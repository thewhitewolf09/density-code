...
/*jshint ignore:start*/
(function () {
  function ka(k, F) { k.prototype = ob(F.prototype); k.prototype.constructor = k; k.base = F.prototype } function ob(k) { function F() { } F.prototype = k; return new F } function bb(k, F, g) {
    "millisecond" === g ? k.setMilliseconds(k.getMilliseconds() + 1 * F) : "second" === g ? k.setSeconds(k.getSeconds() + 1 * F) : "minute" === g ? k.setMinutes(k.getMinutes() + 1 * F) : "hour" === g ? k.setHours(k.getHours() + 1 * F) : "day" === g ? k.setDate(k.getDate() + 1 * F) : "week" === g ? k.setDate(k.getDate() + 7 * F) : "month" === g ? k.setMonth(k.getMonth() + 1 * F) : "year" === g && k.setFullYear(k.getFullYear() +
      1 * F); return k
  } function qa(k, F) { var g = !1; 0 > k && (g = !0, k *= -1); k = "" + k; for (F = F ? F : 1; k.length < F;)k = "0" + k; return g ? "-" + k : k } function Oa(k) { if (!k) return k; k = k.replace(/^\s\s*/, ""); for (var F = /\s/, g = k.length; F.test(k.charAt(--g));); return k.slice(0, g + 1) } function Ga(k) {
    k.roundRect = function (k, g, u, $, M, z, s, y) {
      s && (this.fillStyle = s); y && (this.strokeStyle = y); "undefined" === typeof M && (M = 5); this.lineWidth = z; this.beginPath(); this.moveTo(k + M, g); this.lineTo(k + u - M, g); this.quadraticCurveTo(k + u, g, k + u, g + M); this.lineTo(k + u, g + $ -
        M); this.quadraticCurveTo(k + u, g + $, k + u - M, g + $); this.lineTo(k + M, g + $); this.quadraticCurveTo(k, g + $, k, g + $ - M); this.lineTo(k, g + M); this.quadraticCurveTo(k, g, k + M, g); this.closePath(); s && this.fill(); y && 0 < z && this.stroke()
    }
  } function Wa(k, F) { return k - F } function cb(k, F, g) {
    if (k && F && g) {
      g = g + "." + F; var u = "image/" + F; k = k.toDataURL(u); var $ = !1, M = document.createElement("a"); M.download = g; M.href = k; if ("undefined" !== typeof Blob && new Blob) {
        for (var z = k.replace(/^data:[a-z\/]*;base64,/, ""), z = atob(z), s = new ArrayBuffer(z.length), s =
          new Uint8Array(s), y = 0; y < z.length; y++)s[y] = z.charCodeAt(y); F = new Blob([s.buffer], { type: "image/" + F }); try { window.navigator.msSaveBlob(F, g), $ = !0 } catch (O) { M.dataset.downloadurl = [u, M.download, M.href].join(":"), M.href = window.URL.createObjectURL(F) }
        ...
        F = window.open(), F.document.write("<img src='" + k + "'></img><div>Please right click on the image and save it to your device</div>"),
        F.document.close()
      }
    }
  } function R(k) { var F = ((k & 16711680) >> 16).toString(16), g = ((k & 65280) >> 8).toString(16); k = ((k & 255) >> 0).toString(16); F = 2 > F.length ? "0" + F : F; g = 2 > g.length ? "0" + g : g; k = 2 > k.length ? "0" + k : k; return "#" + F + g + k } function pb(k, F) { var g = this.length >>> 0, u = Number(F) || 0, u = 0 > u ? Math.ceil(u) : Math.floor(u); for (0 > u && (u += g); u < g; u++)if (u in this && this[u] === k) return u; return -1 } function g(k) { return null === k || "undefined" === typeof k } function Da(k) { k.indexOf || (k.indexOf = pb); return k } function qb(k) {
    if (pa.fSDec) k[wa("`eeDwdouMhrudods")](wa("e`u`@ohl`uhnoHuds`uhnoDoe"),
      function () { pa._fTWm && pa._fTWm(k) })
  } function db(k, F, g) {
    g = g || "normal"; var u = k + "_" + F + "_" + g, $ = eb[u]; if (isNaN($)) {
      try {
        if (!Ea) { var M = document.body; Ea = document.createElement("span"); Ea.innerHTML = ""; var z = document.createTextNode("Mpgyi"); Ea.appendChild(z); M.appendChild(Ea) } Ea.style.display = ""; N(Ea, { position: "absolute", left: "0px", top: "-20000px", padding: "0px", margin: "0px", border: "none", whiteSpace: "pre", lineHeight: "normal", fontFamily: k, fontSize: F + "px", fontWeight: g }); $ = Math.round(Ea.offsetHeight); Ea.style.display =
          "none"
      } catch (s) { $ = Math.ceil(1.1 * F) } $ = Math.max($, F); eb[u] = $
    } return $
  } function T(k, F) { var g = []; if (g = { solid: [], shortDash: [3, 1], shortDot: [1, 1], shortDashDot: [3, 1, 1, 1], shortDashDotDot: [3, 1, 1, 1, 1, 1], dot: [1, 2], dash: [4, 2], dashDot: [4, 2, 1, 2], longDash: [8, 2], longDashDot: [8, 2, 1, 2], longDashDotDot: [8, 2, 1, 2, 1, 2] }[k || "solid"]) for (var u = 0; u < g.length; u++)g[u] *= F; else g = []; return g } function y(k, F, H, u, $) {
    u = u || []; $ = g($) ? rb ? { passive: !1, capture: !1 } : !1 : $; u.push([k, F, H, $]); return k.addEventListener ? (k.addEventListener(F, H,
      $), H) : k.attachEvent ? (u = function (F) { F = F || window.event; F.preventDefault = F.preventDefault || function () { F.returnValue = !1 }; F.stopPropagation = F.stopPropagation || function () { F.cancelBubble = !0 }; H.call(k, F) }, k.attachEvent("on" + F, u), u) : !1
  } function fb(k, F, g, u) { u = u || !1; if (k.removeEventListener) k.removeEventListener(F, g, u); else if (k.detachEvent) k.detachEvent("on" + F, g); else return !1 } function gb(k, F) {
    if ("createEvent" in document) { var g = document.createEvent("HTMLEvents"); g.initEvent(F, !1, !0); k.dispatchEvent(g) } else k.fireEvent("on" +
      F)
  } function hb(k) {
    if (k._menuButton) k.exportEnabled ? (N(k._menuButton, { backgroundColor: k.toolbar.itemBackgroundColor, color: k.toolbar.fontColor }), Ra(k._menuButton), k._menuButton.title = k._cultureInfo.menuText) : ya(k._menuButton); else if (k.exportEnabled && u) {
      var F = !1; k._menuButton = document.createElement("button"); Ba(k, k._menuButton, "menu"); k._toolBar.appendChild(k._menuButton); y(k._menuButton, "touchstart", function (k) { F = !0 }, k.allDOMEventHandlers); y(k._menuButton, "click", function () {
        ...
        "mouseout", function () { F || (N(k._menuButton, { backgroundColor: k.toolbar.itemBackgroundColor, color: k.toolbar.fontColor }), 0 >= navigator.userAgent.search("MSIE") && N(k._menuButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" })) }, k.allDOMEventHandlers, !0)
    } if (k.exportEnabled && k._dropdownMenu) {
      N(k._dropdownMenu, { backgroundColor: k.toolbar.itemBackgroundColor, color: k.toolbar.fontColor }); for (var g = k._dropdownMenu.childNodes, P = [k._cultureInfo.printText, k._cultureInfo.saveJPGText, k._cultureInfo.savePNGText],
        $ = 0; $ < g.length; $++)N(g[$], { backgroundColor: k.toolbar.itemBackgroundColor, color: k.toolbar.fontColor }), g[$].innerHTML = P[$]
    } else !k._dropdownMenu && (k.exportEnabled && u) && (F = !1, k._dropdownMenu = document.createElement("div"), k._dropdownMenu.setAttribute("tabindex", -1), g = -1 !== k.theme.indexOf("dark") ? "black" : "#888888", N(k._dropdownMenu, {
      ...
      fontSize: "14px", fontFamily: "Arial, Helvetica, sans-serif", padding: "5px 0px 5px 0px", textAlign: "left", lineHeight: "10px", backgroundColor: k.toolbar.itemBackgroundColor, boxShadow: "2px 2px 10px" + g
    }), k._dropdownMenu.style.display = "none", k._toolBar.appendChild(k._dropdownMenu), y(k._dropdownMenu, "blur", function () { ya(k._dropdownMenu); k._dropDownCloseTime = new Date }, k.allDOMEventHandlers, !0), g = document.createElement("div"), N(g, { padding: "12px 8px 12px 8px" }), g.innerHTML = k._cultureInfo.printText, g.style.backgroundColor =
      k.toolbar.itemBackgroundColor, g.style.color = k.toolbar.fontColor, k._dropdownMenu.appendChild(g), y(g, "touchstart", function (k) { F = !0 }, k.allDOMEventHandlers), y(g, "mousemove", function () { F || (this.style.backgroundColor = k.toolbar.itemBackgroundColorOnHover, this.style.color = k.toolbar.fontColorOnHover) }, k.allDOMEventHandlers, !0), y(g, "mouseout", function () { F || (this.style.backgroundColor = k.toolbar.itemBackgroundColor, this.style.color = k.toolbar.fontColor) }, k.allDOMEventHandlers, !0), y(g, "click", function () {
        k.print();
        ya(k._dropdownMenu)
      }, k.allDOMEventHandlers, !0), g = document.createElement("div"), N(g, { padding: "12px 8px 12px 8px" }), g.innerHTML = k._cultureInfo.saveJPGText, g.style.backgroundColor = k.toolbar.itemBackgroundColor, g.style.color = k.toolbar.fontColor, k._dropdownMenu.appendChild(g), y(g, "touchstart", function (k) { F = !0 }, k.allDOMEventHandlers), y(g, "mousemove", function () { F || (this.style.backgroundColor = k.toolbar.itemBackgroundColorOnHover, this.style.color = k.toolbar.fontColorOnHover) }, k.allDOMEventHandlers, !0), y(g,
        "mouseout", function () { F || (this.style.backgroundColor = k.toolbar.itemBackgroundColor, this.style.color = k.toolbar.fontColor) }, k.allDOMEventHandlers, !0), y(g, "click", function () { k.exportChart({ format: "jpeg", fileName: k.exportFileName }); ya(k._dropdownMenu) }, k.allDOMEventHandlers, !0), g = document.createElement("div"), N(g, { padding: "12px 8px 12px 8px" }), g.innerHTML = k._cultureInfo.savePNGText, g.style.backgroundColor = k.toolbar.itemBackgroundColor, g.style.color = k.toolbar.fontColor, k._dropdownMenu.appendChild(g), y(g,
          "touchstart", function (k) { F = !0 }, k.allDOMEventHandlers), y(g, "mousemove", function () { F || (this.style.backgroundColor = k.toolbar.itemBackgroundColorOnHover, this.style.color = k.toolbar.fontColorOnHover) }, k.allDOMEventHandlers, !0), y(g, "mouseout", function () { F || (this.style.backgroundColor = k.toolbar.itemBackgroundColor, this.style.color = k.toolbar.fontColor) }, k.allDOMEventHandlers, !0), y(g, "click", function () { k.exportChart({ format: "png", fileName: k.exportFileName }); ya(k._dropdownMenu) }, k.allDOMEventHandlers, !0))
  } function ib(k,
    g, u) { k *= ma; g *= ma; k = u.getImageData(k, g, 2, 2).data; g = !0; for (u = 0; 4 > u; u++)if (k[u] !== k[u + 4] | k[u] !== k[u + 8] | k[u] !== k[u + 12]) { g = !1; break } return g ? k[0] << 16 | k[1] << 8 | k[2] : 0 } function ra(k, g, u) { return k in g ? g[k] : u[k] } function Sa(k, g, H) {
      if (u && jb) {
        var P = k.getContext("2d"); Ta = P.webkitBackingStorePixelRatio || P.mozBackingStorePixelRatio || P.msBackingStorePixelRatio || P.oBackingStorePixelRatio || P.backingStorePixelRatio || 1; ma = Xa / Ta; k.width = g * ma; k.height = H * ma; Xa !== Ta && (k.style.width = g + "px", k.style.height = H + "px", P.scale(ma,
          ma))
      } else k.width = g, k.height = H
    } function sb(k) {
      if (!tb) {
        var g = !1, u = !1; "undefined" === typeof ea.Chart.creditHref ? (k.creditHref = wa("iuuqr;..b`ow`rkr/bnl."), k.creditText = wa("B`ow`rKR/bnl")) : (g = k.updateOption("creditText"), u = k.updateOption("creditHref")); if (k.creditHref && k.creditText) {
          k._creditLink || (k._creditLink = document.createElement("a"), k._creditLink.setAttribute("class", "canvasjs-chart-credit"), k._creditLink.setAttribute("title", "JavaScript Charts"), N(k._creditLink, {
            outline: "none", margin: "0px", position: "absolute",
            right: "2px", top: k.height - 14 + "px", color: "dimgrey", textDecoration: "none", fontSize: "11px", fontFamily: "Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif"
          }), k._creditLink.setAttribute("tabIndex", -1), k._creditLink.setAttribute("target", "_blank")); if (0 === k.renderCount || g || u) k._creditLink.setAttribute("href", k.creditHref), k._creditLink.innerHTML = k.creditText; k._creditLink && k.creditHref && k.creditText ? (k._creditLink.parentElement || k._canvasJSContainer.appendChild(k._creditLink), k._creditLink.style.top =
      ...
      g.getAttribute("state") || (g.style.backgroundColor = k.toolbar.itemBackgroundColor,
    ...
    } function Ra() { for (var k = null, g = 0; g < arguments.length; g++)k = arguments[g], k.style && (k.style.display = "inline") } function ya() { for (var k = null, g = 0; g < arguments.length; g++)(k = arguments[g]) && k.style && (k.style.display = "none") } function Ya(k) {
      if (null === k || "object" !== typeof k) return k; if (k instanceof Date) return new Date(k.getTime()); Array.isArray || (Array.isArray = function (k) { return "[object Array]" === Object.prototype.toString.call(k) }); if (Array.isArray(k)) {
        for (var g =
          [], u = 0; u < k.length; u++)g.push(Ya(k[u])); return g
      } g = new k.constructor; for (u in k) k.hasOwnProperty(u) && (g[u] = Ya(k[u])); return g
    } function Ua(k, g, u, P, $) { if (null === k || "undefined" === typeof k) return "undefined" === typeof u ? g : u; k = parseFloat(k.toString()) * (0 <= k.toString().indexOf("%") ? g / 100 : 1); "undefined" !== typeof P && (k = Math.min(P, k), "undefined" !== typeof $ && (k = Math.max($, k))); return !isNaN(k) && k <= g && 0 <= k ? k : "undefined" === typeof u ? g : u } function Y(k, F, u, P, $) {
      this._defaultsKey = k; this._themeOptionsKey = F; this._index =
      ...
      Va.base.constructor.call(this, "Toolbar", "toolbar", g, null, k); this.chart = k; this.canvas = k.canvas; this.ctx = this.chart.ctx; this.optionsName =
        "toolbar"
    } function Ha(k, F) {
      Ha.base.constructor.call(this, "Title", "title", F, null, k); this.chart = k; this.canvas = k.canvas; this.ctx = this.chart.ctx; this.optionsName = "title"; if (g(this.options.margin) && k.options.subtitles) for (var u = k.options.subtitles, P = 0; P < u.length; P++)if ((g(u[P].horizontalAlign) && "center" === this.horizontalAlign || u[P].horizontalAlign === this.horizontalAlign) && (g(u[P].verticalAlign) && "top" === this.verticalAlign || u[P].verticalAlign === this.verticalAlign) && !u[P].dockInsidePlotArea === !this.dockInsidePlotArea) {
        this.margin =
        0; break
      ...
      Ma.base.constructor.call(this, "Subtitle", "subtitles", g, u, k); this.chart = k; this.canvas = k.canvas; this.ctx = this.chart.ctx; this.optionsName = "subtitles"; this.isOptionsInArray = !0; "undefined" === typeof this.options.fontSize && (this.fontSize = this.chart.getAutoFontSize(this.fontSize)); this.height = this.width = null;
      this.bounds = { x1: null, y1: null, x2: null, y2: null }
    } function Za() { this.pool = [] } function Na(k) { var g; k && Pa[k] && (g = Pa[k]); Na.base.constructor.call(this, "CultureInfo", null, g, null, null) } var La = !1, pa = {}, u = !!document.createElement("canvas").getContext, ea = {
      Chart: {
        ...
        fontWeight: "normal", fontColor: "black", fontStyle: "normal", borderThickness: 0, borderColor: "black", cornerRadius: 0, backgroundColor: u ? "transparent" : null, margin: 5, wrap: !0, maxWidth: null, dockInsidePlotArea: !1, publicProperties: { options: "readWrite", bounds: "readOnly", chart: "readOnly" }
      }, Subtitle: {
        ...
        backgroundColor: u ? "rgba(255,255,255,.9)" : "rgb(255,255,255)", borderColor: null, borderThickness: 2, cornerRadius: 5, fontSize: 14, fontColor: "black", fontFamily: "Calibri, Arial, Georgia, serif;", fontWeight: "normal", fontStyle: "italic", updated: null, hidden: null, publicProperties: { options: "readWrite", chart: "readOnly" }
      }, Axis: {
        ...
        labelBorderThickness: 0, labelCornerRadius: 0, labelPlacement: "outside", labelTextAlign: "left", prefix: "", suffix: "", includeZero: !1, tickLength: 5, tickColor: "black", tickThickness: 1, tickPlacement: "outside", lineColor: "black", lineThickness: 1, lineDashType: "solid", gridColor: "#A0A0A0", gridThickness: 0, gridDashType: "solid", interlacedColor: u ? "transparent" : null, valueFormatString: null, margin: 2, publicProperties: {
        ...
        markerColor: null, markerSize: null, markerBorderColor: u ? "transparent" : null, markerBorderThickness: 0, mouseover: null, mouseout: null, mousemove: null, click: null, toolTipContent: null, visible: !0, publicProperties: { options: "readWrite", axisX: "readWrite", axisY: "readWrite", chart: "readOnly" }
      }, TextBlock: {
      ...
      L, ca, V, fa, ta; ca = "#333333"; V = "#000000"; L = "#666666"; ta = fa = "#000000"; var ja = 20, E = 14, Fa = {
        colorSet: "colorSet1", backgroundColor: "#FFFFFF", title: { fontFamily: za, fontSize: 32, fontColor: ca, fontWeight: "normal", verticalAlign: "top", margin: 5 }, subtitles: [{ fontFamily: za, fontSize: E, fontColor: ca, fontWeight: "normal", verticalAlign: "top", margin: 5 }], data: [{ indexLabelFontFamily: s, indexLabelFontSize: E, indexLabelFontColor: ca, indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }], axisX: [{
          titleFontFamily: s, titleFontSize: ja,
          ...
          titleFontFamily: s, titleFontSize: ja, titleFontColor: ca, titleFontWeight: "normal", labelFontFamily: s, labelFontSize: E, labelFontColor: V, labelFontWeight: "normal", lineThickness: 1, lineColor: L, tickThickness: 1, tickColor: L, gridThickness: 0, gridColor: L, stripLines: [{ labelFontFamily: s, labelFontSize: E, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1 }], crosshair: {
            labelFontFamily: s,
            labelFontSize: E, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: ta, color: fa, thickness: 1, lineDashType: "dash"
          }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#BBBBBB", lineThickness: 1, lineDashType: "solid" }
        }], axisY: [{
          titleFontFamily: s, titleFontSize: ja, titleFontColor: ca, titleFontWeight: "normal", labelFontFamily: s, labelFontSize: E, labelFontColor: V, labelFontWeight: "normal", lineThickness: 1, lineColor: L, tickThickness: 1, tickColor: L, gridThickness: 1, gridColor: L, stripLines: [{
            labelFontFamily: s,
            labelFontSize: E, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1
          }], crosshair: { labelFontFamily: s, labelFontSize: E, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: ta, color: fa, thickness: 1, lineDashType: "dash" }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#BBBBBB", lineThickness: 1, lineDashType: "solid" }
        }], axisY2: [{
          titleFontFamily: s, titleFontSize: ja, titleFontColor: ca, titleFontWeight: "normal", labelFontFamily: s, labelFontSize: E,
          labelFontColor: V, labelFontWeight: "normal", lineThickness: 1, lineColor: L, tickThickness: 1, tickColor: L, gridThickness: 1, gridColor: L, stripLines: [{ labelFontFamily: s, labelFontSize: E, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1 }], crosshair: { labelFontFamily: s, labelFontSize: E, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: ta, color: fa, thickness: 1, lineDashType: "dash" }, scaleBreaks: {
      ...
      }; L = "#2A2A2A"; V = ca = "#F5F5F5"; L = "#FFFFFF"; fa = "#40BAF1"; ta = "#F5F5F5"; var ja = 20, E = 14, Ia = {
        colorSet: "colorSet2", title: {
          ...
          titleFontFamily: s, titleFontSize: ja, titleFontColor: "#666666", titleFontWeight: "normal", labelFontFamily: s, labelFontSize: E, labelFontColor: "#666666", labelFontWeight: "normal",
          ...
          titleFontFamily: s, titleFontSize: ja, titleFontColor: "#666666", titleFontWeight: "normal", labelFontFamily: s, labelFontSize: E, labelFontColor: "#666666", labelFontWeight: "normal", lineThickness: 0, lineColor: "#BBBBBB", tickColor: "#BBBBBB", tickThickness: 1, gridThickness: 1, gridColor: "#BBBBBB",
          ...
          titleFontFamily: s, titleFontSize: ja, titleFontColor: "#666666", titleFontWeight: "normal",
  ...
  fa = "#40BAF1"; ta = "#F5F5F5"; ja = 20; E = 14; za = {
    colorSet: "colorSet12", backgroundColor: "#2A2A2A", title: { fontFamily: za, fontSize: 32, fontColor: ca, fontWeight: "normal", verticalAlign: "top", margin: 5 }, subtitles: [{ fontFamily: za, fontSize: E, fontColor: ca, fontWeight: "normal", verticalAlign: "top", margin: 5 }], toolbar: { itemBackgroundColor: "#666666", itemBackgroundColorOnHover: "#FF7372", buttonBorderColor: "#FF7372", buttonBorderThickness: 1, fontColor: "#F5F5F5", fontColorOnHover: "#F5F5F5" }, data: [{
      ...
      titleFontFamily: s, titleFontSize: ja, titleFontColor: V, titleFontWeight: "normal", labelFontFamily: s, labelFontSize: E, labelFontColor: V, labelFontWeight: "normal", lineThickness: 1, lineColor: L, tickThickness: 1, tickColor: L, gridThickness: 0, gridColor: L, stripLines: [{ labelFontFamily: s, labelFontSize: E, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1 }], crosshair: {
        labelFontFamily: s,
        labelFontSize: E, labelFontColor: "#000000", labelFontWeight: "normal", labelBackgroundColor: ta, color: fa, thickness: 1, lineDashType: "dash"
      }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#777777", lineThickness: 1, lineDashType: "solid", color: "#111111" }
    }], axisX2: [{
      titleFontFamily: s, titleFontSize: ja, titleFontColor: V, titleFontWeight: "normal", labelFontFamily: s, labelFontSize: E, labelFontColor: V, labelFontWeight: "normal", lineThickness: 1, lineColor: L, tickThickness: 1, tickColor: L, gridThickness: 0, gridColor: L, stripLines: [{
        labelFontFamily: s,
        labelFontSize: E, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1
      }], crosshair: { labelFontFamily: s, labelFontSize: E, labelFontColor: "#000000", labelFontWeight: "normal", labelBackgroundColor: ta, color: fa, thickness: 1, lineDashType: "dash" }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#777777", lineThickness: 1, lineDashType: "solid", color: "#111111" }
    }], axisY: [{
      titleFontFamily: s, titleFontSize: ja, titleFontColor: V, titleFontWeight: "normal", labelFontFamily: s,
      labelFontSize: E, labelFontColor: V, labelFontWeight: "normal", lineThickness: 1, lineColor: L, tickThickness: 1, tickColor: L, gridThickness: 1, gridColor: L, stripLines: [{ labelFontFamily: s, labelFontSize: E, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1 }], crosshair: { labelFontFamily: s, labelFontSize: E, labelFontColor: "#000000", labelFontWeight: "normal", labelBackgroundColor: ta, color: fa, thickness: 1, lineDashType: "dash" }, scaleBreaks: {
      ...
      titleFontFamily: s, titleFontSize: ja, titleFontColor: V, titleFontWeight: "normal", labelFontFamily: s, labelFontSize: E, labelFontColor: V, labelFontWeight: "normal", lineThickness: 1, lineColor: L, tickThickness: 1, tickColor: L, gridThickness: 1, gridColor: L, stripLines: [{ labelFontFamily: s, labelFontSize: E, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1 }], crosshair: {
        ...
        labelFontWeight: "normal", labelBackgroundColor: ta, color: fa, thickness: 1, lineDashType: "dash"
      }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#777777", lineThickness: 1, lineDashType: "solid", color: "#111111" }
  ...
  }; L = "#FFFFFF"; V = ca = "#FAFAFA"; fa = "#40BAF1"; ta = "#F5F5F5";
  ja = 20; E = 14; fa = {
    colorSet: "colorSet2", backgroundColor: "#32373A", title: { fontFamily: s, fontSize: 32, fontColor: ca, fontWeight: "normal", verticalAlign: "top", margin: 5 }, subtitles: [{ fontFamily: s, fontSize: E, fontColor: ca, fontWeight: "normal", verticalAlign: "top", margin: 5 }], toolbar: { itemBackgroundColor: "#666666", itemBackgroundColorOnHover: "#FF7372", buttonBorderColor: "#FF7372", buttonBorderThickness: 1, fontColor: "#F5F5F5", fontColorOnHover: "#F5F5F5" }, data: [{
      ...
      titleFontFamily: s, titleFontSize: ja, titleFontColor: V, titleFontWeight: "normal", labelFontFamily: s, labelFontSize: E, labelFontColor: V, labelFontWeight: "normal", lineThickness: 1, lineColor: L, tickThickness: 1, tickColor: L, gridThickness: 0, gridColor: L, stripLines: [{ labelFontFamily: s, labelFontSize: E, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1 }], crosshair: {
        labelFontFamily: s, labelFontSize: E,
        labelFontColor: "#000000", labelFontWeight: "normal", labelBackgroundColor: ta, color: fa, thickness: 1, lineDashType: "dash"
      }, scaleBreaks: { type: "zigzag", spacing: "2%", lineColor: "#777777", lineThickness: 1, lineDashType: "solid", color: "#111111" }
    }], axisX2: [{
      titleFontFamily: s, titleFontSize: ja, titleFontColor: V, titleFontWeight: "normal", labelFontFamily: s, labelFontSize: E, labelFontColor: V, labelFontWeight: "normal", lineThickness: 1, lineColor: L, tickThickness: 1, tickColor: L, gridThickness: 0, gridColor: L, stripLines: [{
        labelFontFamily: s,
    ...
    light1: Fa, light2: Ia, dark1: za, dark2: fa,
    theme1: Fa, theme2: Ia, theme3: Fa
  }, ba = { numberDuration: 1, yearDuration: 314496E5, monthDuration: 2592E6, weekDuration: 6048E5, dayDuration: 864E5, hourDuration: 36E5, minuteDuration: 6E4, secondDuration: 1E3, millisecondDuration: 1, dayOfWeekFromInt: "Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" ") }; (function () {
    pa.fSDec = function (k) { for (var g = "", u = 0; u < k.length; u++)g += String.fromCharCode(Math.ceil(k.length / 57 / 5) ^ k.charCodeAt(u)); return g }; delete ea[pa.fSDec("Bi`su")][pa.fSDec("bsdehuIsdg")]; pa.pro = { sCH: ea[pa.fSDec("Bi`su")][pa.fSDec("bsdehuIsdg")] };
    pa._fTWm = function (k) { if ("undefined" === typeof pa.pro.sCH && !kb) try { var g, u = k[pa.fSDec("buy")]; u[pa.fSDec("udyuC`rdmhod")] = pa.fSDec("unq"); u[pa.fSDec("gnou")] = 11 + pa.fSDec("qy!B`mhcsh-!Mtbhe`!Fs`oed-!Mtbhe`!R`or!Tohbned-!@sh`m-!r`or,rdshg"); u[pa.fSDec("ghmmRuxmd")] = pa.fSDec("fsdx"); g = k.height - 11; u[pa.fSDec("ghmmUdyu")](pa.fSDec("B`ow`rKR!Ush`m"), 0, g) } catch (P) { } }
  })(); var rb = function () {
    var k = !1; try {
      var g = Object.defineProperty && Object.defineProperty({}, "passive", { get: function () { k = !0; return !1 } }); window.addEventListener &&
        (window.addEventListener("test", null, g), window.removeEventListener("test", null, g))
    } catch (u) { k = !1 } return k
  }(), eb = {}, Ea = null, lb = function (k) {
    var g = 0, u = 0; this.options.width ? g = this.width : this.width = g = 0 < this.container.clientWidth ? this.container.clientWidth : this.width; this.options.height ? u = this.height : this.height = u = 0 < this.container.clientHeight ? this.container.clientHeight : this.height; if (this.canvas.width !== g * ma || this.canvas.height !== u * ma) {
      for (var P = 0; P < k.length; P++)Sa(k[P], g, u); this.bounds = {
          ...
          switch (A) {
            case "D": return v; case "DD": return qa(v, 2); case "DDD": return V[x]; case "DDDD": return L[x]; case "M": return t +
              1; case "MM": return qa(t + 1, 2); case "MMM": return R[t]; case "MMMM": return T[t]; case "Y": return parseInt(String(a).slice(-2)); case "YY": return qa(String(a).slice(-2), 2); case "YYY": return qa(String(a).slice(-3), 3); case "YYYY": return qa(a, 4); case "h": return f % 12 || 12; case "hh": return qa(f % 12 || 12, 2); case "H": return f; case "HH": return qa(f, 2); case "m": return c; case "mm": return qa(c, 2); case "s": return b; case "ss": return qa(b, 2); case "f": return qa(String(e), 3).slice(0, 1); case "ff": return qa(String(e), 3).slice(0,
                2); case "fff": return qa(String(e), 3).slice(0, 3); case "t": return 12 > f ? "a" : "p"; case "tt": return 12 > f ? "am" : "pm"; case "T": return 12 > f ? "A" : "P"; case "TT": return 12 > f ? "AM" : "PM"; case "K": return d ? "UTC" : (String(y).match(s) || [""]).pop().replace(z, ""); case "z": return (0 < h ? "-" : "+") + Math.floor(Math.abs(h) / 60); case "zz": return (0 < h ? "-" : "+") + qa(Math.floor(Math.abs(h) / 60), 2); case "zzz": return (0 < h ? "-" : "+") + qa(Math.floor(Math.abs(h) / 60), 2) + qa(Math.abs(h) % 60, 2); default: return A.slice(1, A.length - 1)
          }
        })
    }
  }(), aa = function (k,
    g, u) {
      if (null === k) return ""; if (!isFinite(k)) return k; k = Number(k); var P = 0 > k ? !0 : !1; P && (k *= -1); var $ = u ? u.decimalSeparator : ".", s = u ? u.digitGroupSeparator : ",", z = ""; g = String(g); var z = 1, y = u = "", E = -1, O = [], L = [], T = 0, V = 0, R = 0, d = !1, v = 0, y = g.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g); g = null; for (var x = 0; y && x < y.length; x++)if (g = y[x], "." === g && 0 > E) E = x; else {
      ...
      } d && (g = Math.floor(k), y = -Math.floor(Math.log(k) / Math.LN10 + 1), v = 0 === k ? 0 : 0 === g ? -(T + y) : String(g).length - T, z /= Math.pow(10, v)); 0 > E && (E = x); z = (k * z).toFixed(V); g = z.split("."); z = (g[0] + "").split(""); k = (g[1] + "").split(""); z && "0" === z[0] && z.shift(); for (d = y = x = V = E = 0; 0 < O.length;)if (g = O.pop(), "#" === g || "0" === g) if (E++, E === T) {
        var t = z, z = []; if ("0" === g) for (g = T - V - (t ? t.length : 0); 0 < g;)t.unshift("0"),
          g--; for (; 0 < t.length;)u = t.pop() + u, d++, 0 === d % y && (x === R && 0 < t.length) && (u = s + u)
      } else 0 < z.length ? (u = z.pop() + u, V++, d++) : "0" === g && (u = "0" + u, V++, d++), 0 === d % y && (x === R && 0 < z.length) && (u = s + u); else "E" !== g[0] && "e" !== g[0] || "0" !== g[g.length - 1] || !/[eE][+-]*[0]+/.test(g) ? "," === g ? (x++, y = d, d = 0, 0 < z.length && (u = s + u)) : u = 1 < g.length && ('"' === g[0] && '"' === g[g.length - 1] || "'" === g[0] && "'" === g[g.length - 1]) ? g.slice(1, g.length - 1) + u : g + u : (g = 0 > v ? g.replace("+", "").replace("-", "") : g.replace("-", ""), u += g.replace(/[0]+/, function (a) {
        return qa(v,
          a.length)
      })); s = ""; for (O = !1; 0 < L.length;)g = L.shift(), "#" === g || "0" === g ? 0 < k.length && 0 !== Number(k.join("")) ? (s += k.shift(), O = !0) : "0" === g && (s += "0", O = !0) : 1 < g.length && ('"' === g[0] && '"' === g[g.length - 1] || "'" === g[0] && "'" === g[g.length - 1]) ? s += g.slice(1, g.length - 1) : "E" !== g[0] && "e" !== g[0] || "0" !== g[g.length - 1] || !/[eE][+-]*[0]+/.test(g) ? s += g : (g = 0 > v ? g.replace("+", "").replace("-", "") : g.replace("-", ""), s += g.replace(/[0]+/, function (a) { return qa(v, a.length) })); u += (O ? $ : "") + s; return P ? "-" + u : u
  }, Aa = function (g) {
    var u = 0, H = 0; g =
      g || window.event; g.offsetX || 0 === g.offsetX ? (u = g.offsetX, H = g.offsetY) : g.layerX || 0 == g.layerX ? (u = g.layerX, H = g.layerY) : (u = g.pageX - g.target.offsetLeft, H = g.pageY - g.target.offsetTop); return { x: u, y: H }
  }, jb = !0, Xa = window.devicePixelRatio || 1, Ta = 1, ma = jb ? Xa / Ta : 1, Z = function (g, u, H, P, s, y, z, E, L, O, T, V, R) {
    "undefined" === typeof R && (R = 1); z = z || 0; E = E || "black"; var N = 15 < P - u && 15 < s - H ? 8 : 0.35 * Math.min(P - u, s - H); g.beginPath(); g.moveTo(u, H); g.save(); g.fillStyle = y; g.globalAlpha = R; g.fillRect(u, H, P - u, s - H); g.globalAlpha = 1; 0 < z && (R = 0 === z %
      2 ? 0 : 0.5, g.beginPath(), g.lineWidth = z, g.strokeStyle = E, g.moveTo(u, H), g.rect(u - R, H - R, P - u + 2 * R, s - H + 2 * R), g.stroke()); g.restore(); !0 === L && (g.save(), g.beginPath(), g.moveTo(u, H), g.lineTo(u + N, H + N), g.lineTo(P - N, H + N), g.lineTo(P, H), g.closePath(), z = g.createLinearGradient((P + u) / 2, H + N, (P + u) / 2, H), z.addColorStop(0, y), z.addColorStop(1, "rgba(255, 255, 255, .4)"), g.fillStyle = z, g.fill(), g.restore()); !0 === O && (g.save(), g.beginPath(), g.moveTo(u, s), g.lineTo(u + N, s - N), g.lineTo(P - N, s - N), g.lineTo(P, s), g.closePath(), z = g.createLinearGradient((P +
        u) / 2, s - N, (P + u) / 2, s), z.addColorStop(0, y), z.addColorStop(1, "rgba(255, 255, 255, .4)"), g.fillStyle = z, g.fill(), g.restore()); !0 === T && (g.save(), g.beginPath(), g.moveTo(u, H), g.lineTo(u + N, H + N), g.lineTo(u + N, s - N), g.lineTo(u, s), g.closePath(), z = g.createLinearGradient(u + N, (s + H) / 2, u, (s + H) / 2), z.addColorStop(0, y), z.addColorStop(1, "rgba(255, 255, 255, 0.1)"), g.fillStyle = z, g.fill(), g.restore()); !0 === V && (g.save(), g.beginPath(), g.moveTo(P, H), g.lineTo(P - N, H + N), g.lineTo(P - N, s - N), g.lineTo(P, s), z = g.createLinearGradient(P -
          N, (s + H) / 2, P, (s + H) / 2), z.addColorStop(0, y), z.addColorStop(1, "rgba(255, 255, 255, 0.1)"), g.fillStyle = z, z.addColorStop(0, y), z.addColorStop(1, "rgba(255, 255, 255, 0.1)"), g.fillStyle = z, g.fill(), g.closePath(), g.restore())
  }, wa = function (g) { for (var u = "", H = 0; H < g.length; H++)u += String.fromCharCode(Math.ceil(g.length / 57 / 5) ^ g.charCodeAt(H)); return u }, kb = window && window[wa("mnb`uhno")] && window[wa("mnb`uhno")].href && window[wa("mnb`uhno")].href.indexOf && (-1 !== window[wa("mnb`uhno")].href.indexOf(wa("b`ow`rkr/bnl")) ||
    -1 !== window[wa("mnb`uhno")].href.indexOf(wa("gdonqhy/bnl")) || -1 !== window[wa("mnb`uhno")].href.indexOf(wa("gheemd"))), tb = kb && -1 === window[wa("mnb`uhno")].href.indexOf(wa("gheemd")), ub = {
  ...
  Y.prototype.setOptions = function (g, u) { if (ea[this._defaultsKey]) { var H = ea[this._defaultsKey], s; for (s in H) "publicProperties" !== s && H.hasOwnProperty(s) && (this[s] = g && s in g ? g[s] : u && s in u ? u[s] : H[s]) } else La && window.console && console.log("defaults not set") }; Y.prototype.get = function (g) {
    var u = ea[this._defaultsKey]; if ("options" === g) return this.options && this.options._isPlaceholder ? null : this.options; if (u.hasOwnProperty(g) || u.publicProperties && u.publicProperties.hasOwnProperty(g)) return this[g]; window.console &&
      window.console.log('Property "' + g + "\" doesn't exist. Please check for typo.")
  }; Y.prototype.set = function (g, u, H) {
    H = "undefined" === typeof H ? !0 : H; var s = ea[this._defaultsKey]; if ("options" === g) this.createUserOptions(u); else if (s.hasOwnProperty(g) || s.publicProperties && s.publicProperties.hasOwnProperty(g) && "readWrite" === s.publicProperties[g]) this.options._isPlaceholder && this.createUserOptions(), this.options[g] = u; else {
  ...
  }; Y.prototype.addTo = function (g, u, H, s) {
    s = "undefined" === typeof s ? !0 : s; var y = ea[this._defaultsKey]; y.hasOwnProperty(g) || y.publicProperties && y.publicProperties.hasOwnProperty(g) && "readWrite" === y.publicProperties[g] ? (this.options._isPlaceholder && this.createUserOptions(), "undefined" === typeof this.options[g] && (this.options[g] =
    ...
    if ("undefined" !== typeof g || this.options._isPlaceholder) if (this.parent.options._isPlaceholder &&
      this.parent.createUserOptions(), this.isOptionsInArray) { this.parent.options[this.optionsName] || (this.parent.options[this.optionsName] = []); var u = this.parent.options[this.optionsName], H = u.length; this.options._isPlaceholder || (Da(u), H = u.indexOf(this.options)); this.options = "undefined" === typeof g ? {} : g; u[H] = this.options } else this.options = "undefined" === typeof g ? {} : g, g = this.parent.options, this.optionsName ? u = this.optionsName : (u = this._defaultsKey) && 0 !== u.length ? (H = u.charAt(0).toLowerCase(), 1 < u.length && (H = H.concat(u.slice(1))),
        u = H) : u = void 0, g[u] = this.options
  }; Y.prototype.remove = function (g) { g = "undefined" === typeof g ? !0 : g; if (this.isOptionsInArray) { var u = this.parent.options[this.optionsName]; Da(u); var H = u.indexOf(this.options); 0 <= H && u.splice(H, 1) } else delete this.parent.options[this.optionsName]; g && (this.stockChart || this.chart || this).render() }; Y.prototype.updateOption = function (k) {
    !ea[this._defaultsKey] && (La && window.console) && console.log("defaults not set"); var u = ea[this._defaultsKey], H = {}, s = this[k], y = this._themeOptionsKey,
    ...
    g && u && (this._eventListeners[g] =
      this._eventListeners[g] || [], this._eventListeners[g].push({ context: H || this, eventHandler: u }))
  }; Y.prototype.removeEventListener = function (g, u) { if (g && u && this._eventListeners[g]) for (var H = this._eventListeners[g], s = 0; s < H.length; s++)if (H[s].eventHandler === u) { H[s].splice(s, 1); break } }; Y.prototype.removeAllEventListeners = function () { this._eventListeners = [] }; Y.prototype.dispatchEvent = function (g, u, s) {
    if (g && this._eventListeners[g]) {
      u = u || {}; for (var y = this._eventListeners[g], E = 0; E < y.length; E++)y[E].eventHandler.call(y[E].context,
        u)
    } "function" === typeof this[g] && this[g].call(s || this.chart, u)
  }; Ka.prototype.registerSpace = function (g, u) { "top" === g ? this._topOccupied += u.height : "bottom" === g ? this._bottomOccupied += u.height : "left" === g ? this._leftOccupied += u.width : "right" === g && (this._rightOccupied += u.width) }; Ka.prototype.unRegisterSpace = function (g, u) { "top" === g ? this._topOccupied -= u.height : "bottom" === g ? this._bottomOccupied -= u.height : "left" === g ? this._leftOccupied -= u.width : "right" === g && (this._rightOccupied -= u.width) }; Ka.prototype.getFreeSpace =
    function () { return { x1: this._x1 + this._leftOccupied, y1: this._y1 + this._topOccupied, x2: this._x2 - this._rightOccupied, y2: this._y2 - this._bottomOccupied, width: this._x2 - this._x1 - this._rightOccupied - this._leftOccupied, height: this._y2 - this._y1 - this._bottomOccupied - this._topOccupied } }; Ka.prototype.reset = function () { this._rightOccupied = this._leftOccupied = this._bottomOccupied = this._topOccupied = this._padding }; ka(na, Y); na.prototype._initialize = function () {
      ...
      if (0 !== this.fontSize) {
        g && this.ctx.save(); var u = this.ctx.font; this.ctx.textBaseline = this.textBaseline; var s = 0; this._isDirty &&
      ...
      g = String(g); if (!g) return { text: "", width: 0 }; var y = s = 0, E = g.length - 1, M = Infinity; for (this.ctx.font = this._getFontString(); y <= E;) {
        ...
        if (s < u) y = M + 1; else if (s > u) E = M - 1; else break
      } s > u && 1 < z.length && (z = z.substr(0, z.length - 1), s = this.ctx.measureText(z).width); u = !0; if (z.length === g.length || " " === g[z.length]) u = !1; u && (g = z.split(" "), 1 < g.length && g.pop(), z = g.join(" "), s = this.ctx.measureText(z).width); return { text: z, width: s }
    }; na.prototype._wrapText = function () {
      var g = new String(Oa(String(this.text))), u = [], s = this.ctx.font, y = 0, E = 0; this.ctx.font = this._getFontString(); if (0 === this.frontSize) E = y = 0; else for (; 0 < g.length;) {
        var M = this.maxHeight - (this.topPadding +
          this.bottomPadding), z = this._getLineWithWidth(g, this.maxWidth - (this.leftPadding + this.rightPadding), !1); z.height = this._lineHeight; u.push(z); var L = E, E = Math.max(E, z.width), y = y + z.height, g = Oa(g.slice(z.text.length, g.length)); M && y > M && (z = u.pop(), y -= z.height, E = L)
      } this._wrappedText = { lines: u, width: E, height: y }; this.width = E + (this.leftPadding + this.rightPadding); this.height = y + (this.topPadding + this.bottomPadding); this.ctx.font = s
    }; na.prototype._getFontString = function () {
      var g; g = "" + (this.fontStyle ? this.fontStyle + " " :
        ""); g += this.fontWeight ? this.fontWeight + " " : ""; g += this.fontSize ? this.fontSize + "px " : ""; var F = this.fontFamily ? this.fontFamily + "" : ""; !u && F && (F = F.split(",")[0], "'" !== F[0] && '"' !== F[0] && (F = "'" + F + "'")); return g += F
    }; ka(Va, Y); ka(Ha, Y); Ha.prototype.setLayout = function () {
      if (this.text) {
        var u = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, F = u.layoutManager.getFreeSpace(), s = F.x1, y = F.y1, E = 0, M = 0, z = this.chart._menuButton && this.chart.exportEnabled && "top" === this.verticalAlign ? 22 : 0, L, N; "top" === this.verticalAlign ||
          "bottom" === this.verticalAlign ? (null === this.maxWidth && (this.maxWidth = F.width - 4 - z * ("center" === this.horizontalAlign ? 2 : 1)), M = 0.5 * F.height - this.margin - 2, E = 0) : "center" === this.verticalAlign && ("left" === this.horizontalAlign || "right" === this.horizontalAlign ? (null === this.maxWidth && (this.maxWidth = F.height - 4), M = 0.5 * F.width - this.margin - 2) : "center" === this.horizontalAlign && (null === this.maxWidth && (this.maxWidth = F.width - 4), M = 0.5 * F.height - 4)); var O; g(this.padding) || "number" !== typeof this.padding ? g(this.padding) || "object" !==
            typeof this.padding || (O = this.padding.top ? this.padding.top : this.padding.bottom ? this.padding.bottom : 0, O += this.padding.bottom ? this.padding.bottom : this.padding.top ? this.padding.top : 0) : O = 2 * this.padding; this.wrap || (M = Math.min(M, 1.5 * this.fontSize + O)); M = new na(this.ctx, {
              ...
              this.width = O.width, this.height = O.height) : "center" === this.verticalAlign && ("left" === this.horizontalAlign ? (s = F.x1 + 2, y = F.y2 - 2 - (this.maxWidth / 2 - O.width / 2), E = -90, N = "left", this.width = O.height, this.height = O.width) : "right" === this.horizontalAlign ? (s = F.x2 - 2, y = F.y1 + 2 + (this.maxWidth / 2 - O.width / 2), E = 90, N = "right", this.width = O.height, this.height = O.width) : "center" === this.horizontalAlign && (y = u.y1 + (u.height / 2 - O.height / 2), s = u.x1 + (u.width / 2 - O.width / 2), N = "center", this.width = O.width, this.height = O.height), L = "center"); M.x =
                s; M.y = y; M.angle = E; M.horizontalAlign = L; this._textBlock = M; u.layoutManager.registerSpace(N, { width: this.width + ("left" === N || "right" === N ? this.margin + 2 : 0), height: this.height + ("top" === N || "bottom" === N ? this.margin + 2 : 0) }); this.bounds = { x1: s, y1: y, x2: s + this.width, y2: y + this.height }; this.ctx.textBaseline = "top"
      }
    }; Ha.prototype.render = function () { this._textBlock && this._textBlock.render(!0) }; ka(Ma, Y); Ma.prototype.setLayout = Ha.prototype.setLayout; Ma.prototype.render = Ha.prototype.render; Za.prototype.get = function (g, u) {
      var s =
        null; 0 < this.pool.length ? (s = this.pool.pop(), Sa(s, g, u)) : s = sa(g, u); return s
    }; Za.prototype.release = function (g) { this.pool.push(g) }; ka(Na, Y); var Qa = { addTheme: function (g, u) { $a[g] = u }, addColorSet: function (g, u) { xa[g] = u }, addCultureInfo: function (g, u) { Pa[g] = u }, formatNumber: function (g, u, s) { s = s || "en"; if (Pa[s]) return aa(g, u || "#,##0.##", new Na(s)); throw "Unknown Culture Name"; }, formatDate: function (g, u, s) { s = s || "en"; if (Pa[s]) return oa(g, u || "DD MMM YYYY", new Na(s)); throw "Unknown Culture Name"; } }; "undefined" !== typeof module &&
      "undefined" !== typeof module.exports ? module.exports = Qa : "function" === typeof define && define.amd ? define([], function () { return Qa }) : (window.CanvasJS && window.console && window.console.log("CanvasJS namespace already exists. If you are loading both chart and stockchart scripts, just load stockchart alone as it includes all chart features."), window.CanvasJS = window.CanvasJS ? window.CanvasJS : Qa); var Ja = Qa.Chart = function () {
        function k(a, f) { return a.x - f.x } function s(a, f, c) {
        ...
        } function ea(a) { this.chart = a; this.lastObjectId = 0; this.objectMap = []; this.rectangularRegionEventSubscriptions = []; this.previousDataPointEventObject = null; this.ghostCanvas = sa(this.chart.width, this.chart.height); this.ghostCtx = this.ghostCanvas.getContext("2d"); this.mouseoveredObjectMaps = [] } function ja(a) {
          ...
          if (this.options.zoomEnabled || this.panEnabled) {
            if (this._zoomButton) N(this._zoomButton, { borderRight: this.toolbar.buttonBorderThickness + "px solid " + this.toolbar.buttonBorderColor, backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor }), this._zoomButton.title = this._cultureInfo.zoomText; else {
              var f = !1; ya(this._zoomButton = document.createElement("button")); Ba(this, this._zoomButton, "pan"); this._zoomButton.title = this._cultureInfo.panText; this._toolBar.appendChild(this._zoomButton); this._zoomButton.style.borderRight =
                this.toolbar.buttonBorderThickness + "px solid " + this.toolbar.buttonBorderColor; y(this._zoomButton, "touchstart", function (a) { f = !0 }, this.allDOMEventHandlers); y(this._zoomButton, "click", function () { a.zoomEnabled ? (a.zoomEnabled = !1, a.panEnabled = !0, Ba(a, a._zoomButton, "zoom")) : (a.zoomEnabled = !0, a.panEnabled = !1, Ba(a, a._zoomButton, "pan")); a.render() }, this.allDOMEventHandlers); y(this._zoomButton, "mousemove", function () {
              ...
              (N(this._resetButton, { borderRight: this.toolbar.buttonBorderThickness + "px solid " + this.toolbar.buttonBorderColor, backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor }), this._resetButton.title = this._cultureInfo.resetText) : (f = !1, ya(this._resetButton = document.createElement("button")), Ba(this, this._resetButton, "reset"), this._resetButton.style.borderRight = (this.exportEnabled ? this.toolbar.buttonBorderThickness : 0) + "px solid " + this.toolbar.buttonBorderColor, this._toolBar.appendChild(this._resetButton),
                y(this._resetButton, "touchstart", function (a) { f = !0 }, this.allDOMEventHandlers), y(this._resetButton, "click", function () {
                  a.toolTip.hide(); a.toolTip && a.toolTip.enabled && a.toolTip.dispatchEvent("hidden", { chart: a, toolTip: a.toolTip }, a.toolTip); a.zoomEnabled || a.panEnabled ? (a.zoomEnabled = !0, a.panEnabled = !1, Ba(a, a._zoomButton, "pan"), a._defaultCursor = "default", a.overlaidCanvas.style.cursor = a._defaultCursor) : (a.zoomEnabled = !1, a.panEnabled = !1); if (a.sessionVariables.axisX) for (var b = 0; b < a.sessionVariables.axisX.length; b++)a.sessionVariables.axisX[b].newViewportMinimum =
          ...
          } else this.panEnabled = this.zoomEnabled = !1; hb(this); "none" !== this._toolBar.style.display && this._zoomButton && (this.panEnabled ? Ba(a, a._zoomButton, "zoom") : Ba(a, a._zoomButton, "pan"),
            a._resetButton.getAttribute("state") !== a._cultureInfo.resetText && Ba(a, a._resetButton, "reset")); this.options.toolTip && this.toolTip.options !== this.options.toolTip && (this.toolTip.options = this.options.toolTip); for (var c in this.toolTip.options) this.toolTip.options.hasOwnProperty(c) && this.toolTip.updateOption(c)
        }; s.prototype._updateSize = function () { return lb.call(this, [this.canvas, this.overlaidCanvas, this._eventManager.ghostCanvas]) }; s.prototype._initialize = function () {
        ...
        s.prototype.setLayout = function () {
          ...
          var a = this._plotAreaElements; this.title && !this.title.dockInsidePlotArea && this.title.render(); for (var f = 0; f < this.subtitles.length; f++)this.subtitles[f].dockInsidePlotArea || this.subtitles[f].render(); this.legend.dockInsidePlotArea ||
            this.legend.render(); if ("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) z.render(this.axisX, this.axisX2, this.axisY, this.axisY2, this.plotInfo.axisPlacement); else if ("none" === this.plotInfo.axisPlacement) this.preparePlotArea(); else return; for (f = 0; f < a.length; f++)a[f].setLayout(), a[f].render(); var c = []; if (this.animatedRender) { var b = sa(this.width, this.height); b.getContext("2d").drawImage(this.canvas, 0, 0, this.width, this.height) } sb(this); var a = this.ctx.miterLimit, e; this.ctx.miterLimit =
              3; u && this._breaksCanvas && (this._preRenderCtx.drawImage(this.canvas, 0, 0, this.width, this.height), this._preRenderCtx.drawImage(this._breaksCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx.globalCompositeOperation = "source-atop", this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), this._preRenderCtx.clearRect(0, 0, this.width, this.height)); for (f = 0; f < this.plotInfo.plotTypes.length; f++)for (var h = this.plotInfo.plotTypes[f], A = 0; A < h.plotUnits.length; A++) {
                ...
                }, function () { c = []; for (var a = 0; a < n.plotInfo.plotTypes.length; a++)for (var f = n.plotInfo.plotTypes[a], e = 0; e < f.plotUnits.length; e++) { var h = f.plotUnits[e]; h.targetCanvas && Ca(h.targetCanvas); h.targetCanvas = null } b = null; n.disableToolTip = !1; n.dispatchEvent("dataAnimationEnd", { chart: n }) }); else {
                  if (n._breaksCanvas) if (u) n.plotArea.ctx.drawImage(n._breaksCanvas, 0, 0, this.width, this.height); else for (m = 0; m < n._axes.length; m++)n._axes[m].createMask();
          ...
          } this.attachPlotAreaEventHandlers(); this.zoomEnabled || (this.panEnabled || !this._zoomButton || "none" === this._zoomButton.style.display) || ya(this._zoomButton, this._resetButton); this.toolTip._updateToolTip(); this.renderCount++; La && (n = this, setTimeout(function () {
        ...
        }; s.prototype.render = function (a) { a && (this.options = a); this._initialize(); this.setLayout(); this.renderElements(); this._preRenderCanvas && Ca(this._preRenderCanvas) }; s.prototype.attachPlotAreaEventHandlers = function () {
          this.attachEvent({
          ...
          if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var f = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, h = !1, A = 0; A < a.dataSeriesIndexes.length; A++) {
            ...
            d = 0, m = !1, n = !1, p; if ("normal" === g.axisPlacement || "xySwapped" === g.axisPlacement) var q = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : a.axisX.logarithmic ? 0 : -Infinity, l = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ?
              this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ? this.options.axisX.maximum : Infinity; if (g.dataPoints[d].x && g.dataPoints[d].x.getTime || "dateTime" === g.xValueType) h = !0; for (d = 0; d < g.dataPoints.length; d++) {
                ...
                e > f.max && "number" === typeof e && (f.max = e); if (0 < d) { if (a.axisX.logarithmic) { var r = b / g.dataPoints[d - 1].x; 1 > r && (r = 1 / r); c.minDiff > r && 1 !== r && (c.minDiff = r) } else r = b - g.dataPoints[d - 1].x, 0 > r && (r *= -1), c.minDiff > r && 0 !== r && (c.minDiff = r); null !== e && null !== g.dataPoints[d - 1].y && (a.axisY.logarithmic ? (r = e / g.dataPoints[d - 1].y, 1 > r && (r = 1 / r), f.minDiff > r && 1 !== r && (f.minDiff = r)) : (r = e - g.dataPoints[d - 1].y, 0 > r && (r *= -1), f.minDiff > r && 0 !== r && (f.minDiff = r))) } if (b < q && !m) null !== e && (p = b); else {
                  if (!m && (m = !0, 0 < d)) { d -= 2; continue } if (b > l &&
                    !n) n = !0; else if (b > l && n) continue; g.dataPoints[d].label && (a.axisX.labels[b] = g.dataPoints[d].label); b < c.viewPortMin && (c.viewPortMin = b); b > c.viewPortMax && (c.viewPortMax = b); null === e ? c.viewPortMin === b && p < b && (c.viewPortMin = p) : (e < f.viewPortMin && "number" === typeof e && (f.viewPortMin = e), e > f.viewPortMax && "number" === typeof e && (f.viewPortMax = e))
                }
          ...
          if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var f =
              a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, h = !1, A = [], d = [], K = Infinity, m = -Infinity, n = 0; n < a.dataSeriesIndexes.length; n++) {
                var p = this.data[a.dataSeriesIndexes[n]], q = 0, l = !1, r = !1, x; if ("normal" === p.axisPlacement || "xySwapped" === p.axisPlacement) var u = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity,
                  w = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ? this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ? this.options.axisX.maximum : Infinity; if (p.dataPoints[q].x && p.dataPoints[q].x.getTime || "dateTime" === p.xValueType) h = !0; for (q = 0; q < p.dataPoints.length; q++) {
                    "undefined" === typeof p.dataPoints[q].x && (p.dataPoints[q].x = q + (a.axisX.logarithmic ? 1 : 0)); p.dataPoints[q].x.getTime ? (h = !0, b = p.dataPoints[q].x.getTime()) :
                      b = p.dataPoints[q].x; e = g(p.dataPoints[q].y) ? 0 : p.dataPoints[q].y; b < c.min && (c.min = b); b > c.max && (c.max = b); if (0 < q) { if (a.axisX.logarithmic) { var B = b / p.dataPoints[q - 1].x; 1 > B && (B = 1 / B); c.minDiff > B && 1 !== B && (c.minDiff = B) } else B = b - p.dataPoints[q - 1].x, 0 > B && (B *= -1), c.minDiff > B && 0 !== B && (c.minDiff = B); null !== e && null !== p.dataPoints[q - 1].y && (a.axisY.logarithmic ? 0 < e && (B = e / p.dataPoints[q - 1].y, 1 > B && (B = 1 / B), f.minDiff > B && 1 !== B && (f.minDiff = B)) : (B = e - p.dataPoints[q - 1].y, 0 > B && (B *= -1), f.minDiff > B && 0 !== B && (f.minDiff = B))) } if (b < u &&
                        !l) null !== p.dataPoints[q].y && (x = b); else {
            ...
            } for (q in A) A.hasOwnProperty(q) && !isNaN(q) && (a = A[q], a < f.min && (f.min = Math.min(a, K)), a > f.max && (f.max = a), q < c.viewPortMin || q > c.viewPortMax ||
              (a < f.viewPortMin && (f.viewPortMin = Math.min(a, K)), a > f.viewPortMax && (f.viewPortMax = a))); for (q in d) d.hasOwnProperty(q) && !isNaN(q) && (a = d[q], a < f.min && (f.min = a), a > f.max && (f.max = Math.max(a, m)), q < c.viewPortMin || q > c.viewPortMax || (a < f.viewPortMin && (f.viewPortMin = a), a > f.viewPortMax && (f.viewPortMax = Math.max(a, m))))
          }
              ...
              var n =
                this.data[a.dataSeriesIndexes[m]], p = 0, q = !1, l = !1, r; if ("normal" === n.axisPlacement || "xySwapped" === n.axisPlacement) var x = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity, u = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ?
                  this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ? this.options.axisX.maximum : Infinity; if (n.dataPoints[p].x && n.dataPoints[p].x.getTime || "dateTime" === n.xValueType) h = !0; for (p = 0; p < n.dataPoints.length; p++) {
                    ...
                    } if (b < x && !q) null !== e && (r = b); else {
                      if (!q && (q = !0, 0 < p)) { p -= 2; continue } if (b > u && !l) l = !0; else if (b > u && l) continue; n.dataPoints[p].label && (a.axisX.labels[b] = n.dataPoints[p].label);
                      b < c.viewPortMin && (c.viewPortMin = b); b > c.viewPortMax && (c.viewPortMax = b); null === e ? c.viewPortMin === b && r < b && (c.viewPortMin = r) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e, a.yAbsTotals[b] = (a.yAbsTotals[b] ? a.yAbsTotals[b] : 0) + Math.abs(e), 0 <= e ? A = !0 : 0 > e && (d = !0), K[b] = K[b] ? K[b] + Math.abs(e) : Math.abs(e))
                    }
          ...
          if (a.dataSeriesIndexes &&
            !(1 > a.dataSeriesIndexes.length)) for (var f = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, h, A, g = !1, d = 0; d < a.dataSeriesIndexes.length; d++) {
              var m = this.data[a.dataSeriesIndexes[d]], n = 0, p = !1, q = !1, l, r, x; if ("normal" === m.axisPlacement || "xySwapped" === m.axisPlacement) var u = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum :
                a.axisX.logarithmic ? 0 : -Infinity, w = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ? this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ? this.options.axisX.maximum : Infinity; if (m.dataPoints[n].x && m.dataPoints[n].x.getTime || "dateTime" === m.xValueType) g = !0; for (n = 0; n < m.dataPoints.length; n++) {
                  "undefined" === typeof m.dataPoints[n].x && (m.dataPoints[n].x = n + (a.axisX.logarithmic ? 1 : 0)); m.dataPoints[n].x.getTime ?
                    (g = !0, b = m.dataPoints[n].x.getTime()) : b = m.dataPoints[n].x; if ((e = m.dataPoints[n].y) && e.length) { h = Math.min.apply(null, e); A = Math.max.apply(null, e); r = !0; for (var B = 0; B < e.length; B++)null === e.k && (r = !1); r && (p || (x = l), l = b) } b < c.min && (c.min = b); b > c.max && (c.max = b); h < f.min && (f.min = h); A > f.max && (f.max = A); 0 < n && (a.axisX.logarithmic ? (r = b / m.dataPoints[n - 1].x, 1 > r && (r = 1 / r), c.minDiff > r && 1 !== r && (c.minDiff = r)) : (r = b - m.dataPoints[n - 1].x, 0 > r && (r *= -1), c.minDiff > r && 0 !== r && (c.minDiff = r)), e && (null !== e[0] && m.dataPoints[n - 1].y && null !==
                      m.dataPoints[n - 1].y[0]) && (a.axisY.logarithmic ? (r = e[0] / m.dataPoints[n - 1].y[0], 1 > r && (r = 1 / r), f.minDiff > r && 1 !== r && (f.minDiff = r)) : (r = e[0] - m.dataPoints[n - 1].y[0], 0 > r && (r *= -1), f.minDiff > r && 0 !== r && (f.minDiff = r)))); if (!(b < u) || p) {
                        if (!p && (p = !0, 0 < n)) { n -= 2; l = x; continue } if (b > w && !q) q = !0; else if (b > w && q) continue; m.dataPoints[n].label && (a.axisX.labels[b] = m.dataPoints[n].label); b < c.viewPortMin && (c.viewPortMin = b); b > c.viewPortMax && (c.viewPortMax = b); if (c.viewPortMin === b && e) for (B = 0; B < e.length; B++)if (null === e[B] && l < b) {
                          c.viewPortMin =
                          l; break
                        } null === e ? c.viewPortMin === b && l < b && (c.viewPortMin = l) : (h < f.viewPortMin && (f.viewPortMin = h), A > f.viewPortMax && (f.viewPortMax = A))
                      }
                ...
                this.options.axisX.maximum ? this.options.axisX.maximum : Infinity; if (g.dataPoints[d].x && g.dataPoints[d].x.getTime || "dateTime" === g.xValueType) h = !0; for (d = 0; d < g.dataPoints.length; d++)"undefined" !== typeof g.dataPoints[d].isCumulativeSum && !0 === g.dataPoints[d].isCumulativeSum ? (g.dataPointEOs[d].cumulativeSumYStartValue = 0, g.dataPointEOs[d].cumulativeSum = 0 === d ? 0 : g.dataPointEOs[d - 1].cumulativeSum, g.dataPoints[d].y = 0 === d ? 0 : g.dataPointEOs[d - 1].cumulativeSum) : "undefined" !== typeof g.dataPoints[d].isIntermediateSum &&
                  !0 === g.dataPoints[d].isIntermediateSum ? (g.dataPointEOs[d].cumulativeSumYStartValue = p, g.dataPointEOs[d].cumulativeSum = 0 === d ? 0 : g.dataPointEOs[d - 1].cumulativeSum, g.dataPoints[d].y = 0 === d ? 0 : b, p = 0 === d ? 0 : g.dataPointEOs[d - 1].cumulativeSum, b = 0) : (e = "number" !== typeof g.dataPoints[d].y ? 0 : g.dataPoints[d].y, g.dataPointEOs[d].cumulativeSumYStartValue = 0 === d ? 0 : g.dataPointEOs[d - 1].cumulativeSum, g.dataPointEOs[d].cumulativeSum = 0 === d ? e : g.dataPointEOs[d - 1].cumulativeSum + e, b += e); for (d = 0; d < g.dataPoints.length; d++)if ("undefined" ===
                    typeof g.dataPoints[d].x && (g.dataPoints[d].x = d + (a.axisX.logarithmic ? 1 : 0)), g.dataPoints[d].x.getTime ? (h = !0, b = g.dataPoints[d].x.getTime()) : b = g.dataPoints[d].x, e = g.dataPoints[d].y, b < c.min && (c.min = b), b > c.max && (c.max = b), g.dataPointEOs[d].cumulativeSum < f.min && (f.min = g.dataPointEOs[d].cumulativeSum), g.dataPointEOs[d].cumulativeSum > f.max && (f.max = g.dataPointEOs[d].cumulativeSum), 0 < d && (a.axisX.logarithmic ? (p = b / g.dataPoints[d - 1].x, 1 > p && (p = 1 / p), c.minDiff > p && 1 !== p && (c.minDiff = p)) : (p = b - g.dataPoints[d - 1].x, 0 > p &&
                      (p *= -1), c.minDiff > p && 0 !== p && (c.minDiff = p)), null !== e && null !== g.dataPoints[d - 1].y && (a.axisY.logarithmic ? (e = g.dataPointEOs[d].cumulativeSum / g.dataPointEOs[d - 1].cumulativeSum, 1 > e && (e = 1 / e), f.minDiff > e && 1 !== e && (f.minDiff = e)) : (e = g.dataPointEOs[d].cumulativeSum - g.dataPointEOs[d - 1].cumulativeSum, 0 > e && (e *= -1), f.minDiff > e && 0 !== e && (f.minDiff = e)))), !(b < q) || m) {
                        if (!m && (m = !0, 0 < d)) { d -= 2; continue } if (b > l && !n) n = !0; else if (b > l && n) continue; g.dataPoints[d].label && (a.axisX.labels[b] = g.dataPoints[d].label); b < c.viewPortMin &&
        ...
        s.prototype.calculateAutoBreaks = function () {
          function a(a, b, c, f) { if (f) return c = Math.pow(Math.min(c * a / b, b / a), 0.2), 1 >= c && (c = Math.pow(1 > a ? 1 / a : Math.min(b / a, a), 0.25)), { startValue: a * c, endValue: b / c }; c = 0.2 * Math.min(c - b + a, b - a); 0 >= c && (c = 0.25 * Math.min(b - a, Math.abs(a))); return { startValue: a + c, endValue: b - c } } function f(a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
              var b = a.axisX.scaleBreaks && a.axisX.scaleBreaks.autoCalculate && 1 <= a.axisX.scaleBreaks.maxNumberOfAutoBreaks, c = a.axisY.scaleBreaks && a.axisY.scaleBreaks.autoCalculate &&
                1 <= a.axisY.scaleBreaks.maxNumberOfAutoBreaks; if (b || c) for (var f = a.axisY.dataInfo, h = a.axisX.dataInfo, l, A = h.min, m = h.max, d = f.min, n = f.max, h = h._dataRanges, f = f._dataRanges, p, q = 0, ua = 0; ua < a.dataSeriesIndexes.length; ua++) {
                  var x = e.data[a.dataSeriesIndexes[ua]]; if (!(4 > x.dataPoints.length)) for (q = 0; q < x.dataPoints.length; q++)if (b && (p = (m + 1 - A) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, l = x.dataPoints[q].x.getTime ? x.dataPoints[q].x.getTime() : x.dataPoints[q].x, p = Math.floor((l - A) / p), l <
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length) &&
              a.axisX.scaleBreaks && a.axisX.scaleBreaks.autoCalculate && 1 <= a.axisX.scaleBreaks.maxNumberOfAutoBreaks) for (var b = a.axisX.dataInfo, c = b.min, f = b.max, h = b._dataRanges, l, A = 0, m = 0; m < a.dataSeriesIndexes.length; m++) {
                var g = e.data[a.dataSeriesIndexes[m]]; if (!(4 > g.dataPoints.length)) for (A = 0; A < g.dataPoints.length; A++)l = (f + 1 - c) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, b = g.dataPoints[A].x.getTime ? g.dataPoints[A].x.getTime() : g.dataPoints[A].x, l = Math.floor((b - c) / l), b < h[l].min && (h[l].min =
            ...
            for (A = 0; A < this.plotInfo.plotTypes.length; A++)for (h = this.plotInfo.plotTypes[A], d = 0; d <
              h.plotUnits.length; d++)b = h.plotUnits[d], "line" === b.type || "stepLine" === b.type || "spline" === b.type || "column" === b.type || "area" === b.type || "stepArea" === b.type || "splineArea" === b.type || "bar" === b.type || "bubble" === b.type || "scatter" === b.type || "candlestick" === b.type || "ohlc" === b.type || "rangeColumn" === b.type || "rangeBar" === b.type || "rangeArea" === b.type || "rangeSplineArea" === b.type || "waterfall" === b.type || "error" === b.type || "boxAndWhisker" === b.type ? f(b) : 0 <= b.type.indexOf("stacked") && c(b); for (A = 0; A < this._axes.length; A++)if (this._axes[A].dataInfo._dataRanges) {
                var x =
                  this._axes[A].dataInfo.min; b = (this._axes[A].dataInfo.max + 1 - x) * Math.max(parseFloat(this._axes[A].scaleBreaks.collapsibleThreshold) || 10, 10) / 100; var m = this._axes[A].dataInfo._dataRanges, n, p, h = []; if (this._axes[A].dataInfo.dataPointYPositiveSums) { var q = this._axes[A].dataInfo.dataPointYPositiveSums; n = m; for (d in q) if (q.hasOwnProperty(d) && !isNaN(d) && (p = q[d], !g(p))) { var l = Math.floor((p - x) / b); p < n[l].min && (n[l].min = p); p > n[l].max && (n[l].max = p) } delete this._axes[A].dataInfo.dataPointYPositiveSums } if (this._axes[A].dataInfo.dataPointYNegativeSums) {
                    q =
                    this._axes[A].dataInfo.dataPointYNegativeSums; n = m; for (d in q) q.hasOwnProperty(d) && !isNaN(d) && (p = -1 * q[d], g(p) || (l = Math.floor((p - x) / b), p < n[l].min && (n[l].min = p), p > n[l].max && (n[l].max = p))); delete this._axes[A].dataInfo.dataPointYNegativeSums
          ...
          function (a, f, c) {
            ...
            function () { this.overlaidCanvasCtx.clearRect(0, 0, this.width, this.height) }; s.prototype.clearCanvas = mb; s.prototype.attachEvent = function (a) { this._events.push(a) }; s.prototype._touchEventHandler = function (a) {
              if (a.changedTouches && this.interactivityEnabled) {
                var f = [], c = a.changedTouches, b = c ? c[0] : a, e = null; switch (a.type) {
                  case "touchstart": case "MSPointerDown": f = ["mousemove", "mousedown"]; this._lastTouchData = Aa(b); this._lastTouchData.time = new Date; break; case "touchmove": case "MSPointerMove": f = ["mousemove"]; break;
                  ...
                  e = Aa(b); e.time = new Date; try { var A = e.y - this._lastTouchData.y, h = e.time - this._lastTouchData.time; if (1 < Math.abs(A) && this._lastTouchData.scroll || 5 < Math.abs(A) && 250 > h) this._lastTouchData.scroll = !0 } catch (d) { } this._lastTouchEventType =
        ...
        s.prototype._dispatchRangeEvent = function (a, f) {
          ...
          e = e || !1; for (var h = 0 <= this.zoomType.indexOf("x"), g = 0 <= this.zoomType.indexOf("y"), d = !1, x = [], m = [], n = [], p = 0; p < this._axes.length; p++)("axisX" === this._axes[p].type &&
            h || "axisY" === this._axes[p].type && g) && m.push(this._axes[p]); for (g = 0; g < m.length; g++) {
              var p = m[g], h = !1, q = p.convertPixelToValue({ x: a, y: f }), l = p.convertPixelToValue({ x: c, y: b }); if (q > l) var r = l, l = q, q = r; if (p.scaleBreaks) for (r = 0; !h && r < p.scaleBreaks._appliedBreaks.length; r++)h = p.scaleBreaks._appliedBreaks[r].startValue <= q && p.scaleBreaks._appliedBreaks[r].endValue >= l; if (isFinite(p.dataInfo.minDiff)) if (r = p.getApparentDifference(q, l, null, !0), !(h || !(this.panEnabled && p.scaleBreaks && p.scaleBreaks._appliedBreaks.length) &&
                (p.logarithmic && r < Math.pow(p.dataInfo.minDiff, 3) || !p.logarithmic && r < 3 * Math.abs(p.dataInfo.minDiff)) || q < p.minimum || l > p.maximum)) x.push(p), n.push({ val1: q, val2: l }), d = !0; else if (!e) { d = !1; break }
          ...
          } else f = this.layoutManager.getFreeSpace(), a.x1 = f.x1, a.x2 = f.x2, a.y1 = f.y1, a.y2 = f.y2, a.width = f.width, a.height = f.height; u || (a.canvas.width = a.width, a.canvas.height = a.height, a.canvas.style.left = a.x1 + "px", a.canvas.style.top = a.y1 + "px", (0 < a.x1 || 0 < a.y1) && a.ctx.translate(-a.x1, -a.y1)); a.layoutManager = new Ka(a.x1, a.y1, a.x2, a.y2, 2)
          ...
          b = 0, e = 0, h = 0, A = h = e = 0, d = 0, K = b = 0, m = 0; for (a = 0; a < this._indexLabels.length; a++) {
            ...
            l = ra("indexLabelWrap", n.dataPoint, n.dataSeries); var ha = ra("indexLabelLineDashType", n.dataPoint, n.dataSeries), w = ra("indexLabelLineColor", n.dataPoint, n.dataSeries), B = g(n.dataPoint.indexLabelLineThickness) ? g(n.dataSeries.options.indexLabelLineThickness) ? 0 : n.dataSeries.options.indexLabelLineThickness : n.dataPoint.indexLabelLineThickness, b = 0 < B ? Math.min(10, ("normal" === this.plotInfo.axisPlacement ? this.plotArea.height : this.plotArea.width) << 0) : 0, k = { percent: null, total: null }, v = null; if (0 <= n.dataSeries.type.indexOf("stacked") ||
              "pie" === n.dataSeries.type || "doughnut" === n.dataSeries.type) k = this.getPercentAndTotal(n.dataSeries, n.dataPoint); if (n.dataSeries.indexLabelFormatter || n.dataPoint.indexLabelFormatter) v = { chart: this, dataSeries: n.dataSeries, dataPoint: n.dataPoint, index: n.indexKeyword, total: k.total, percent: k.percent }; var s = n.dataPoint.indexLabelFormatter ? n.dataPoint.indexLabelFormatter(v) : n.dataPoint.indexLabel ? this.replaceKeywordsWithValue(n.dataPoint.indexLabel, n.dataPoint, n.dataSeries, null, n.indexKeyword) : n.dataSeries.indexLabelFormatter ?
                n.dataSeries.indexLabelFormatter(v) : n.dataSeries.indexLabel ? this.replaceKeywordsWithValue(n.dataSeries.indexLabel, n.dataPoint, n.dataSeries, null, n.indexKeyword) : null; if (null !== s && "" !== s) {
                  var k = ra("indexLabelPlacement", n.dataPoint, n.dataSeries), v = ra("indexLabelOrientation", n.dataPoint, n.dataSeries), D = ra("indexLabelTextAlign", n.dataPoint, n.dataSeries), y = n.direction, e = n.dataSeries.axisX, h = n.dataSeries.axisY, z = !1, t = new na(f, {
                    x: 0, y: 0, maxWidth: q ? q : 0.5 * this.width, maxHeight: l ? 5 * r : 1.5 * r, angle: "horizontal" ===
                      v ? 0 : -90, text: s, padding: 0, backgroundColor: t, textAlign: D, fontSize: r, fontFamily: d, fontWeight: m, fontColor: A, fontStyle: K, textBaseline: "middle"
                  }); t.measureText(); n.dataSeries.indexLabelMaxWidth = t.maxWidth; if ("stackedarea100" === p) { if (n.point.x < c.x1 || n.point.x > c.x2 || n.point.y < c.y1 - 1 || n.point.y > c.y2 + 1) continue } else if ("rangearea" === p || "rangesplinearea" === p) {
                    ...
                    0 <= p.indexOf("scatter") ? (k = "auto", A = 4) : 0 <= p.indexOf("stacked") ? "auto" === k && (k = "inside") : "bubble" === p && (k = "inside"), l = n.point.y + r / 2 - m / 2 + d, "inside" !== k ? (e = c.x1, h = c.x2, 0 > y ? (q = n.point.x - ("horizontal" === v ? K : K - r / 2) - A - b, q < e && (q = "auto" === k ? Math.max(n.point.x, e) + A : e + A, z = q + K > n.point.x)) : (q = n.point.x + ("horizontal" === v ? 0 : r / 2) + A + b, q > h - K - A - b && (q = "auto" === k ? Math.min(n.point.x, h) - ("horizontal" === v ? K : K / 2) - A : h - K - A, z = q < n.point.x))) : (e = Math.max(n.bounds.x1, c.x1), Math.min(n.bounds.x2, c.x2), b = 0 <= p.indexOf("range") || "error" ===
                      p ? 0 > y ? Math.max(n.bounds.x1, c.x1) + r / 2 + A : Math.min(n.bounds.x2, c.x2) - K / 2 - A + ("horizontal" === v ? 0 : r / 2) : (Math.max(n.bounds.x1, c.x1) + Math.min(n.bounds.x2, c.x2)) / 2 + ("horizontal" === v ? 0 : r / 2), q = 0 > y ? Math.max(n.point.x, b) - ("horizontal" === v ? K / 2 : 0) : Math.min(n.point.x, b) - K / 2, q = Math.max(q, e)); "vertical" === v && (l += m - r / 2); t.x = q; t.y = l; t.render(!0); B && ("inside" !== k && (0 > p.indexOf("bar") && ("error" !== p || !n.axisSwapped) && n.point.x > c.x1 && n.point.x < c.x2 || !z) && (0 > p.indexOf("column") && ("error" !== p || n.axisSwapped) && n.point.y > c.y1 &&
                        n.point.y < c.y2 || !z)) && (f.lineWidth = B, f.strokeStyle = w ? w : "gray", f.setLineDash && f.setLineDash(T(ha, B)), f.beginPath(), f.moveTo(n.point.x, n.point.y), 0 <= p.indexOf("bar") || "error" === p && n.axisSwapped ? f.lineTo(q + (0 < n.direction ? -A : K + A) + ("vertical" === v ? -r / 2 : 0), l + ("vertical" === v ? -m / 2 : m / 2 - r / 2) - d) : 0 <= p.indexOf("column") || "error" === p && !n.axisSwapped ? f.lineTo(q + K / 2 - ("horizontal" === v ? 0 : r / 2), l + ("vertical" === v ? (l - m < n.point.y ? 0 : -m) + d : (l - r / 2 < n.point.y ? m : 0) - r / 2)) : f.lineTo(q + K / 2 - ("horizontal" === v ? 0 : r / 2), l + ("vertical" ===
                          v ? l - m < n.point.y ? 0 : -m : (l - r / 2 < n.point.y ? m : 0) - r / 2)), f.stroke())
                }
          } f = { source: f, dest: this.plotArea.ctx, animationCallback: x.fadeInAnimation, easingFunction: x.easing.easeInQuad, animationBase: 0, startTimePercent: 0.7 }; for (a = 0; a < this._indexLabels.length; a++)n = this._indexLabels[a], t = ra("indexLabelBackgroundColor", n.dataPoint, n.dataSeries), n.dataSeries.indexLabelBackgroundColor = g(t) ? u ? "transparent" : null : t; return f
        }; s.prototype.renderLine = function (a) {
          var f = a.targetCanvasCtx || this.plotArea.ctx, c = u ? this._preRenderCtx :
            f; if (!(0 >= a.dataSeriesIndexes.length)) {
              var b = this._eventManager.ghostCtx; c.save(); var e = this.plotArea; c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); for (var h = [], g, d = 0; d < a.dataSeriesIndexes.length; d++) {
                var K = a.dataSeriesIndexes[d], m = this.data[K]; c.lineWidth = m.lineThickness; var n = m.dataPoints, p = "solid"; if (c.setLineDash) { var q = T(m.nullDataLineDashType, m.lineThickness), p = m.lineDashType, l = T(p, m.lineThickness); c.setLineDash(l) } var r = m.id; this._eventManager.objectMap[r] = {
                  objectType: "dataSeries",
                  dataSeriesIndex: K
                }; r = R(r); b.strokeStyle = r; b.lineWidth = 0 < m.lineThickness ? Math.max(m.lineThickness, 4) : 0; var r = m._colorSet, k = r = m.lineColor = m.options.lineColor ? m.options.lineColor : r[0]; c.strokeStyle = r; var ha = !0, w = 0, B, v; c.beginPath(); if (0 < n.length) {
                  for (var s = !1, w = 0; w < n.length; w++)if (B = n[w].x.getTime ? n[w].x.getTime() : n[w].x, !(B < a.axisX.dataInfo.viewPortMin || B > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !s))) if ("number" !== typeof n[w].y) 0 < w && !(m.connectNullData || s || ha) && (c.stroke(), u && b.stroke()),
                    s = !0; else {
                      B = a.axisX.convertValueToPixel(B); v = a.axisY.convertValueToPixel(n[w].y); var I = m.dataPointIds[w]; this._eventManager.objectMap[I] = { id: I, objectType: "dataPoint", dataSeriesIndex: K, dataPointIndex: w, x1: B, y1: v }; ha || s ? (!ha && m.connectNullData ? (c.setLineDash && (m.options.nullDataLineDashType || p === m.lineDashType && m.lineDashType !== m.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(g.x, g.y), p = m.nullDataLineDashType, c.setLineDash(q)), c.lineTo(B, v), u && b.lineTo(B, v)) : (c.beginPath(), c.moveTo(B, v),
                        u && (b.beginPath(), b.moveTo(B, v))), s = ha = !1) : (c.lineTo(B, v), u && b.lineTo(B, v), 0 == w % 500 && (c.stroke(), c.beginPath(), c.moveTo(B, v), u && (b.stroke(), b.beginPath(), b.moveTo(B, v)))); g = { x: B, y: v }; w < n.length - 1 && (k !== (n[w].lineColor || r) || p !== (n[w].lineDashType || m.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(B, v), k = n[w].lineColor || r, c.strokeStyle = k, c.setLineDash && (n[w].lineDashType ? (p = n[w].lineDashType, c.setLineDash(T(p, m.lineThickness))) : (p = m.lineDashType, c.setLineDash(l)))); if (0 < n[w].markerSize || 0 < m.markerSize) {
                          var D =
                            m.getMarkerProperties(w, B, v, c); h.push(D); I = R(I); u && h.push({ x: B, y: v, ctx: b, type: D.type, size: D.size, color: I, borderColor: I, borderThickness: D.borderThickness })
                        } (n[w].indexLabel || m.indexLabel || n[w].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({ chartType: "line", dataPoint: n[w], dataSeries: m, point: { x: B, y: v }, direction: 0 > n[w].y === a.axisY.reversed ? 1 : -1, color: r })
                  } c.stroke(); u && b.stroke()
                }
              } t.drawMarkers(h); u && (f.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation =
          ...
          function (a) {
            var f = a.targetCanvasCtx || this.plotArea.ctx, c = u ? this._preRenderCtx : f; if (!(0 >= a.dataSeriesIndexes.length)) {
              var b = this._eventManager.ghostCtx; c.save(); var e = this.plotArea; c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); for (var h = [], g, d = 0; d < a.dataSeriesIndexes.length; d++) {
                var K = a.dataSeriesIndexes[d], m = this.data[K]; c.lineWidth = m.lineThickness; var n = m.dataPoints, p = "solid"; if (c.setLineDash) { var q = T(m.nullDataLineDashType, m.lineThickness), p = m.lineDashType, l = T(p, m.lineThickness); c.setLineDash(l) } var r =
                  m.id; this._eventManager.objectMap[r] = { objectType: "dataSeries", dataSeriesIndex: K }; r = R(r); b.strokeStyle = r; b.lineWidth = 0 < m.lineThickness ? Math.max(m.lineThickness, 4) : 0; var r = m._colorSet, k = r = m.lineColor = m.options.lineColor ? m.options.lineColor : r[0]; c.strokeStyle = r; var ha = !0, w = 0, B, v; c.beginPath(); if (0 < n.length) {
                    for (var s = !1, w = 0; w < n.length; w++)if (B = n[w].getTime ? n[w].x.getTime() : n[w].x, !(B < a.axisX.dataInfo.viewPortMin || B > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !s))) if ("number" !== typeof n[w].y) 0 <
                      w && !(m.connectNullData || s || ha) && (c.stroke(), u && b.stroke()), s = !0; else {
                        var I = v; B = a.axisX.convertValueToPixel(B); v = a.axisY.convertValueToPixel(n[w].y); var D = m.dataPointIds[w]; this._eventManager.objectMap[D] = { id: D, objectType: "dataPoint", dataSeriesIndex: K, dataPointIndex: w, x1: B, y1: v }; ha || s ? (!ha && m.connectNullData ? (c.setLineDash && (m.options.nullDataLineDashType || p === m.lineDashType && m.lineDashType !== m.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(g.x, g.y), p = m.nullDataLineDashType, c.setLineDash(q)),
                          c.lineTo(B, I), c.lineTo(B, v), u && (b.lineTo(B, I), b.lineTo(B, v))) : (c.beginPath(), c.moveTo(B, v), u && (b.beginPath(), b.moveTo(B, v))), s = ha = !1) : (c.lineTo(B, I), u && b.lineTo(B, I), c.lineTo(B, v), u && b.lineTo(B, v), 0 == w % 500 && (c.stroke(), c.beginPath(), c.moveTo(B, v), u && (b.stroke(), b.beginPath(), b.moveTo(B, v)))); g = { x: B, y: v }; w < n.length - 1 && (k !== (n[w].lineColor || r) || p !== (n[w].lineDashType || m.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(B, v), k = n[w].lineColor || r, c.strokeStyle = k, c.setLineDash && (n[w].lineDashType ? (p = n[w].lineDashType,
                            c.setLineDash(T(p, m.lineThickness))) : (p = m.lineDashType, c.setLineDash(l)))); if (0 < n[w].markerSize || 0 < m.markerSize) I = m.getMarkerProperties(w, B, v, c), h.push(I), D = R(D), u && h.push({ x: B, y: v, ctx: b, type: I.type, size: I.size, color: D, borderColor: D, borderThickness: I.borderThickness }); (n[w].indexLabel || m.indexLabel || n[w].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({ chartType: "stepLine", dataPoint: n[w], dataSeries: m, point: { x: B, y: v }, direction: 0 > n[w].y === a.axisY.reversed ? 1 : -1, color: r })
                    } c.stroke();
                    u && b.stroke()
                  }
              } t.drawMarkers(h); u && (f.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(e.x1, e.y1, e.width, e.height), b.beginPath()); c.restore(); c.beginPath(); return {
            ...
            function f(a) {
              ...
              var h = this.plotArea; b.beginPath(); b.rect(h.x1, h.y1, h.width, h.height); b.clip(); for (var g = [], d = 0; d < a.dataSeriesIndexes.length; d++) {
                var K = a.dataSeriesIndexes[d], m = this.data[K]; b.lineWidth = m.lineThickness; var n = m.dataPoints, p = "solid"; if (b.setLineDash) { var q = T(m.nullDataLineDashType, m.lineThickness), p = m.lineDashType, l = T(p, m.lineThickness); b.setLineDash(l) } var r = m.id; this._eventManager.objectMap[r] = { objectType: "dataSeries", dataSeriesIndex: K }; r = R(r); e.strokeStyle = r; e.lineWidth = 0 < m.lineThickness ? Math.max(m.lineThickness,
                  4) : 0; var r = m._colorSet, k = r = m.lineColor = m.options.lineColor ? m.options.lineColor : r[0]; b.strokeStyle = r; var ha = 0, w, B, v = []; b.beginPath(); if (0 < n.length) for (B = !1, ha = 0; ha < n.length; ha++)if (w = n[ha].getTime ? n[ha].x.getTime() : n[ha].x, !(w < a.axisX.dataInfo.viewPortMin || w > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !B))) if ("number" !== typeof n[ha].y) 0 < ha && !B && (m.connectNullData ? b.setLineDash && (0 < v.length && (m.options.nullDataLineDashType || !n[ha - 1].lineDashType)) && (v[v.length - 1].newLineDashArray = q, p = m.nullDataLineDashType) :
                    (f(v), v = [])), B = !0; else {
                      w = a.axisX.convertValueToPixel(w); B = a.axisY.convertValueToPixel(n[ha].y); var s = m.dataPointIds[ha]; this._eventManager.objectMap[s] = { id: s, objectType: "dataPoint", dataSeriesIndex: K, dataPointIndex: ha, x1: w, y1: B }; v[v.length] = { x: w, y: B }; ha < n.length - 1 && (k !== (n[ha].lineColor || r) || p !== (n[ha].lineDashType || m.lineDashType)) && (k = n[ha].lineColor || r, v[v.length - 1].newStrokeStyle = k, b.setLineDash && (n[ha].lineDashType ? (p = n[ha].lineDashType, v[v.length - 1].newLineDashArray = T(p, m.lineThickness)) : (p =
                        m.lineDashType, v[v.length - 1].newLineDashArray = l))); if (0 < n[ha].markerSize || 0 < m.markerSize) { var I = m.getMarkerProperties(ha, w, B, b); g.push(I); s = R(s); u && g.push({ x: w, y: B, ctx: e, type: I.type, size: I.size, color: s, borderColor: s, borderThickness: I.borderThickness }) } (n[ha].indexLabel || m.indexLabel || n[ha].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({ chartType: "spline", dataPoint: n[ha], dataSeries: m, point: { x: w, y: B }, direction: 0 > n[ha].y === a.axisY.reversed ? 1 : -1, color: r }); B = !1
                  } f(v)
              } t.drawMarkers(g);
              ...
              var b = null, e = this.plotArea, h = 0, g, d, K, m = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), h = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, n = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth :
                Math.min(0.15 * this.width, 0.9 * (this.plotArea.width / a.plotType.totalDataSeries)) << 0, p = a.axisX.dataInfo.minDiff; isFinite(p) || (p = 0.3 * Math.abs(a.axisX.range)); p = this.dataPointWidth = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * (e.width * (a.axisX.logarithmic ? Math.log(p) / Math.log(a.axisX.range) : Math.abs(p) / Math.abs(a.axisX.range)) / a.plotType.totalDataSeries) << 0; this.dataPointMaxWidth && h > n && (h = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, n)); !this.dataPointMaxWidth && (this.dataPointMinWidth &&
                  n < h) && (n = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, h)); p < h && (p = h); p > n && (p = n); c.save(); u && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); u && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                    var q = a.dataSeriesIndexes[n], l = this.data[q], r = l.dataPoints; if (0 < r.length) for (var k = 5 < p && l.bevelEnabled ? !0 : !1, h =
                      0; h < r.length; h++)if (r[h].getTime ? K = r[h].x.getTime() : K = r[h].x, !(K < a.axisX.dataInfo.viewPortMin || K > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[h].y) {
                        g = a.axisX.convertValueToPixel(K); d = a.axisY.convertValueToPixel(r[h].y); g = a.axisX.reversed ? g + a.plotType.totalDataSeries * p / 2 - (a.previousDataSeriesCount + n) * p << 0 : g - a.plotType.totalDataSeries * p / 2 + (a.previousDataSeriesCount + n) * p << 0; var t = a.axisX.reversed ? g - p << 0 : g + p << 0, w; 0 <= r[h].y ? w = m : (w = d, d = m); d > w && (b = d, d = w, w = b); b = r[h].color ? r[h].color : l._colorSet[h % l._colorSet.length];
                        Z(c, a.axisX.reversed ? t : g, d, a.axisX.reversed ? g : t, w, b, 0, null, k && (a.axisY.reversed ? 0 > r[h].y : 0 <= r[h].y), (a.axisY.reversed ? 0 <= r[h].y : 0 > r[h].y) && k, !1, !1, l.fillOpacity); b = l.dataPointIds[h]; this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: h, x1: g, y1: d, x2: t, y2: w }; b = R(b); u && Z(this._eventManager.ghostCtx, a.axisX.reversed ? t : g, d, a.axisX.reversed ? g : t, w, b, 0, null, !1, !1, !1, !1); (r[h].indexLabel || l.indexLabel || r[h].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({
                          chartType: "column",
                          dataPoint: r[h], dataSeries: l, point: { x: g + (t - g) / 2, y: 0 > r[h].y === a.axisY.reversed ? d : w }, direction: 0 > r[h].y === a.axisY.reversed ? 1 : -1, bounds: { x1: g, y1: Math.min(d, w), x2: t, y2: Math.max(d, w) }, color: b
                        })
                      }
            ...
            var f = a.targetCanvasCtx || this.plotArea.ctx, c = u ? this._preRenderCtx : f; if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              h = [], g = [], d = [], K = [], m = 0, n, p, q = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), m = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, l = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.15 * this.width << 0, r = a.axisX.dataInfo.minDiff; isFinite(r) || (r = 0.3 * Math.abs(a.axisX.range)); r = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * (e.width * (a.axisX.logarithmic ? Math.log(r) /
                Math.log(a.axisX.range) : Math.abs(r) / Math.abs(a.axisX.range)) / a.plotType.plotUnits.length) << 0; this.dataPointMaxWidth && m > l && (m = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, l)); !this.dataPointMaxWidth && (this.dataPointMinWidth && l < m) && (l = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, m)); r < m && (r = m); r > l && (r = l); c.save(); u && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); u && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1,
                  e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (l = 0; l < a.dataSeriesIndexes.length; l++) {
                    var t = a.dataSeriesIndexes[l], k = this.data[t], w = k.dataPoints; if (0 < w.length) {
                      var v = 5 < r && k.bevelEnabled ? !0 : !1; c.strokeStyle = "#4572A7 "; for (m = 0; m < w.length; m++)if (b = w[m].x.getTime ? w[m].x.getTime() : w[m].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof w[m].y) {
                        n = a.axisX.convertValueToPixel(b); n = n - a.plotType.plotUnits.length * r / 2 + a.index * r << 0; var s = n + r << 0, C; if (a.axisY.logarithmic ||
                          a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < w[m].y) d[b] = w[m].y + (d[b] ? d[b] : 0), 0 < d[b] && (p = a.axisY.convertValueToPixel(d[b]), C = "undefined" !== typeof h[b] ? h[b] : q, h[b] = p); else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= w[m].y) K[b] = w[m].y + (K[b] ? K[b] : 0), C = a.axisY.convertValueToPixel(K[b]), p = "undefined" !== typeof g[b] ? g[b] : q, g[b] = C; else if (p = a.axisY.convertValueToPixel(w[m].y), 0 <= w[m].y) { var I = "undefined" !== typeof h[b] ? h[b] : 0; p -= I; C = q - I; h[b] = I + (C - p) } else I =
                            g[b] ? g[b] : 0, C = p + I, p = q + I, g[b] = I + (C - p); b = w[m].color ? w[m].color : k._colorSet[m % k._colorSet.length]; Z(c, n, a.axisY.reversed ? C : p, s, a.axisY.reversed ? p : C, b, 0, null, v && (a.axisY.reversed ? 0 > w[m].y : 0 <= w[m].y), (a.axisY.reversed ? 0 <= w[m].y : 0 > w[m].y) && v, !1, !1, k.fillOpacity); b = k.dataPointIds[m]; this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: t, dataPointIndex: m, x1: n, y1: p, x2: s, y2: C }; b = R(b); u && Z(this._eventManager.ghostCtx, n, p, s, C, b, 0, null, !1, !1, !1, !1); (w[m].indexLabel || k.indexLabel || w[m].indexLabelFormatter ||
                              k.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedColumn", dataPoint: w[m], dataSeries: k, point: { x: n + (s - n) / 2, y: 0 <= w[m].y ? p : C }, direction: 0 > w[m].y === a.axisY.reversed ? 1 : -1, bounds: { x1: n, y1: Math.min(p, C), x2: s, y2: Math.max(p, C) }, color: b })
                      }
                    }
                    ...
                    this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.restore()); c.restore(); return { source: f, dest: this.plotArea.ctx, animationCallback: x.yScaleAnimation, easingFunction: x.easing.easeOutQuart, animationBase: q < a.axisY.bounds.y1 ? a.axisY.bounds.y1 : q > a.axisY.bounds.y2 ? a.axisY.bounds.y2 : q }
            }
            ...
            var f = a.targetCanvasCtx || this.plotArea.ctx, c = u ? this._preRenderCtx :
              f; if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                c.clip(); u && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (l = 0; l < a.dataSeriesIndexes.length; l++) {
                  var k = a.dataSeriesIndexes[l], t = this.data[k], w = t.dataPoints; if (0 < w.length) for (var v = 5 < r && t.bevelEnabled ? !0 : !1, m = 0; m < w.length; m++)if (b = w[m].x.getTime ? w[m].x.getTime() : w[m].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof w[m].y) {
                    n = a.axisX.convertValueToPixel(b); p = 0 !== a.dataPointYSums[b] ?
                      100 * (w[m].y / a.dataPointYSums[b]) : 0; n = n - a.plotType.plotUnits.length * r / 2 + a.index * r << 0; var s = n + r << 0, C; if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < w[m].y) { d[b] = p + ("undefined" !== typeof d[b] ? d[b] : 0); if (0 >= d[b]) continue; p = a.axisY.convertValueToPixel(d[b]); C = h[b] ? h[b] : q; h[b] = p } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= w[m].y) K[b] = p + ("undefined" !== typeof K[b] ? K[b] : 0), C = a.axisY.convertValueToPixel(K[b]), p = g[b] ? g[b] : q, g[b] = C;
                        ...
                        v, !1, !1, t.fillOpacity); b = t.dataPointIds[m]; this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: m, x1: n, y1: p, x2: s, y2: C }; b = R(b); u && Z(this._eventManager.ghostCtx, n, p, s, C, b, 0, null, !1, !1, !1, !1); (w[m].indexLabel || t.indexLabel || w[m].indexLabelFormatter || t.indexLabelFormatter) && this._indexLabels.push({
                          chartType: "stackedColumn100", dataPoint: w[m], dataSeries: t, point: { x: n + (s - n) / 2, y: 0 <= w[m].y ? p : C }, direction: 0 > w[m].y === a.axisY.reversed ? 1 : -1, bounds: {
                  ...
                  source: f,
                  dest: this.plotArea.ctx, animationCallback: x.yScaleAnimation, easingFunction: x.easing.easeOutQuart, animationBase: q < a.axisY.bounds.y1 ? a.axisY.bounds.y1 : q > a.axisY.bounds.y2 ? a.axisY.bounds.y2 : q
                }
              }
                  ...
                  Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, n)); !this.dataPointMaxWidth && (this.dataPointMinWidth && n < h) && (n = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, h)); p < h && (p = h); p > n && (p = n); c.save(); u && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); u && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                    var q =
                      a.dataSeriesIndexes[n], l = this.data[q], r = l.dataPoints; if (0 < r.length) {
                        var t = 5 < p && l.bevelEnabled ? !0 : !1; c.strokeStyle = "#4572A7 "; for (h = 0; h < r.length; h++)if (r[h].getTime ? K = r[h].x.getTime() : K = r[h].x, !(K < a.axisX.dataInfo.viewPortMin || K > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[h].y) {
                          d = a.axisX.convertValueToPixel(K); g = a.axisY.convertValueToPixel(r[h].y); d = a.axisX.reversed ? d + a.plotType.totalDataSeries * p / 2 - (a.previousDataSeriesCount + n) * p << 0 : d - a.plotType.totalDataSeries * p / 2 + (a.previousDataSeriesCount +
                            n) * p << 0; var k = a.axisX.reversed ? d - p << 0 : d + p << 0, w; 0 <= r[h].y ? w = m : (w = g, g = m); b = r[h].color ? r[h].color : l._colorSet[h % l._colorSet.length]; Z(c, a.axisY.reversed ? g : w, a.axisX.reversed ? k : d, a.axisY.reversed ? w : g, a.axisX.reversed ? d : k, b, 0, null, t, !1, !1, !1, l.fillOpacity); b = l.dataPointIds[h]; this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: h, x1: w, y1: d, x2: g, y2: k }; b = R(b); u && Z(this._eventManager.ghostCtx, w, a.axisX.reversed ? k : d, g, a.axisX.reversed ? d : k, b, 0, null, !1, !1, !1, !1); (r[h].indexLabel ||
                              l.indexLabel || r[h].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({ chartType: "bar", dataPoint: r[h], dataSeries: l, point: { x: 0 <= r[h].y ? g : w, y: d + (k - d) / 2 }, direction: 0 > r[h].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(w, g), y1: d, x2: Math.max(w, g), y2: k }, color: b })
                        }
                      }
            ...
            c = u ? this._preRenderCtx : f; if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              c.clip(); u && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (l = 0; l < a.dataSeriesIndexes.length; l++) {
                var k = a.dataSeriesIndexes[l], t = this.data[k], w = t.dataPoints; if (0 < w.length) {
                  var v = 5 < r && t.bevelEnabled ? !0 : !1; c.strokeStyle = "#4572A7 "; for (m = 0; m < w.length; m++)if (b = w[m].x.getTime ? w[m].x.getTime() : w[m].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof w[m].y) {
                    p = a.axisX.convertValueToPixel(b);
                    p = p - a.plotType.plotUnits.length * r / 2 + a.index * r << 0; var s = p + r << 0, C; if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < w[m].y) d[b] = w[m].y + (d[b] ? d[b] : 0), 0 < d[b] && (C = h[b] ? h[b] : q, h[b] = n = a.axisY.convertValueToPixel(d[b])); else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= w[m].y) K[b] = w[m].y + (K[b] ? K[b] : 0), n = g[b] ? g[b] : q, g[b] = C = a.axisY.convertValueToPixel(K[b]); else if (n = a.axisY.convertValueToPixel(w[m].y), 0 <= w[m].y) {
                      var I = h[b] ? h[b] : 0; C = q + I; n +=
                        I; h[b] = I + (n - C)
                    } else I = g[b] ? g[b] : 0, C = n - I, n = q - I, g[b] = I + (n - C); b = w[m].color ? w[m].color : t._colorSet[m % t._colorSet.length]; Z(c, a.axisY.reversed ? n : C, p, a.axisY.reversed ? C : n, s, b, 0, null, v, !1, !1, !1, t.fillOpacity); b = t.dataPointIds[m]; this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: m, x1: C, y1: p, x2: n, y2: s }; b = R(b); u && Z(this._eventManager.ghostCtx, C, p, n, s, b, 0, null, !1, !1, !1, !1); (w[m].indexLabel || t.indexLabel || w[m].indexLabelFormatter || t.indexLabelFormatter) && this._indexLabels.push({
                      chartType: "stackedBar",
                      dataPoint: w[m], dataSeries: t, point: { x: 0 <= w[m].y ? n : C, y: p + (s - p) / 2 }, direction: 0 > w[m].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(C, n), y1: p, x2: Math.max(C, n), y2: s }, color: b
                    })
                  }
                }
              } u && (f.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
                0, 0, this.width, this.height), c.clearRect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.restore()); c.restore(); return { source: f, dest: this.plotArea.ctx, animationCallback: x.xScaleAnimation, easingFunction: x.easing.easeOutQuart, animationBase: q < a.axisY.bounds.x1 ? a.axisY.bounds.x1 : q > a.axisY.bounds.x2 ? a.axisY.bounds.x2 : q }
            }
                    ...
                    var t = a.dataSeriesIndexes[l], k = this.data[t], w = k.dataPoints; if (0 < w.length) {
                      var v = 5 < r && k.bevelEnabled ? !0 : !1; c.strokeStyle = "#4572A7 "; for (m = 0; m < w.length; m++)if (b = w[m].x.getTime ? w[m].x.getTime() : w[m].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof w[m].y) {
                        p = a.axisX.convertValueToPixel(b); var s; s = 0 !== a.dataPointYSums[b] ? 100 * (w[m].y / a.dataPointYSums[b]) : 0; p = p - a.plotType.plotUnits.length *
                          r / 2 + a.index * r << 0; var C = p + r << 0; if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < w[m].y) { d[b] = s + (d[b] ? d[b] : 0); if (0 >= d[b]) continue; s = h[b] ? h[b] : q; h[b] = n = a.axisY.convertValueToPixel(d[b]) } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= w[m].y) K[b] = s + (K[b] ? K[b] : 0), n = g[b] ? g[b] : q, g[b] = s = a.axisY.convertValueToPixel(K[b]); else if (n = a.axisY.convertValueToPixel(s), 0 <= w[m].y) {
                            var I = h[b] ? h[b] : 0; s = q + I; n += I; a.dataSeriesIndexes.length - 1 === l &&
                              1 >= Math.abs(e.x2 - n) && (n = e.x2); h[b] = I + (n - s)
                          } else I = g[b] ? g[b] : 0, s = n - I, n = q - I, a.dataSeriesIndexes.length - 1 === l && 1 >= Math.abs(e.x1 - s) && (s = e.x1), g[b] = I + (n - s); b = w[m].color ? w[m].color : k._colorSet[m % k._colorSet.length]; Z(c, a.axisY.reversed ? n : s, p, a.axisY.reversed ? s : n, C, b, 0, null, v, !1, !1, !1, k.fillOpacity); b = k.dataPointIds[m]; this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: t, dataPointIndex: m, x1: s, y1: p, x2: n, y2: C }; b = R(b); u && Z(this._eventManager.ghostCtx, s, p, n, C, b, 0, null, !1, !1, !1, !1);
                        (w[m].indexLabel || k.indexLabel || w[m].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedBar100", dataPoint: w[m], dataSeries: k, point: { x: 0 <= w[m].y ? n : s, y: p + (C - p) / 2 }, direction: 0 > w[m].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(s, n), y1: p, x2: Math.max(s, n), y2: C }, color: b })
                      }
                    }
                  } u && (f.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas &&
                    c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.restore()); c.restore(); return { source: f, dest: this.plotArea.ctx, animationCallback: x.xScaleAnimation, easingFunction: x.easing.easeOutQuart, animationBase: q < a.axisY.bounds.x1 ? a.axisY.bounds.x1 : q > a.axisY.bounds.x2 ? a.axisY.bounds.x2 : q }
            }
            ...
            c; function b() { I && (0 < l.lineThickness && h.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? C = s : 0 > a.axisY.viewportMaximum ? C = d.y1 : 0 < a.axisY.viewportMinimum && (C = s), h.lineTo(v, C), h.lineTo(I.x, C), h.closePath(), h.globalAlpha = l.fillOpacity, h.fill(), h.globalAlpha = 1, u && (g.lineTo(v, C), g.lineTo(I.x, C), g.closePath(), g.fill()), h.beginPath(), h.moveTo(v, w), g.beginPath(), g.moveTo(v, w), I = { x: v, y: w }) } var e = a.targetCanvasCtx || this.plotArea.ctx, h = u ? this._preRenderCtx : e; if (!(0 >= a.dataSeriesIndexes.length)) {
              var g =
                this._eventManager.ghostCtx, d = a.axisY.lineCoordinates, K = [], m = this.plotArea, n; h.save(); u && g.save(); h.beginPath(); h.rect(m.x1, m.y1, m.width, m.height); h.clip(); u && (g.beginPath(), g.rect(m.x1, m.y1, m.width, m.height), g.clip()); for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                  var q = a.dataSeriesIndexes[p], l = this.data[q], r = l.dataPoints, K = l.id; this._eventManager.objectMap[K] = { objectType: "dataSeries", dataSeriesIndex: q }; K = R(K); g.fillStyle = K; K = []; f = !0; var k = 0, v, w, B, s = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
                        ...
                        typeof r[k].y) l.connectNullData || (ia || f) || b(), ia = !0; else {
                          v = a.axisX.convertValueToPixel(B); w = a.axisY.convertValueToPixel(r[k].y); f || ia ? (!f && l.connectNullData ? (h.setLineDash && (l.options.nullDataLineDashType || c === l.lineDashType && l.lineDashType !== l.nullDataLineDashType) && (f = v, c = w, v = n.x, w = n.y, b(), h.moveTo(n.x, n.y), v = f, w = c, I = n, c = l.nullDataLineDashType, h.setLineDash(S)), h.lineTo(v, w), u && g.lineTo(v, w)) : (h.beginPath(), h.moveTo(v, w), u && (g.beginPath(), g.moveTo(v, w)), I = { x: v, y: w }), ia = f = !1) : (h.lineTo(v, w), u && g.lineTo(v,
                            w), 0 == k % 250 && b()); n = { x: v, y: w }; k < r.length - 1 && (z !== (r[k].lineColor || y) || c !== (r[k].lineDashType || l.lineDashType)) && (b(), z = r[k].lineColor || y, h.strokeStyle = z, h.setLineDash && (r[k].lineDashType ? (c = r[k].lineDashType, h.setLineDash(T(c, l.lineThickness))) : (c = l.lineDashType, h.setLineDash(X)))); var da = l.dataPointIds[k]; this._eventManager.objectMap[da] = { id: da, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: k, x1: v, y1: w }; 0 !== r[k].markerSize && (0 < r[k].markerSize || 0 < l.markerSize) && (B = l.getMarkerProperties(k,
                              v, w, h), K.push(B), da = R(da), u && K.push({ x: v, y: w, ctx: g, type: B.type, size: B.size, color: da, borderColor: da, borderThickness: B.borderThickness })); (r[k].indexLabel || l.indexLabel || r[k].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({ chartType: "area", dataPoint: r[k], dataSeries: l, point: { x: v, y: w }, direction: 0 > r[k].y === a.axisY.reversed ? 1 : -1, color: D })
                      } b(); t.drawMarkers(K)
                    }
                } u && (e.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), h.globalCompositeOperation = "source-atop", a.axisX.maskCanvas &&
            ...
            function f() {
              var c =
                H(B, 2); if (0 < c.length) {
                  ...
                  } b.beginPath(); b.moveTo(c[0].x, c[0].y); u && (e.beginPath(), e.moveTo(c[0].x, c[0].y)); for (f = 0; f < c.length - 3; f += 3)b.bezierCurveTo(c[f + 1].x, c[f + 1].y, c[f + 2].x, c[f + 2].y, c[f + 3].x, c[f + 3].y), u && e.bezierCurveTo(c[f + 1].x, c[f + 1].y, c[f + 2].x, c[f + 2].y, c[f + 3].x, c[f + 3].y); a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? v = k : 0 > a.axisY.viewportMaximum ? v = h.y1 : 0 < a.axisY.viewportMinimum && (v = k); w = {
                    x: c[0].x,
                    y: c[0].y
                  }; b.lineTo(c[c.length - 1].x, v); b.lineTo(w.x, v); b.closePath(); b.globalAlpha = n.fillOpacity; b.fill(); b.globalAlpha = 1; u && (e.lineTo(c[c.length - 1].x, v), e.lineTo(w.x, v), e.closePath(), e.fill())
                }
            } var c = a.targetCanvasCtx || this.plotArea.ctx, b = u ? this._preRenderCtx : c; if (!(0 >= a.dataSeriesIndexes.length)) {
              var e = this._eventManager.ghostCtx, h = a.axisY.lineCoordinates, g = [], d = this.plotArea; b.save(); u && e.save(); b.beginPath(); b.rect(d.x1, d.y1, d.width, d.height); b.clip(); u && (e.beginPath(), e.rect(d.x1, d.y1, d.width,
                d.height), e.clip()); for (var K = 0; K < a.dataSeriesIndexes.length; K++) {
                  var m = a.dataSeriesIndexes[K], n = this.data[m], p = n.dataPoints, g = n.id; this._eventManager.objectMap[g] = { objectType: "dataSeries", dataSeriesIndex: m }; g = R(g); e.fillStyle = g; var g = [], q = 0, l, r, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), v, w = null, B = []; if (0 < p.length) {
                    var s = n._colorSet[q % n._colorSet.length], C = n.lineColor = n.options.lineColor || s, I = C; b.fillStyle = s; b.strokeStyle = C; b.lineWidth = n.lineThickness; var D = "solid";
            ...
            var f, c; function b() { I && (0 < l.lineThickness && h.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? C = s : 0 > a.axisY.viewportMaximum ? C = d.y1 : 0 < a.axisY.viewportMinimum && (C = s), h.lineTo(v, C), h.lineTo(I.x, C), h.closePath(), h.globalAlpha = l.fillOpacity, h.fill(), h.globalAlpha = 1, u && (g.lineTo(v, C), g.lineTo(I.x, C), g.closePath(), g.fill()), h.beginPath(), h.moveTo(v, w), g.beginPath(), g.moveTo(v, w), I = { x: v, y: w }) } var e = a.targetCanvasCtx ||
              this.plotArea.ctx, h = u ? this._preRenderCtx : e; if (!(0 >= a.dataSeriesIndexes.length)) {
                var g = this._eventManager.ghostCtx, d = a.axisY.lineCoordinates, K = [], m = this.plotArea, n; h.save(); u && g.save(); h.beginPath(); h.rect(m.x1, m.y1, m.width, m.height); h.clip(); u && (g.beginPath(), g.rect(m.x1, m.y1, m.width, m.height), g.clip()); for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                  var q = a.dataSeriesIndexes[p], l = this.data[q], r = l.dataPoints, K = l.id; this._eventManager.objectMap[K] = { objectType: "dataSeries", dataSeriesIndex: q }; K = R(K); g.fillStyle =
            ...
            function f() { if (!(1 > m.length)) { for (0 < D.lineThickness && b.stroke(); 0 < m.length;) { var a = m.pop(); b.lineTo(a.x, a.y); u && s.lineTo(a.x, a.y) } b.closePath(); b.globalAlpha = D.fillOpacity; b.fill(); b.globalAlpha = 1; b.beginPath(); u && (s.closePath(), s.fill(), s.beginPath()); m = [] } } var c = a.targetCanvasCtx || this.plotArea.ctx, b = u ? this._preRenderCtx : c; if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              m = [], n = [], p = [], q = 0, l, r, v = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), s = this._eventManager.ghostCtx, w, B, Q; u && s.beginPath(); b.save(); u && s.save(); b.beginPath(); b.rect(d.x1, d.y1, d.width, d.height); b.clip(); u && (s.beginPath(), s.rect(d.x1, d.y1, d.width, d.height), s.clip()); for (var e = [], C = 0; C < a.dataSeriesIndexes.length; C++) {
                var I = a.dataSeriesIndexes[C], D = this.data[I], y = D.dataPoints; D.dataPointIndexes = []; for (q = 0; q < y.length; q++)I = y[q].x.getTime ? y[q].x.getTime() : y[q].x, D.dataPointIndexes[I] =
                  q, e[I] || (n.push(I), e[I] = !0); n.sort(Wa)
              } for (C = 0; C < a.dataSeriesIndexes.length; C++) {
                I = a.dataSeriesIndexes[C]; D = this.data[I]; y = D.dataPoints; B = !0; m = []; q = D.id; this._eventManager.objectMap[q] = { objectType: "dataSeries", dataSeriesIndex: I }; q = R(q); s.fillStyle = q; if (0 < n.length) {
                  var e = D._colorSet[0], z = D.lineColor = D.options.lineColor || e, S = z; b.fillStyle = e; b.strokeStyle = z; b.lineWidth = D.lineThickness; Q = "solid"; if (b.setLineDash) {
                    var X = T(D.nullDataLineDashType, D.lineThickness); Q = D.lineDashType; var ia = T(Q, D.lineThickness);
                    b.setLineDash(ia)
                  } for (var da = !0, q = 0; q < n.length; q++) {
                    var h = n[q], la = null, la = 0 <= D.dataPointIndexes[h] ? y[D.dataPointIndexes[h]] : { x: h, y: null }; if (!(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax && (!D.connectNullData || !da))) if ("number" !== typeof la.y) D.connectNullData || (da || B) || f(), da = !0; else {
                      l = a.axisX.convertValueToPixel(h); var va = k[h] ? k[h] : 0; if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) {
                        p[h] = la.y + (p[h] ? p[h] : 0); if (0 >= p[h] && a.axisY.logarithmic) continue;
                        r = a.axisY.convertValueToPixel(p[h])
                      } else r = a.axisY.convertValueToPixel(la.y), r -= va; m.push({ x: l, y: v - va }); k[h] = v - r; B || da ? (!B && D.connectNullData ? (b.setLineDash && (D.options.nullDataLineDashType || Q === D.lineDashType && D.lineDashType !== D.nullDataLineDashType) && (B = m.pop(), Q = m[m.length - 1], f(), b.moveTo(w.x, w.y), m.push(Q), m.push(B), Q = D.nullDataLineDashType, b.setLineDash(X)), b.lineTo(l, r), u && s.lineTo(l, r)) : (b.beginPath(), b.moveTo(l, r), u && (s.beginPath(), s.moveTo(l, r))), da = B = !1) : (b.lineTo(l, r), u && s.lineTo(l, r),
                        0 == q % 250 && (f(), b.moveTo(l, r), u && s.moveTo(l, r), m.push({ x: l, y: v - va }))); w = { x: l, y: r }; q < y.length - 1 && (S !== (y[q].lineColor || z) || Q !== (y[q].lineDashType || D.lineDashType)) && (f(), b.beginPath(), b.moveTo(l, r), m.push({ x: l, y: v - va }), S = y[q].lineColor || z, b.strokeStyle = S, b.setLineDash && (y[q].lineDashType ? (Q = y[q].lineDashType, b.setLineDash(T(Q, D.lineThickness))) : (Q = D.lineDashType, b.setLineDash(ia)))); if (0 <= D.dataPointIndexes[h]) {
                          var F = D.dataPointIds[D.dataPointIndexes[h]]; this._eventManager.objectMap[F] = {
                            ...
                            dataSeriesIndex: I, dataPointIndex: D.dataPointIndexes[h], x1: l, y1: r
                          }
                          ...
                          chartType: "stackedArea", dataPoint: la, dataSeries: D, point: { x: l, y: r }, direction: 0 >
                            y[q].y === a.axisY.reversed ? 1 : -1, color: e
                        })
                    }
                  } f(); b.moveTo(l, r); u && s.moveTo(l, r)
            ...
            function f() { for (0 < D.lineThickness && b.stroke(); 0 < m.length;) { var a = m.pop(); b.lineTo(a.x, a.y); u && Q.lineTo(a.x, a.y) } b.closePath(); b.globalAlpha = D.fillOpacity; b.fill(); b.globalAlpha = 1; b.beginPath(); u && (Q.closePath(), Q.fill(), Q.beginPath()); m = [] } var c = a.targetCanvasCtx || this.plotArea.ctx,
              b = u ? this._preRenderCtx : c; if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, h = null, g = this.plotArea, d = [], k = [], m = [], n = [], p = [], q = 0, l, r, v, s, w, B = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), Q = this._eventManager.ghostCtx; b.save(); u && Q.save(); b.beginPath(); b.rect(g.x1, g.y1, g.width, g.height); b.clip(); u && (Q.beginPath(), Q.rect(g.x1, g.y1, g.width, g.height), Q.clip()); for (var e = [], C = 0; C < a.dataSeriesIndexes.length; C++) {
                  var I = a.dataSeriesIndexes[C], D = this.data[I], y = D.dataPoints; D.dataPointIndexes =
                    []; for (q = 0; q < y.length; q++)I = y[q].x.getTime ? y[q].x.getTime() : y[q].x, D.dataPointIndexes[I] = q, e[I] || (n.push(I), e[I] = !0); n.sort(Wa)
                } for (C = 0; C < a.dataSeriesIndexes.length; C++) {
                  I = a.dataSeriesIndexes[C]; D = this.data[I]; y = D.dataPoints; s = !0; e = D.id; this._eventManager.objectMap[e] = { objectType: "dataSeries", dataSeriesIndex: I }; e = R(e); Q.fillStyle = e; m = []; if (0 < n.length) {
                    var e = D._colorSet[q % D._colorSet.length], z = D.lineColor = D.options.lineColor || e, S = z; b.fillStyle = e; b.strokeStyle = z; b.lineWidth = D.lineThickness; w = "solid";
                    if (b.setLineDash) { var X = T(D.nullDataLineDashType, D.lineThickness); w = D.lineDashType; var ia = T(w, D.lineThickness); b.setLineDash(ia) } for (var da = !0, q = 0; q < n.length; q++) {
                      var h = n[q], la = null, la = 0 <= D.dataPointIndexes[h] ? y[D.dataPointIndexes[h]] : { x: h, y: null }; if (!(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax && (!D.connectNullData || !da))) if ("number" !== typeof la.y) D.connectNullData || (da || s) || f(), da = !0; else {
                        var va; va = 0 !== a.dataPointYSums[h] ? 100 * (la.y / a.dataPointYSums[h]) : 0; l = a.axisX.convertValueToPixel(h);
                        var F = k[h] ? k[h] : 0; if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) { p[h] = va + (p[h] ? p[h] : 0); if (0 >= p[h] && a.axisY.logarithmic) continue; r = a.axisY.convertValueToPixel(p[h]) } else r = a.axisY.convertValueToPixel(va), r -= F; m.push({ x: l, y: B - F }); k[h] = B - r; s || da ? (!s && D.connectNullData ? (b.setLineDash && (D.options.nullDataLineDashType || w === D.lineDashType && D.lineDashType !== D.nullDataLineDashType) && (s = m.pop(), w = m[m.length - 1], f(), b.moveTo(v.x, v.y), m.push(w), m.push(s), w = D.nullDataLineDashType,
                          b.setLineDash(X)), b.lineTo(l, r), u && Q.lineTo(l, r)) : (b.beginPath(), b.moveTo(l, r), u && (Q.beginPath(), Q.moveTo(l, r))), da = s = !1) : (b.lineTo(l, r), u && Q.lineTo(l, r), 0 == q % 250 && (f(), b.moveTo(l, r), u && Q.moveTo(l, r), m.push({ x: l, y: B - F }))); v = { x: l, y: r }; q < y.length - 1 && (S !== (y[q].lineColor || z) || w !== (y[q].lineDashType || D.lineDashType)) && (f(), b.beginPath(), b.moveTo(l, r), m.push({ x: l, y: B - F }), S = y[q].lineColor || z, b.strokeStyle = S, b.setLineDash && (y[q].lineDashType ? (w = y[q].lineDashType, b.setLineDash(T(w, D.lineThickness))) : (w = D.lineDashType,
                            b.setLineDash(ia)))); if (0 <= D.dataPointIndexes[h]) { var G = D.dataPointIds[D.dataPointIndexes[h]]; this._eventManager.objectMap[G] = { id: G, objectType: "dataPoint", dataSeriesIndex: I, dataPointIndex: D.dataPointIndexes[h], x1: l, y1: r } } 0 <= D.dataPointIndexes[h] && 0 !== la.markerSize && (0 < la.markerSize || 0 < D.markerSize) && (F = D.getMarkerProperties(q, l, r, b), d.push(F), h = R(G), u && d.push({ x: l, y: r, ctx: Q, type: F.type, size: F.size, color: h, borderColor: h, borderThickness: F.borderThickness })); (la.indexLabel || D.indexLabel || la.indexLabelFormatter ||
                              D.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedArea100", dataPoint: la, dataSeries: D, point: { x: l, y: r }, direction: 0 > y[q].y === a.axisY.reversed ? 1 : -1, color: e })
                      }
                    } f(); b.moveTo(l, r); u && Q.moveTo(l, r)
                  } delete D.dataPointIndexes
                } t.drawMarkers(d); u && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width,
                  this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(g.x1, g.y1, g.width, g.height), Q.restore()); b.restore(); return { source: c, dest: this.plotArea.ctx, animationCallback: x.xClipAnimation, easingFunction: x.easing.linear, animationBase: 0 }
              }
          }; s.prototype.renderBubble = function (a) {
            var f = a.targetCanvasCtx || this.plotArea.ctx, c = u ? this._preRenderCtx : f; if (!(0 >= a.dataSeriesIndexes.length)) {
              var b = this.plotArea, e = 0, h, g; c.save(); u && this._eventManager.ghostCtx.save();
              c.beginPath(); c.rect(b.x1, b.y1, b.width, b.height); c.clip(); u && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(b.x1, b.y1, b.width, b.height), this._eventManager.ghostCtx.clip()); for (var d = -Infinity, k = Infinity, m = 0; m < a.dataSeriesIndexes.length; m++)for (var n = a.dataSeriesIndexes[m], p = this.data[n], q = p.dataPoints, l = 0, e = 0; e < q.length; e++)h = q[e].getTime ? h = q[e].x.getTime() : h = q[e].x, h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax || "undefined" === typeof q[e].z || (l = q[e].z, l >
                d && (d = l), l < k && (k = l)); for (var r = 25 * Math.PI, v = Math.max(Math.pow(0.25 * Math.min(b.height, b.width) / 2, 2) * Math.PI, r), m = 0; m < a.dataSeriesIndexes.length; m++)if (n = a.dataSeriesIndexes[m], p = this.data[n], q = p.dataPoints, 0 < q.length) for (c.strokeStyle = "#4572A7 ", e = 0; e < q.length; e++)if (h = q[e].getTime ? h = q[e].x.getTime() : h = q[e].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[e].y) {
                  h = a.axisX.convertValueToPixel(h); g = a.axisY.convertValueToPixel(q[e].y); var l = q[e].z, s = 2 * Math.max(Math.sqrt((d ===
                    k ? v / 2 : r + (v - r) / (d - k) * (l - k)) / Math.PI) << 0, 1), l = p.getMarkerProperties(e, c); l.size = s; c.globalAlpha = p.fillOpacity; t.drawMarker(h, g, c, l.type, l.size, l.color, l.borderColor, l.borderThickness); c.globalAlpha = 1; var w = p.dataPointIds[e]; this._eventManager.objectMap[w] = { id: w, objectType: "dataPoint", dataSeriesIndex: n, dataPointIndex: e, x1: h, y1: g, size: s }; s = R(w); u && t.drawMarker(h, g, this._eventManager.ghostCtx, l.type, l.size, s, s, l.borderThickness); (q[e].indexLabel || p.indexLabel || q[e].indexLabelFormatter || p.indexLabelFormatter) &&
                      this._indexLabels.push({ chartType: "bubble", dataPoint: q[e], dataSeries: p, point: { x: h, y: g }, direction: 1, bounds: { x1: h - l.size / 2, y1: g - l.size / 2, x2: h + l.size / 2, y2: g + l.size / 2 }, color: null })
                } u && (f.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
            ...
            var f = a.targetCanvasCtx || this.plotArea.ctx, c = u ? this._preRenderCtx : f; if (!(0 >= a.dataSeriesIndexes.length)) {
              var b = this.plotArea, e = 0, h, g; c.save(); u && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(b.x1, b.y1, b.width,
                b.height); c.clip(); u && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(b.x1, b.y1, b.width, b.height), this._eventManager.ghostCtx.clip()); for (var d = 0; d < a.dataSeriesIndexes.length; d++) {
                  var k = a.dataSeriesIndexes[d], m = this.data[k], n = m.dataPoints; if (0 < n.length) {
                    c.strokeStyle = "#4572A7 "; Math.pow(0.3 * Math.min(b.height, b.width) / 2, 2); for (var p = 0, q = 0, e = 0; e < n.length; e++)if (h = n[e].getTime ? h = n[e].x.getTime() : h = n[e].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && "number" ===
                      typeof n[e].y) {
                        h = a.axisX.convertValueToPixel(h); g = a.axisY.convertValueToPixel(n[e].y); var l = m.getMarkerProperties(e, h, g, c); c.globalAlpha = m.fillOpacity; t.drawMarker(l.x, l.y, l.ctx, l.type, l.size, l.color, l.borderColor, l.borderThickness); c.globalAlpha = 1; Math.sqrt((p - h) * (p - h) + (q - g) * (q - g)) < Math.min(l.size, 5) && n.length > Math.min(this.plotArea.width, this.plotArea.height) || (p = m.dataPointIds[e], this._eventManager.objectMap[p] = { id: p, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: e, x1: h, y1: g }, p = R(p), u &&
                          t.drawMarker(l.x, l.y, this._eventManager.ghostCtx, l.type, l.size, p, p, l.borderThickness), (n[e].indexLabel || m.indexLabel || n[e].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({ chartType: "scatter", dataPoint: n[e], dataSeries: m, point: { x: h, y: g }, direction: 1, bounds: { x1: h - l.size / 2, y1: g - l.size / 2, x2: h + l.size / 2, y2: g + l.size / 2 }, color: null }), p = h, q = g)
                    }
                  }
                } u && (f.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas,
            ...
            var f = a.targetCanvasCtx || this.plotArea.ctx,
            c = u ? this._preRenderCtx : f, b = this._eventManager.ghostCtx; if (!(0 >= a.dataSeriesIndexes.length)) {
              var e = null, h = null, d = this.plotArea, k = 0, v, m, n, p, q, l, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, h = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.015 * this.width, r = a.axisX.dataInfo.minDiff; isFinite(r) || (r = 0.3 * Math.abs(a.axisX.range)); r = this.options.dataPointWidth ? this.dataPointWidth : 0.7 * d.width *
                (a.axisX.logarithmic ? Math.log(r) / Math.log(a.axisX.range) : Math.abs(r) / Math.abs(a.axisX.range)) << 0; this.dataPointMaxWidth && e > h && (e = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, h)); !this.dataPointMaxWidth && (this.dataPointMinWidth && h < e) && (h = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, e)); r < e && (r = e); r > h && (r = h); c.save(); u && b.save(); c.beginPath(); c.rect(d.x1, d.y1, d.width, d.height); c.clip(); u && (b.beginPath(), b.rect(d.x1, d.y1, d.width, d.height), b.clip()); for (var t =
                  0; t < a.dataSeriesIndexes.length; t++) {
                    var s = a.dataSeriesIndexes[t], w = this.data[s], B = w.dataPoints; if (0 < B.length) for (var Q = 5 < r && w.bevelEnabled ? !0 : !1, k = 0; k < B.length; k++)if (B[k].getTime ? l = B[k].x.getTime() : l = B[k].x, !(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax) && !g(B[k].y) && B[k].y.length && "number" === typeof B[k].y[0] && "number" === typeof B[k].y[1] && "number" === typeof B[k].y[2] && "number" === typeof B[k].y[3]) {
                      v = a.axisX.convertValueToPixel(l); m = a.axisY.convertValueToPixel(B[k].y[0]); n = a.axisY.convertValueToPixel(B[k].y[1]);
                      ...
                      "candlestick" === w.type ? (c.moveTo(v - y, n), c.lineTo(v - y, Math.min(m, q)), c.stroke(), c.moveTo(v - y, Math.max(m, q)), c.lineTo(v - y, p), c.stroke(), Z(c, C, Math.min(m, q), I, Math.max(m, q), B[k].y[0] <= B[k].y[3] ? w.risingColor : h, D, e, Q, Q, !1, !1, w.fillOpacity), u && (e = R(z), b.strokeStyle = e, b.moveTo(v - y, n), b.lineTo(v - y, Math.min(m, q)), b.stroke(), b.moveTo(v - y, Math.max(m, q)), b.lineTo(v - y, p), b.stroke(), Z(b, C, Math.min(m, q), I, Math.max(m, q), e, 0, null, !1, !1, !1, !1))) : "ohlc" === w.type && (c.moveTo(v - y, n), c.lineTo(v - y, p), c.stroke(), c.beginPath(),
                        c.moveTo(v, m), c.lineTo(C, m), c.stroke(), c.beginPath(), c.moveTo(v, q), c.lineTo(I, q), c.stroke(), u && (e = R(z), b.strokeStyle = e, b.moveTo(v - y, n), b.lineTo(v - y, p), b.stroke(), b.beginPath(), b.moveTo(v, m), b.lineTo(C, m), b.stroke(), b.beginPath(), b.moveTo(v, q), b.lineTo(I, q), b.stroke())); (B[k].indexLabel || w.indexLabel || B[k].indexLabelFormatter || w.indexLabelFormatter) && this._indexLabels.push({
                          chartType: w.type, dataPoint: B[k], dataSeries: w, point: { x: C + (I - C) / 2, y: a.axisY.reversed ? p : n }, direction: 1, bounds: {
                            x1: C, y1: Math.min(n,
            ...
            var f = a.targetCanvasCtx || this.plotArea.ctx, c = u ? this._preRenderCtx : f, b = this._eventManager.ghostCtx; if (!(0 >= a.dataSeriesIndexes.length)) {
              var e = null, h = this.plotArea, d = 0, k, v, m, n, p, q, l, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, d = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ?
                this.dataPointWidth : 0.015 * this.width, r = a.axisX.dataInfo.minDiff; isFinite(r) || (r = 0.3 * Math.abs(a.axisX.range)); r = this.options.dataPointWidth ? this.dataPointWidth : 0.7 * h.width * (a.axisX.logarithmic ? Math.log(r) / Math.log(a.axisX.range) : Math.abs(r) / Math.abs(a.axisX.range)) << 0; this.dataPointMaxWidth && e > d && (e = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, d)); !this.dataPointMaxWidth && (this.dataPointMinWidth && d < e) && (d = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, e)); r <
                  e && (r = e); r > d && (r = d); c.save(); u && b.save(); c.beginPath(); c.rect(h.x1, h.y1, h.width, h.height); c.clip(); u && (b.beginPath(), b.rect(h.x1, h.y1, h.width, h.height), b.clip()); for (var t = !1, t = !!a.axisY.reversed, s = 0; s < a.dataSeriesIndexes.length; s++) {
                    var w = a.dataSeriesIndexes[s], B = this.data[w], Q = B.dataPoints; if (0 < Q.length) for (var C = 5 < r && B.bevelEnabled ? !0 : !1, d = 0; d < Q.length; d++)if (Q[d].getTime ? l = Q[d].x.getTime() : l = Q[d].x, !(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax) && !g(Q[d].y) && Q[d].y.length && "number" ===
                      typeof Q[d].y[0] && "number" === typeof Q[d].y[1] && "number" === typeof Q[d].y[2] && "number" === typeof Q[d].y[3] && "number" === typeof Q[d].y[4] && 5 === Q[d].y.length) {
                        k = a.axisX.convertValueToPixel(l); v = a.axisY.convertValueToPixel(Q[d].y[0]); m = a.axisY.convertValueToPixel(Q[d].y[1]); n = a.axisY.convertValueToPixel(Q[d].y[2]); p = a.axisY.convertValueToPixel(Q[d].y[3]); q = a.axisY.convertValueToPixel(Q[d].y[4]); var I = k - r / 2 << 0, D = k + r / 2 << 0, e = Q[d].color ? Q[d].color : B._colorSet[0], y = Math.round(Math.max(1, 0.15 * r)), z = 0 === y % 2 ? 0 :
                          0.5, S = Q[d].whiskerColor ? Q[d].whiskerColor : Q[d].color ? B.whiskerColor ? B.whiskerColor : Q[d].color : B.whiskerColor ? B.whiskerColor : e, X = "number" === typeof Q[d].whiskerThickness ? Q[d].whiskerThickness : "number" === typeof B.options.whiskerThickness ? B.whiskerThickness : y, F = Q[d].whiskerDashType ? Q[d].whiskerDashType : B.whiskerDashType, da = g(Q[d].whiskerLength) ? g(B.options.whiskerLength) ? r : B.whiskerLength : Q[d].whiskerLength, da = "number" === typeof da ? 0 >= da ? 0 : da >= r ? r : da : "string" === typeof da ? parseInt(da) * r / 100 > r ? r : parseInt(da) *
                            r / 100 : r, la = 1 === Math.round(X) % 2 ? 0.5 : 0, va = Q[d].stemColor ? Q[d].stemColor : Q[d].color ? B.stemColor ? B.stemColor : Q[d].color : B.stemColor ? B.stemColor : e, H = "number" === typeof Q[d].stemThickness ? Q[d].stemThickness : "number" === typeof B.options.stemThickness ? B.stemThickness : y, G = 1 === Math.round(H) % 2 ? 0.5 : 0, E = Q[d].stemDashType ? Q[d].stemDashType : B.stemDashType, L = Q[d].lineColor ? Q[d].lineColor : Q[d].color ? B.lineColor ? B.lineColor : Q[d].color : B.lineColor ? B.lineColor : e, M = "number" === typeof Q[d].lineThickness ? Q[d].lineThickness :
                              "number" === typeof B.options.lineThickness ? B.lineThickness : y, N = Q[d].lineDashType ? Q[d].lineDashType : B.lineDashType, U = 1 === Math.round(M) % 2 ? 0.5 : 0, O = B.upperBoxColor, P = B.lowerBoxColor, V = g(B.options.fillOpacity) ? 1 : B.fillOpacity, W = B.dataPointIds[d]; this._eventManager.objectMap[W] = {
                                id: W, objectType: "dataPoint", dataSeriesIndex: w, dataPointIndex: d, x1: I, y1: v, x2: D, y2: m, x3: k, y3: n, x4: k, y4: p, y5: q, borderThickness: y, color: e, stemThickness: H, stemColor: va, whiskerThickness: X, whiskerLength: da, whiskerColor: S, lineThickness: M,
                                lineColor: L
                              }; c.save(); 0 < H && (c.beginPath(), c.strokeStyle = va, c.lineWidth = H, c.setLineDash && c.setLineDash(T(E, H)), c.moveTo(k - G, m), c.lineTo(k - G, v), c.stroke(), c.moveTo(k - G, p), c.lineTo(k - G, n), c.stroke()); c.restore(); b.lineWidth = Math.max(y, 4); c.beginPath(); Z(c, I, Math.min(q, m), D, Math.max(m, q), P, 0, e, t ? C : !1, t ? !1 : C, !1, !1, V); c.beginPath(); Z(c, I, Math.min(n, q), D, Math.max(q, n), O, 0, e, t ? !1 : C, t ? C : !1, !1, !1, V); c.beginPath(); c.lineWidth = y; c.strokeStyle = e; c.rect(I - z, Math.min(m, n) - z, D - I + 2 * z, Math.max(m, n) - Math.min(m, n) + 2 *
                                z); c.stroke(); c.save(); 0 < M && (c.beginPath(), c.globalAlpha = 1, c.setLineDash && c.setLineDash(T(N, M)), c.strokeStyle = L, c.lineWidth = M, c.moveTo(I, q - U), c.lineTo(D, q - U), c.stroke()); c.restore(); c.save(); 0 < X && (c.beginPath(), c.setLineDash && c.setLineDash(T(F, X)), c.strokeStyle = S, c.lineWidth = X, c.moveTo(k - da / 2 << 0, p - la), c.lineTo(k + da / 2 << 0, p - la), c.stroke(), c.moveTo(k - da / 2 << 0, v + la), c.lineTo(k + da / 2 << 0, v + la), c.stroke()); c.restore(); u && (e = R(W), b.strokeStyle = e, b.lineWidth = H, 0 < H && (b.moveTo(k - z - G, m), b.lineTo(k - z - G, Math.max(v,
                                  p)), b.stroke(), b.moveTo(k - z - G, Math.min(v, p)), b.lineTo(k - z - G, n), b.stroke()), Z(b, I, Math.max(m, n), D, Math.min(m, n), e, 0, null, !1, !1, !1, !1), 0 < X && (b.beginPath(), b.lineWidth = X, b.moveTo(k + da / 2, p - la), b.lineTo(k - da / 2, p - la), b.stroke(), b.moveTo(k + da / 2, v + la), b.lineTo(k - da / 2, v + la), b.stroke())); (Q[d].indexLabel || B.indexLabel || Q[d].indexLabelFormatter || B.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: B.type, dataPoint: Q[d], dataSeries: B, point: { x: I + (D - I) / 2, y: a.axisY.reversed ? v : p }, direction: 1, bounds: {
                                      x1: I, y1: Math.min(v,
                                        p), x2: D, y2: Math.max(v, p)
                                    }, color: e
                                  })
                    }
            ...
            var f = a.targetCanvasCtx || this.plotArea.ctx, c = u ? this._preRenderCtx : f; if (!(0 >= a.dataSeriesIndexes.length)) {
              var b = null, e = this.plotArea, h = 0, d, k, v, h = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1; d = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.03 * this.width; var m =
              ...
              m > d && (m = d); c.save(); u && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); u && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                var p = a.dataSeriesIndexes[n], q = this.data[p], l = q.dataPoints; if (0 < l.length) for (var r = 5 < m && q.bevelEnabled ? !0 : !1, h = 0; h < l.length; h++)if (l[h].getTime ? v = l[h].x.getTime() : v = l[h].x, !(v < a.axisX.dataInfo.viewPortMin ||
                  v > a.axisX.dataInfo.viewPortMax) && !g(l[h].y) && l[h].y.length && "number" === typeof l[h].y[0] && "number" === typeof l[h].y[1]) {
                    b = a.axisX.convertValueToPixel(v); d = a.axisY.convertValueToPixel(l[h].y[0]); k = a.axisY.convertValueToPixel(l[h].y[1]); var t = a.axisX.reversed ? b + a.plotType.totalDataSeries * m / 2 - (a.previousDataSeriesCount + n) * m << 0 : b - a.plotType.totalDataSeries * m / 2 + (a.previousDataSeriesCount + n) * m << 0, s = a.axisX.reversed ? t - m << 0 : t + m << 0, b = l[h].color ? l[h].color : q._colorSet[h % q._colorSet.length]; if (d > k) {
                      var w = d; d =
                        k; k = w
                    } w = q.dataPointIds[h]; this._eventManager.objectMap[w] = { id: w, objectType: "dataPoint", dataSeriesIndex: p, dataPointIndex: h, x1: t, y1: d, x2: s, y2: k }; Z(c, a.axisX.reversed ? s : t, d, a.axisX.reversed ? t : s, k, b, 0, b, r, r, !1, !1, q.fillOpacity); b = R(w); u && Z(this._eventManager.ghostCtx, a.axisX.reversed ? s : t, d, a.axisX.reversed ? t : s, k, b, 0, null, !1, !1, !1, !1); if (l[h].indexLabel || q.indexLabel || l[h].indexLabelFormatter || q.indexLabelFormatter) this._indexLabels.push({
                      chartType: "rangeColumn", dataPoint: l[h], dataSeries: q, indexKeyword: 0,
                      point: { x: t + (s - t) / 2, y: l[h].y[1] >= l[h].y[0] ? k : d }, direction: l[h].y[1] >= l[h].y[0] ? -1 : 1, bounds: { x1: t, y1: Math.min(d, k), x2: s, y2: Math.max(d, k) }, color: b
                    }), this._indexLabels.push({ chartType: "rangeColumn", dataPoint: l[h], dataSeries: q, indexKeyword: 1, point: { x: t + (s - t) / 2, y: l[h].y[1] >= l[h].y[0] ? d : k }, direction: l[h].y[1] >= l[h].y[0] ? 1 : -1, bounds: { x1: t, y1: Math.min(d, k), x2: s, y2: Math.max(d, k) }, color: b })
                }
              } u && (f.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas &&
            ...
            var f =
              a.targetCanvasCtx || this.plotArea.ctx, c = u ? this._preRenderCtx : f, b = a.axisY._position ? "left" === a.axisY._position || "right" === a.axisY._position ? !1 : !0 : !1; if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, h = !1, d = this.plotArea, k = 0, v, m, n, p, q, l, r, t = a.axisX.dataInfo.minDiff; isFinite(t) || (t = 0.3 * Math.abs(a.axisX.range)); c.save(); u && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(d.x1, d.y1, d.width, d.height); c.clip(); u && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(d.x1, d.y1, d.width,
                  d.height), this._eventManager.ghostCtx.clip()); for (var s = 0, w = 0; w < this.data.length; w++)!this.data[w].type.match(/(bar|column)/ig) || !this.data[w].visible || this.data[w].type.match(/(stacked)/ig) && s || s++; for (var B = 0; B < a.dataSeriesIndexes.length; B++) {
                    var Q = a.dataSeriesIndexes[B], C = this.data[Q], y = C.dataPoints, D = g(C._linkedSeries) ? !1 : C._linkedSeries.type.match(/(bar|column)/ig) && C._linkedSeries.visible ? !0 : !1, z = 0; if (D) for (e = C._linkedSeries.id, w = 0; w < e; w++)!this.data[w].type.match(/(bar|column)/ig) || !this.data[w].visible ||
                        ...
                        this.height, 0.9 * (this.plotArea.height / (D ? s : 1))) << 0 : 0.03 * this.width); w = this.options.dataPointWidth ? this.dataPointWidth : 0.9 * ((b ? d.height : d.width) * (a.axisX.logarithmic ? Math.log(t) / Math.log(a.axisX.range) : Math.abs(t) / Math.abs(a.axisX.range)) / (D ? s : 1)) << 0; this.dataPointMaxWidth && e > k && (e = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, k)); !this.dataPointMaxWidth && (this.dataPointMinWidth && k < e) && (k = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, e)); w < e && (w = e); w > k && (w =
                          k); if (0 < y.length) for (var F = C._colorSet, k = 0; k < y.length; k++) {
                            var e = C.lineColor = C.options.color ? C.options.color : F[0], S = {
                              ...
                              color: y[k].stemColor ? y[k].stemColor : y[k].color ? C.stemColor ? C.stemColor : y[k].color : C.stemColor ? C.stemColor : e, thickness: y[k].stemThickness ? y[k].stemThickness : C.stemThickness, dashType: y[k].stemDashType ? y[k].stemDashType :
                                C.stemDashType
                            }; X.thickness = "number" === typeof X.thickness ? 0 > X.thickness ? 0 : Math.round(X.thickness) : 2; y[k].getTime ? r = y[k].x.getTime() : r = y[k].x; if (!(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax) && !g(y[k].y) && y[k].y.length && "number" === typeof y[k].y[0] && "number" === typeof y[k].y[1]) {
                              var ia = a.axisX.convertValueToPixel(r); b ? m = ia : v = ia; ia = a.axisY.convertValueToPixel(y[k].y[0]); b ? n = ia : q = ia; ia = a.axisY.convertValueToPixel(y[k].y[1]); b ? p = ia : l = ia; b ? (q = a.axisX.reversed ? m + (D ? s : 1) * w / 2 - (D ? z - 1 : 0) * w <<
                                0 : m - (D ? s : 1) * w / 2 + (D ? z - 1 : 0) * w << 0, l = a.axisX.reversed ? q - w << 0 : q + w << 0) : (n = a.axisX.reversed ? v + (D ? s : 1) * w / 2 - (D ? z - 1 : 0) * w << 0 : v - (D ? s : 1) * w / 2 + (D ? z - 1 : 0) * w << 0, p = a.axisX.reversed ? n - w << 0 : n + w << 0); !b && q > l && (ia = q, q = l, l = ia); b && n > p && (ia = n, n = p, p = ia); ia = C.dataPointIds[k]; this._eventManager.objectMap[ia] = { id: ia, objectType: "dataPoint", dataSeriesIndex: Q, dataPointIndex: k, x1: Math.min(n, p), y1: Math.min(q, l), x2: Math.max(p, n), y2: Math.max(l, q), isXYSwapped: b, stemProperties: X, whiskerProperties: S }; E(c, Math.min(n, p), Math.min(q, l), Math.max(p,
                                  n), Math.max(l, q), e, S, X, b); u && E(this._eventManager.ghostCtx, n, q, p, l, e, S, X, b); if (y[k].indexLabel || C.indexLabel || y[k].indexLabelFormatter || C.indexLabelFormatter) this._indexLabels.push({ chartType: "error", dataPoint: y[k], dataSeries: C, indexKeyword: 0, point: { x: b ? y[k].y[1] >= y[k].y[0] ? n : p : n + (p - n) / 2, y: b ? q + (l - q) / 2 : y[k].y[1] >= y[k].y[0] ? l : q }, direction: y[k].y[1] >= y[k].y[0] ? -1 : 1, bounds: { x1: b ? Math.min(n, p) : n, y1: b ? q : Math.min(q, l), x2: b ? Math.max(n, p) : p, y2: b ? l : Math.max(q, l) }, color: e, axisSwapped: b }), this._indexLabels.push({
                                    chartType: "error",
                                    dataPoint: y[k], dataSeries: C, indexKeyword: 1, point: { x: b ? y[k].y[1] >= y[k].y[0] ? p : n : n + (p - n) / 2, y: b ? q + (l - q) / 2 : y[k].y[1] >= y[k].y[0] ? q : l }, direction: y[k].y[1] >= y[k].y[0] ? 1 : -1, bounds: { x1: b ? Math.min(n, p) : n, y1: b ? q : Math.min(q, l), x2: b ? Math.max(n, p) : p, y2: b ? l : Math.max(q, l) }, color: e, axisSwapped: b
                                  })
                            }
                          }
                  } u && (f.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas,
                  ...
                  Math.abs(n) / Math.abs(a.axisX.range)) / a.plotType.totalDataSeries) << 0; this.dataPointMaxWidth && h > d && (h = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, d)); !this.dataPointMaxWidth && (this.dataPointMinWidth && d < h) && (d = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, h)); n < h && (n = h); n > d && (n = d); c.save(); u && this._eventManager.ghostCtx.save(); c.beginPath(); c.rect(e.x1, e.y1, e.width, e.height); c.clip(); u && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1,
                    e.y1, e.width, e.height), this._eventManager.ghostCtx.clip()); for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                      var q = a.dataSeriesIndexes[p], l = this.data[q], r = l.dataPoints; if (0 < r.length) {
                        var t = 5 < n && l.bevelEnabled ? !0 : !1; c.strokeStyle = "#4572A7 "; for (h = 0; h < r.length; h++)if (r[h].getTime ? m = r[h].x.getTime() : m = r[h].x, !(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax) && !g(r[h].y) && r[h].y.length && "number" === typeof r[h].y[0] && "number" === typeof r[h].y[1]) {
                          d = a.axisY.convertValueToPixel(r[h].y[0]); k = a.axisY.convertValueToPixel(r[h].y[1]);
                          v = a.axisX.convertValueToPixel(m); v = a.axisX.reversed ? v + a.plotType.totalDataSeries * n / 2 - (a.previousDataSeriesCount + p) * n << 0 : v - a.plotType.totalDataSeries * n / 2 + (a.previousDataSeriesCount + p) * n << 0; var s = a.axisX.reversed ? v - n << 0 : v + n << 0; d > k && (b = d, d = k, k = b); b = r[h].color ? r[h].color : l._colorSet[h % l._colorSet.length]; Z(c, d, a.axisX.reversed ? s : v, k, a.axisX.reversed ? v : s, b, 0, null, t, !1, !1, !1, l.fillOpacity); b = l.dataPointIds[h]; this._eventManager.objectMap[b] = {
                            id: b, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: h,
                            x1: d, y1: v, x2: k, y2: s
                          }; b = R(b); u && Z(this._eventManager.ghostCtx, d, a.axisX.reversed ? s : v, k, a.axisX.reversed ? v : s, b, 0, null, !1, !1, !1, !1); if (r[h].indexLabel || l.indexLabel || r[h].indexLabelFormatter || l.indexLabelFormatter) this._indexLabels.push({ chartType: "rangeBar", dataPoint: r[h], dataSeries: l, indexKeyword: 0, point: { x: r[h].y[1] >= r[h].y[0] ? d : k, y: v + (s - v) / 2 }, direction: r[h].y[1] >= r[h].y[0] ? -1 : 1, bounds: { x1: Math.min(d, k), y1: v, x2: Math.max(d, k), y2: s }, color: b }), this._indexLabels.push({
                            chartType: "rangeBar", dataPoint: r[h],
                            dataSeries: l, indexKeyword: 1, point: { x: r[h].y[1] >= r[h].y[0] ? k : d, y: v + (s - v) / 2 }, direction: r[h].y[1] >= r[h].y[0] ? 1 : -1, bounds: { x1: Math.min(d, k), y1: v, x2: Math.max(d, k), y2: s }, color: b
                          })
                        }
                      }
                    } u && (f.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
            ...
            function f() {
              if (B) {
                ...
                } b.beginPath(); b.moveTo(r, v); e.beginPath(); e.moveTo(r, v); B = { x: r, y: v }; k = []; k.push({ x: r, y1: v, y2: s })
              }
            } var c = a.targetCanvasCtx || this.plotArea.ctx, b = u ? this._preRenderCtx : c; if (!(0 >= a.dataSeriesIndexes.length)) {
              var e = this._eventManager.ghostCtx, h = [], g = this.plotArea; b.save(); u && e.save(); b.beginPath(); b.rect(g.x1, g.y1, g.width, g.height); b.clip(); u && (e.beginPath(),
                e.rect(g.x1, g.y1, g.width, g.height), e.clip()); for (var d = 0; d < a.dataSeriesIndexes.length; d++) {
                  var k = [], m = a.dataSeriesIndexes[d], n = this.data[m], p = n.dataPoints, h = n.id; this._eventManager.objectMap[h] = { objectType: "dataSeries", dataSeriesIndex: m }; h = R(h); e.fillStyle = h; var h = [], q = !0, l = 0, r, v, s, w, B = null; if (0 < p.length) {
                    var y = n._colorSet[l % n._colorSet.length], C = n.lineColor = n.options.lineColor || y, z = C; b.fillStyle = y; b.strokeStyle = C; b.lineWidth = n.lineThickness; var D = "solid"; if (b.setLineDash) {
                      var F = T(n.nullDataLineDashType,
                        n.lineThickness), D = n.lineDashType, H = T(D, n.lineThickness); b.setLineDash(H)
                    } for (var S = !0; l < p.length; l++)if (w = p[l].x.getTime ? p[l].x.getTime() : p[l].x, !(w < a.axisX.dataInfo.viewPortMin || w > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !S))) if (null !== p[l].y && p[l].y.length && "number" === typeof p[l].y[0] && "number" === typeof p[l].y[1]) {
                      r = a.axisX.convertValueToPixel(w); v = a.axisY.convertValueToPixel(p[l].y[0]); s = a.axisY.convertValueToPixel(p[l].y[1]); q || S ? (n.connectNullData && !q ? (b.setLineDash && (n.options.nullDataLineDashType ||
                        D === n.lineDashType && n.lineDashType !== n.nullDataLineDashType) && (k[k.length - 1].newLineDashArray = H, D = n.nullDataLineDashType, b.setLineDash(F)), b.lineTo(r, v), u && e.lineTo(r, v), k.push({ x: r, y1: v, y2: s })) : (b.beginPath(), b.moveTo(r, v), B = { x: r, y: v }, k = [], k.push({ x: r, y1: v, y2: s }), u && (e.beginPath(), e.moveTo(r, v))), S = q = !1) : (b.lineTo(r, v), k.push({ x: r, y1: v, y2: s }), u && e.lineTo(r, v), 0 == l % 250 && f()); w = n.dataPointIds[l]; this._eventManager.objectMap[w] = {
                          id: w, objectType: "dataPoint", dataSeriesIndex: m, dataPointIndex: l, x1: r, y1: v,
                          y2: s
                        }; l < p.length - 1 && (z !== (p[l].lineColor || C) || D !== (p[l].lineDashType || n.lineDashType)) && (f(), z = p[l].lineColor || C, k[k.length - 1].newStrokeStyle = z, b.strokeStyle = z, b.setLineDash && (p[l].lineDashType ? (D = p[l].lineDashType, k[k.length - 1].newLineDashArray = T(D, n.lineThickness), b.setLineDash(k[k.length - 1].newLineDashArray)) : (D = n.lineDashType, k[k.length - 1].newLineDashArray = H, b.setLineDash(H)))); if (0 !== p[l].markerSize && (0 < p[l].markerSize || 0 < n.markerSize)) {
                          var X = n.getMarkerProperties(l, r, s, b); h.push(X); var ia = R(w);
                          u && h.push({ x: r, y: s, ctx: e, type: X.type, size: X.size, color: ia, borderColor: ia, borderThickness: X.borderThickness }); X = n.getMarkerProperties(l, r, v, b); h.push(X); ia = R(w); u && h.push({ x: r, y: v, ctx: e, type: X.type, size: X.size, color: ia, borderColor: ia, borderThickness: X.borderThickness })
                        } if (p[l].indexLabel || n.indexLabel || p[l].indexLabelFormatter || n.indexLabelFormatter) this._indexLabels.push({
                          chartType: "rangeArea", dataPoint: p[l], dataSeries: n, indexKeyword: 0, point: { x: r, y: v }, direction: p[l].y[0] > p[l].y[1] === a.axisY.reversed ?
                            -1 : 1, color: y
                        }), this._indexLabels.push({ chartType: "rangeArea", dataPoint: p[l], dataSeries: n, indexKeyword: 1, point: { x: r, y: s }, direction: p[l].y[0] > p[l].y[1] === a.axisY.reversed ? 1 : -1, color: y })
                    } else S || q || f(), S = !0; f(); t.drawMarkers(h)
                  }
                } u && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx &&
                  ...
                  1].x, f[h + 1].y, f[h + 2].x, f[h + 2].y, f[h + 3].x, f[h + 3].y); f = H(s, 2); b.lineTo(s[s.length - 1].x, s[s.length - 1].y); for (h = f.length - 1; 2 < h; h -= 3)b.bezierCurveTo(f[h - 1].x, f[h - 1].y, f[h - 2].x, f[h - 2].y, f[h - 3].x, f[h - 3].y), u && e.bezierCurveTo(f[h - 1].x, f[h - 1].y, f[h - 2].x, f[h - 2].y, f[h - 3].x, f[h - 3].y); b.closePath(); b.globalAlpha = m.fillOpacity; b.fill(); u && (e.closePath(), e.fill()); b.globalAlpha = 1; if (0 < m.lineThickness) {
                    b.strokeStyle = c; b.setLineDash && b.setLineDash(a); b.beginPath(); b.moveTo(f[0].x, f[0].y); for (var l = h = 0; h < f.length -
                      3; h += 3, l++) { if (v[l].newStrokeStyle || v[l].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(f[h].x, f[h].y), v[l].newStrokeStyle && (b.strokeStyle = v[l].newStrokeStyle), v[l].newLineDashArray && b.setLineDash(v[l].newLineDashArray); b.bezierCurveTo(f[h + 1].x, f[h + 1].y, f[h + 2].x, f[h + 2].y, f[h + 3].x, f[h + 3].y) } f = H(v, 2); b.moveTo(f[0].x, f[0].y); for (l = h = 0; h < f.length - 3; h += 3, l++) {
                        if (v[l].newStrokeStyle || v[l].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(f[h].x, f[h].y), v[l].newStrokeStyle && (b.strokeStyle = v[l].newStrokeStyle),
                          v[l].newLineDashArray && b.setLineDash(v[l].newLineDashArray); b.bezierCurveTo(f[h + 1].x, f[h + 1].y, f[h + 2].x, f[h + 2].y, f[h + 3].x, f[h + 3].y)
                      } b.stroke()
                  } b.beginPath()
              }
            } var c = a.targetCanvasCtx || this.plotArea.ctx, b = u ? this._preRenderCtx : c; if (!(0 >= a.dataSeriesIndexes.length)) {
              var e = this._eventManager.ghostCtx, h = [], g = this.plotArea; b.save(); u && e.save(); b.beginPath(); b.rect(g.x1, g.y1, g.width, g.height); b.clip(); u && (e.beginPath(), e.rect(g.x1, g.y1, g.width, g.height), e.clip()); for (var d = 0; d < a.dataSeriesIndexes.length; d++) {
                var k =
                  a.dataSeriesIndexes[d], m = this.data[k], n = m.dataPoints, h = m.id; this._eventManager.objectMap[h] = { objectType: "dataSeries", dataSeriesIndex: k }; h = R(h); e.fillStyle = h; var h = [], p = 0, q, l, r, v = [], s = []; if (0 < n.length) {
                    var w = m._colorSet[p % m._colorSet.length], B = m.lineColor = m.options.lineColor || w, y = B; b.fillStyle = w; b.lineWidth = m.lineThickness; var C = "solid", z; if (b.setLineDash) { var D = T(m.nullDataLineDashType, m.lineThickness), C = m.lineDashType; z = T(C, m.lineThickness) } for (l = !1; p < n.length; p++)if (q = n[p].x.getTime ? n[p].x.getTime() :
                      n[p].x, !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !l))) if (null !== n[p].y && n[p].y.length && "number" === typeof n[p].y[0] && "number" === typeof n[p].y[1]) {
                        q = a.axisX.convertValueToPixel(q); l = a.axisY.convertValueToPixel(n[p].y[0]); r = a.axisY.convertValueToPixel(n[p].y[1]); var F = m.dataPointIds[p]; this._eventManager.objectMap[F] = { id: F, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: p, x1: q, y1: l, y2: r }; v[v.length] = { x: q, y: l }; s[s.length] = { x: q, y: r }; p < n.length - 1 && (y !==
                          (n[p].lineColor || B) || C !== (n[p].lineDashType || m.lineDashType)) && (y = n[p].lineColor || B, v[v.length - 1].newStrokeStyle = y, b.setLineDash && (n[p].lineDashType ? (C = n[p].lineDashType, v[v.length - 1].newLineDashArray = T(C, m.lineThickness)) : (C = m.lineDashType, v[v.length - 1].newLineDashArray = z))); if (0 !== n[p].markerSize && (0 < n[p].markerSize || 0 < m.markerSize)) {
                            var E = m.getMarkerProperties(p, q, l, b); h.push(E); var S = R(F); u && h.push({ x: q, y: l, ctx: e, type: E.type, size: E.size, color: S, borderColor: S, borderThickness: E.borderThickness });
                            E = m.getMarkerProperties(p, q, r, b); h.push(E); S = R(F); u && h.push({ x: q, y: r, ctx: e, type: E.type, size: E.size, color: S, borderColor: S, borderThickness: E.borderThickness })
                          } if (n[p].indexLabel || m.indexLabel || n[p].indexLabelFormatter || m.indexLabelFormatter) this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: n[p], dataSeries: m, indexKeyword: 0, point: { x: q, y: l }, direction: n[p].y[0] <= n[p].y[1] ? -1 : 1, color: w }), this._indexLabels.push({
                            chartType: "rangeSplineArea", dataPoint: n[p], dataSeries: m, indexKeyword: 1, point: {
                              x: q,
                              y: r
                            }, direction: n[p].y[0] <= n[p].y[1] ? 1 : -1, color: w
                          }); l = !1
                      } else 0 < p && !l && (m.connectNullData ? b.setLineDash && (0 < v.length && (m.options.nullDataLineDashType || !n[p - 1].lineDashType)) && (v[v.length - 1].newLineDashArray = D, C = m.nullDataLineDashType) : (f(z, B), v = [], s = [])), l = !0; f(z, B); t.drawMarkers(h)
                  }
            ...
            var f = a.targetCanvasCtx || this.plotArea.ctx, c = u ? this._preRenderCtx : f; if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              c.clip(); u && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(h.x1, h.y1, h.width, h.height), this._eventManager.ghostCtx.clip()); for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                var r = a.dataSeriesIndexes[l], v = this.data[r], t = v.dataPoints, e = v._colorSet[0]; v.risingColor = v.options.risingColor ? v.options.risingColor : e; v.fallingColor = v.options.fallingColor ? v.options.fallingColor : "#e40a0a"; var w = "number" === typeof v.options.lineThickness ? Math.round(v.lineThickness) : 1, s = 1 === Math.round(w) %
                  2 ? -0.5 : 0; if (0 < t.length) for (var y = 5 < q && v.bevelEnabled ? !0 : !1, C = !1, z = null, D = null, g = 0; g < t.length; g++)if (t[g].getTime ? n = t[g].x.getTime() : n = t[g].x, "number" !== typeof t[g].y) { if (0 < g && !C && v.connectNullData) var F = v.options.nullDataLineDashType || !t[g - 1].lineDashType ? v.nullDataLineDashType : t[g - 1].lineDashType; C = !0 } else {
                    d = a.axisX.convertValueToPixel(n); k = 0 === v.dataPointEOs[g].cumulativeSum ? p : a.axisY.convertValueToPixel(v.dataPointEOs[g].cumulativeSum); m = 0 === v.dataPointEOs[g].cumulativeSumYStartValue ? p : a.axisY.convertValueToPixel(v.dataPointEOs[g].cumulativeSumYStartValue);
                    d = a.axisX.reversed ? d + a.plotType.totalDataSeries * q / 2 - (a.previousDataSeriesCount + l) * q << 0 : d - a.plotType.totalDataSeries * q / 2 + (a.previousDataSeriesCount + l) * q << 0; var H = a.axisX.reversed ? d - q << 0 : d + q << 0; k > m && (e = k, k = m, m = e); a.axisY.reversed && (e = k, k = m, m = e); e = v.dataPointIds[g]; this._eventManager.objectMap[e] = { id: e, objectType: "dataPoint", dataSeriesIndex: r, dataPointIndex: g, x1: d, y1: k, x2: H, y2: m }; var S = t[g].color ? t[g].color : 0 < t[g].y ? v.risingColor : v.fallingColor; Z(c, a.axisX.reversed ? H : d, a.axisY.reversed ? m : k, a.axisX.reversed ?
                      d : H, a.axisY.reversed ? k : m, S, 0, S, y, y, !1, !1, v.fillOpacity); e = R(e); u && Z(this._eventManager.ghostCtx, a.axisX.reversed ? H : d, k, a.axisX.reversed ? d : H, m, e, 0, null, !1, !1, !1, !1); var X, S = d; X = "undefined" !== typeof t[g].isIntermediateSum && !0 === t[g].isIntermediateSum || "undefined" !== typeof t[g].isCumulativeSum && !0 === t[g].isCumulativeSum ? 0 < t[g].y ? k : m : 0 < t[g].y ? m : k; 0 < g && z && (!C || v.connectNullData) && (C && c.setLineDash && c.setLineDash(T(F, w)), c.beginPath(), c.moveTo(z, D - s), c.lineTo(S, X - s), 0 < w && c.stroke(), u && (b.beginPath(), b.moveTo(z,
                        D - s), b.lineTo(S, X - s), 0 < w && b.stroke())); C = !1; z = H; D = 0 < t[g].y ? k : m; S = t[g].lineDashType ? t[g].lineDashType : v.options.lineDashType ? v.options.lineDashType : "shortDash"; c.strokeStyle = t[g].lineColor ? t[g].lineColor : v.options.lineColor ? v.options.lineColor : "#9e9e9e"; c.lineWidth = w; c.setLineDash && (S = T(S, w), c.setLineDash(S)); (t[g].indexLabel || v.indexLabel || t[g].indexLabelFormatter || v.indexLabelFormatter) && this._indexLabels.push({
                          chartType: "waterfall", dataPoint: t[g], dataSeries: v, point: { x: d + (H - d) / 2, y: 0 <= t[g].y ? k : m },
                          direction: 0 > t[g].y === a.axisY.reversed ? 1 : -1, bounds: { x1: d, y1: Math.min(k, m), x2: H, y2: Math.max(k, m) }, color: e
                        })
                  }
              } u && (f.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && c.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.clearRect(h.x1, h.y1, h.width,
          ...
          }; var d = function (a, f, c, b, e, h, g, d, k) {
            if (!(0 > c)) {
              "undefined" === typeof d && (d = 1); if (!u) { var m = Number((g % (2 * Math.PI)).toFixed(8)); Number((h % (2 * Math.PI)).toFixed(8)) === m && (g -= 1E-4) } a.save(); a.globalAlpha = d; "pie" === e ? (a.beginPath(), a.moveTo(f.x, f.y), a.arc(f.x, f.y, c, h, g, !1), a.fillStyle = b, a.strokeStyle = "white", a.lineWidth =
            ...
            function f() {
              if (m && n) {
                for (var a = 0, b = 0, c = 0, f = 0, e = 0; e < n.length; e++) {
                  var h = n[e], d = m.dataPointIds[e]; l[e].id = d; l[e].objectType = "dataPoint"; l[e].dataPointIndex = e; l[e].dataSeriesIndex = 0; var p = l[e], k = { percent: null, total: null }, A = null, k = x.getPercentAndTotal(m,
                  ...
                  p.indexLabelLineColor = h.indexLabelLineColor ? h.indexLabelLineColor : m.options.indexLabelLineColor ? m.options.indexLabelLineColor : h.color ? h.color : m._colorSet[e % m._colorSet.length]; p.indexLabelLineThickness = g(h.indexLabelLineThickness) ? m.indexLabelLineThickness : h.indexLabelLineThickness; p.indexLabelLineDashType = h.indexLabelLineDashType ? h.indexLabelLineDashType : m.indexLabelLineDashType; p.indexLabelFontColor = h.indexLabelFontColor ? h.indexLabelFontColor : m.indexLabelFontColor; p.indexLabelFontStyle = h.indexLabelFontStyle ?
                    h.indexLabelFontStyle : m.indexLabelFontStyle; p.indexLabelFontWeight = h.indexLabelFontWeight ? h.indexLabelFontWeight : m.indexLabelFontWeight; p.indexLabelFontSize = g(h.indexLabelFontSize) ? m.indexLabelFontSize : h.indexLabelFontSize; p.indexLabelFontFamily = h.indexLabelFontFamily ? h.indexLabelFontFamily : m.indexLabelFontFamily; p.indexLabelBackgroundColor = h.indexLabelBackgroundColor ? h.indexLabelBackgroundColor : m.options.indexLabelBackgroundColor ? m.options.indexLabelBackgroundColor : m.indexLabelBackgroundColor; p.indexLabelMaxWidth =
                      h.indexLabelMaxWidth ? h.indexLabelMaxWidth : m.indexLabelMaxWidth ? m.indexLabelMaxWidth : 0.33 * q.width; p.indexLabelWrap = "undefined" !== typeof h.indexLabelWrap ? h.indexLabelWrap : m.indexLabelWrap; p.indexLabelTextAlign = h.indexLabelTextAlign ? h.indexLabelTextAlign : m.indexLabelTextAlign ? m.indexLabelTextAlign : "left"; p.startAngle = 0 === e ? m.startAngle ? m.startAngle / 180 * Math.PI : 0 : l[e - 1].endAngle; p.startAngle = (p.startAngle + 2 * Math.PI) % (2 * Math.PI); p.endAngle = p.startAngle + 2 * Math.PI / C * Math.abs(h.y); h = (p.endAngle + p.startAngle) /
                        2; h = (h + 2 * Math.PI) % (2 * Math.PI); p.midAngle = h; if (p.midAngle > Math.PI / 2 - w && p.midAngle < Math.PI / 2 + w) { if (0 === a || l[c].midAngle > p.midAngle) c = e; a++ } else if (p.midAngle > 3 * Math.PI / 2 - w && p.midAngle < 3 * Math.PI / 2 + w) { if (0 === b || l[f].midAngle > p.midAngle) f = e; b++ } p.hemisphere = h > Math.PI / 2 && h <= 3 * Math.PI / 2 ? "left" : "right"; p.indexLabelTextBlock = new na(x.plotArea.ctx, {
                ...
                } d = h = 0; k = !1; for (e = 0; e < n.length; e++)p = l[(c + e) % n.length], 1 < a && (p.midAngle > Math.PI / 2 - w && p.midAngle < Math.PI / 2 + w) && (h <= a / 2 && !k ? (p.hemisphere = "right", h++) : (p.hemisphere = "left", k = !0)); k = !1; for (e = 0; e < n.length; e++)p = l[(f + e) % n.length], 1 < b && (p.midAngle >
                  3 * Math.PI / 2 - w && p.midAngle < 3 * Math.PI / 2 + w) && (d <= b / 2 && !k ? (p.hemisphere = "left", d++) : (p.hemisphere = "right", k = !0))
              }
            } function c(a) {
              var b = x.plotArea.ctx; b.clearRect(q.x1, q.y1, q.width, q.height); b.fillStyle = x.backgroundColor; b.fillRect(q.x1, q.y1, q.width, q.height); for (b = 0; b < n.length; b++) {
                var c = l[b].startAngle, f = l[b].endAngle; if (f > c) {
                  var e = 0.07 * D * Math.cos(l[b].midAngle), h = 0.07 * D * Math.sin(l[b].midAngle), g = !1; if (n[b].exploded) {
                    if (1E-9 < Math.abs(l[b].center.x - (y.x + e)) || 1E-9 < Math.abs(l[b].center.y - (y.y + h))) l[b].center.x =
                      y.x + e * a, l[b].center.y = y.y + h * a, g = !0
              ...
              f = (f || 0) + 1; if (1E3 < f) return 0; c = c || 0; var g = 0, d = y.y - 1 * t, m = y.y + 1 * t; if (0 <= a && a < n.length) {
              ...
              var a = x.plotArea.ctx; a.fillStyle = "grey"; a.strokeStyle = "grey"; a.font = "16px Arial"; a.textBaseline = "middle"; for (var c = a = 0, f = 0, g = !0, c = 0; 10 > c && (1 > c || 0 < f); c++) {
                if (m.radius || !m.radius && "undefined" !== typeof m.innerRadius && null !== m.innerRadius &&
                  D - f <= F) g = !1; g && (D -= f); f = 0; if ("inside" !== m.indexLabelPlacement) {
                    t = D * u; for (a = 0; a < n.length; a++) { var d = l[a]; d.indexLabelTextBlock.x = y.x + t * Math.cos(d.midAngle); d.indexLabelTextBlock.y = y.y + t * Math.sin(d.midAngle); d.indexLabelAngle = d.midAngle; d.radius = D; d.percentInnerRadius = H } for (var A, v, a = 0; a < n.length; a++) {
                      var d = l[a], w = e(a); if (null !== w) {
                        A = l[a]; v = l[w]; var C = 0, C = b(A, v) - r; if (0 > C) {
                          for (var ua = v = 0, z = 0; z < n.length; z++)z !== a && l[z].hemisphere === d.hemisphere && (l[z].indexLabelTextBlock.y < d.indexLabelTextBlock.y ? v++ :
                            ua++); v = C / (v + ua || 1) * ua; var ua = -1 * (C - v), I = z = 0; "right" === d.hemisphere ? (z = h(a, v), ua = -1 * (C - z), I = h(w, ua), +I.toFixed(s) < +ua.toFixed(s) && +z.toFixed(s) <= +v.toFixed(s) && h(a, -(ua - I))) : (z = h(w, v), ua = -1 * (C - z), I = h(a, ua), +I.toFixed(s) < +ua.toFixed(s) && +z.toFixed(s) <= +v.toFixed(s) && h(w, -(ua - I)))
                        }
                      }
                    }
                  } else for (a = 0; a < n.length; a++)d = l[a], t = "pie" === m.type ? 0.7 * D : 0.8 * D, w = y.x + t * Math.cos(d.midAngle), v = y.y + t * Math.sin(d.midAngle), d.indexLabelTextBlock.x = w, d.indexLabelTextBlock.y = v; for (a = 0; a < n.length; a++)if (d = l[a], w = d.indexLabelTextBlock.measureText(),
                    0 !== w.height && 0 !== w.width) w = w = 0, "right" === d.hemisphere ? (w = q.x2 - (d.indexLabelTextBlock.x + d.indexLabelTextBlock.width + p), w *= -1) : w = q.x1 - (d.indexLabelTextBlock.x - d.indexLabelTextBlock.width - p), 0 < w && (!g && d.indexLabelText && (v = "right" === d.hemisphere ? q.x2 - d.indexLabelTextBlock.x : d.indexLabelTextBlock.x - q.x1, 0.3 * d.indexLabelTextBlock.maxWidth > v ? d.indexLabelText = "" : d.indexLabelTextBlock.maxWidth = 0.85 * v, 0.3 * d.indexLabelTextBlock.maxWidth < v && (d.indexLabelTextBlock.x -= "right" === d.hemisphere ? 2 : -2)), Math.abs(d.indexLabelTextBlock.y -
                      d.indexLabelTextBlock.height / 2 - y.y) < D || Math.abs(d.indexLabelTextBlock.y + d.indexLabelTextBlock.height / 2 - y.y) < D) && (w /= Math.abs(Math.cos(d.indexLabelAngle)), 9 < w && (w *= 0.3), w > f && (f = w)), w = w = 0, 0 < d.indexLabelAngle && d.indexLabelAngle < Math.PI ? (w = q.y2 - (d.indexLabelTextBlock.y + d.indexLabelTextBlock.height / 2 + 5), w *= -1) : w = q.y1 - (d.indexLabelTextBlock.y - d.indexLabelTextBlock.height / 2 - 5), 0 < w && (!g && d.indexLabelText && (v = 0 < d.indexLabelAngle && d.indexLabelAngle < Math.PI ? -1 : 1, 0 === h(a, w * v) && h(a, 2 * v)), Math.abs(d.indexLabelTextBlock.x -
                        y.x) < D && (w /= Math.abs(Math.sin(d.indexLabelAngle)), 9 < w && (w *= 0.3), w > f && (f = w))); var E = function (a, b, c) { for (var f = [], e = 0; f.push(l[b]), b !== c; b = (b + 1 + n.length) % n.length); f.sort(function (a, b) { return a.y - b.y }); for (b = 0; b < f.length; b++)if (c = f[b], e < 0.7 * a) e += c.indexLabelTextBlock.height, c.indexLabelTextBlock.text = "", c.indexLabelText = "", c.indexLabelTextBlock.measureText(); else break }; (function () {
                          for (var a = -1, c = -1, f = 0, h = !1, g = 0; g < n.length; g++)if (h = !1, A = l[g], A.indexLabelText) {
                            var d = e(g); if (null !== d) {
                              var m = l[d]; C = 0;
              ...
              var m = this.data[a.dataSeriesIndexes[0]], n = m.dataPoints, p = 10, q = this.plotArea, l = m.dataPointEOs, r = 2, t, u = 1.3, w = 20 / 180 * Math.PI, s = 6, y = { x: (q.x2 + q.x1) / 2, y: (q.y2 + q.y1) / 2 }, C = 0; a = !1; for (var z = 0; z < n.length; z++)C += Math.abs(n[z].y), !a && ("undefined" !== typeof n[z].indexLabel && null !== n[z].indexLabel && 0 < n[z].indexLabel.toString().length) && (a = !0), !a && ("undefined" !== typeof n[z].label && null !== n[z].label &&
                0 < n[z].label.toString().length) && (a = !0); if (0 !== C) {
                  a = a || "undefined" !== typeof m.indexLabel && null !== m.indexLabel && 0 < m.indexLabel.toString().length; var D = "inside" !== m.indexLabelPlacement && a ? 0.75 * Math.min(q.width, q.height) / 2 : 0.92 * Math.min(q.width, q.height) / 2; m.radius && (D = Ua(m.radius, D)); var F = "undefined" !== typeof m.innerRadius && null !== m.innerRadius ? Ua(m.innerRadius, D) : 0.7 * D; m.radius = D; "doughnut" === m.type && (m.innerRadius = F); var H = Math.min(F / D, (D - 1) / D); this.pieDoughnutClickHandler = function (a) {
                    x.isAnimating ||
                    !g(a.dataSeries.explodeOnClick) && !a.dataSeries.explodeOnClick || (a = a.dataPoint, a.exploded = a.exploded ? !1 : !0, 1 < this.dataPoints.length && x._animator.animate(0, 500, function (a) { c(a); v(); x.dispatchEvent("dataAnimationIterationEnd", { chart: x }); x.dispatchEvent("dataAnimationEnd", { chart: x }) }))
                  }; f(); k(); k(); k(); k(); this.disableToolTip = !0; this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function (a) {
                    var b = x.plotArea.ctx; b.clearRect(q.x1, q.y1, q.width, q.height); b.fillStyle = x.backgroundColor; b.fillRect(q.x1,
                      q.y1, q.width, q.height); for (var b = l[0].startAngle + 2 * Math.PI * a, c = 0; c < n.length; c++) { var f = 0 === c ? l[c].startAngle : e, e = f + (l[c].endAngle - l[c].startAngle), h = !1; e > b && (e = b, h = !0); var g = n[c].color ? n[c].color : m._colorSet[c % m._colorSet.length]; e > f && d(x.plotArea.ctx, l[c].center, l[c].radius, g, m.type, f, e, m.fillOpacity, l[c].percentInnerRadius); if (h) break } v(); x.dispatchEvent("dataAnimationIterationEnd", { chart: x }); 1 <= a && x.dispatchEvent("dataAnimationEnd", { chart: x })
                  }, function () {
                    x.disableToolTip = !1; x._animator.animate(0,
                      x.animatedRender ? 500 : 0, function (a) { c(a); v(); x.dispatchEvent("dataAnimationIterationEnd", { chart: x }) }); x.dispatchEvent("dataAnimationEnd", { chart: x })
                  })
                }
            }
          }; var v = function (a, f, c, b) {
            ...
            function f() { for (var a = 0, b = [], c = 0; c < B.length; c++) { if ("undefined" === typeof B[c].y) return -1; B[c].y = "number" === typeof B[c].y ? B[c].y : 0; a += Math.abs(B[c].y) } if (0 === a) return -1; for (c = b[0] = 0; c < B.length; c++)b.push(Math.abs(B[c].y) * H / a); return b } function c() {
              var a = R, b = $, c = U, f = ca, e, h; e = L; h = N - P; f = Math.abs((h - e) * (b - a + (f - c)) / 2); c = ca - U; e = h - e; h = c * (h - N); h = Math.abs(h);
              ...
              if (w && B) {
                for (var a, b, c, f, e, h, d, m, p, n, q, k, A, r, v, x = [], t = [], s = { percent: null, total: null }, K = null, z = 0; z < B.length; z++)v = W[z], v = "undefined" !== typeof v.x5 ? (v.y2 + v.y4) / 2 : (v.y2 + v.y3) / 2, v = l(v).x2 + 1, x[z] = M - v - V; v = 0.5 * V; for (var z = 0, C = B.length - 1; z < B.length || 0 <= C; z++, C--) {
                  b = w.reversed ? B[C] : B[z]; a = b.color ? b.color : w.reversed ? w._colorSet[(B.length - 1 - z) % w._colorSet.length] : w._colorSet[z % w._colorSet.length]; c = b.indexLabelPlacement || w.indexLabelPlacement || "outside"; r = b.indexLabelTextAlign ||
              ...
              var a, b, c, f, e, h = []; e = !1; c = 0; for (var g, d = M - $ - V / 2, d = w.options.indexLabelMaxWidth ? w.indexLabelMaxWidth > d ? d : w.indexLabelMaxWidth : d, l = J.length - 1; 0 <= l; l--) { g = B[J[l].id]; c = J[l]; f = c.textBlock; b = (a = q(l) < W.length ? J[q(l)] : null) ? a.textBlock : null; c = c.height; a && f.y + c + ja > b.y && (e = !0); c = g.indexLabelMaxWidth || d; if (c > d || 0 > c) c = d; h.push(c) } if (e) for (l = J.length - 1; 0 <= l; l--)a = W[l], J[l].textBlock.maxWidth =
                h[h.length - (l + 1)], J[l].textBlock.measureText(), J[l].textBlock.x = M - d, c = J[l].textBlock.height < J[l].textBlock.maxHeight ? J[l].textBlock.height : J[l].textBlock.maxHeight, e = J[l].textBlock.width < J[l].textBlock.maxWidth ? J[l].textBlock.width : J[l].textBlock.maxWidth, J[l].height = c, J[l].width = e, c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2, J[l].textBlock.y = c - J[l].height / 2, w.reversed ? (J[l].textBlock.y + J[l].height > Y + C && (J[l].textBlock.y = Y + C - J[l].height), J[l].textBlock.y < Z - C && (J[l].textBlock.y = Z - C)) : (J[l].textBlock.y <
                  Y - C && (J[l].textBlock.y = Y - C), J[l].textBlock.y + J[l].height > Z + C && (J[l].textBlock.y = Z + C - J[l].height))
            } function h() {
              ...
              function a(b, c) { var f; if (0 > b || b >= J.length) return 0; var e, h = J[b].textBlock; if (0 > c) { c *= -1; e = p(b); f = k(e, b); if (f >= c) return h.y -= c, c; if (0 == b) return 0 < f && (h.y -= f), f; f += a(e, -(c - f)); 0 < f && (h.y -= f); return f } e = q(b); f = k(b, e); if (f >= c) return h.y += c, c; if (b == W.length - 1) return 0 < f && (h.y += f), f; f += a(e, c - f); 0 < f && (h.y += f); return f } function b() {
                var a, f, e, h, l = 0, g; h = (N - L + 2 * C) / n; g = n; for (var d, m = 1; m < g; m++) {
                  e = m * h; for (var k = J.length - 1; 0 <= k; k--)!J[k].isDirty && (J[k].textBlock.y < e && J[k].textBlock.y + J[k].height >
                    e) && (d = q(k), !(d >= J.length - 1) && J[k].textBlock.y + J[k].height + ja > J[d].textBlock.y && (J[k].textBlock.y = J[k].textBlock.y + J[k].height - e > e - J[k].textBlock.y ? e + 1 : e - J[k].height - 1))
                  ...
                  e = p(d); if (0 > e && (e = 0, J[e].isDirty)) break; if (J[d].textBlock.y < J[e].textBlock.y + J[e].height) {
                    f = f || d; h = d; for (g = 0; J[h].textBlock.y < J[e].textBlock.y + J[e].height + ja;) { a = a || J[h].textBlock.y + J[h].height; g += J[h].height; g += ja; h = e; if (0 >= h) { h = 0; g += J[h].height; break } e = p(h); if (0 > e) { h = 0; g += J[h].height; break } } if (h !=
                      d) { l = J[h].textBlock.y; a -= l; a = g - a; l = c(a, f, h); break }
                  }
                } return l
              } function c(a, b, f) { var e = [], h = 0, l = 0; for (a = Math.abs(a); f <= b; f++)e.push(W[f]); e.sort(function (a, b) { return a.height - b.height }); for (f = 0; f < e.length; f++)if (b = e[f], h < a) l++, h += J[b.id].height + ja, J[b.id].textBlock.text = "", J[b.id].indexLabelText = "", J[b.id].isDirty = !0, J[b.id].textBlock.measureText(); else break; return l } for (var f, e, h, l, g, m, n = 1, A = 0; A < 2 * n; A++) {
                for (var r = J.length - 1; 0 <= r && !(0 <= p(r) && p(r), h = J[r], l = h.textBlock, m = (g = q(r) < W.length ? J[q(r)] : null) ?
                  g.textBlock : null, f = +h.height.toFixed(6), e = +l.y.toFixed(6), !h.isDirty && (g && e + f + ja > +m.y.toFixed(6)) && (f = l.y + f + ja - m.y, e = a(r, -f), e < f && (0 < e && (f -= e), e = a(q(r), f), e != f))); r--); b()
              }
            } function k(a, b) { return (b < W.length ? J[b].textBlock.y : w.reversed ? Y + C : Z + C) - (0 > a ? w.reversed ? Z - C : Y - C : J[a].textBlock.y + J[a].height + ja) } function t(a, b, c) {
              var f, e, l, g = [], d = C, p = []; -1 !== b && (0 <= ga.indexOf(b) ? (e = ga.indexOf(b), ga.splice(e, 1)) : (ga.push(b), ga = ga.sort(function (a, b) { return a - b }))); if (0 === ga.length) g = oa; else {
                e = C * (1 != ga.length || 0 !=
                  ga[0] && ga[0] != W.length - 1 ? 2 : 1) / m(); for (var q = 0; q < W.length; q++) { if (1 == ga.length && 0 == ga[0]) { if (0 === q) { g.push(oa[q]); f = d; continue } } else 0 === q && (f = -1 * d); g.push(oa[q] + f); if (0 <= ga.indexOf(q) || q < W.length && 0 <= ga.indexOf(q + 1)) f += e }
              } l = function () { for (var a = [], b = 0; b < W.length; b++)a.push(g[b] - W[b].y1); return a }(); var k = {
                startTime: (new Date).getTime(), duration: c || 500, easingFunction: function (a, b, c, f) { return x.easing.easeOutQuart(a, b, c, f) }, changeSection: function (a) {
                  for (var b, c, f = 0; f < W.length; f++)b = l[f], c = W[f], b *= a,
                ...
                for (e = 0; e < W.length; e++)v(f, W[e], w.fillOpacity); s(f); S && ("inside" !== w.indexLabelPlacement ? n(f) : h(), r(f)); 1 <= c && (ma = !1)
              ...
              for (var b, c, f, e, h = 0; h < W.length; h++)e = 1 === J[h].lineThickness % 2 ? 0.5 : 0, c = ((W[h].y2 + W[h].y4) / 2 << 0) + e, b = l(c).x2 - 1, f = J[h].textBlock.x, e = (J[h].textBlock.y + J[h].height / 2 << 0) + e, J[h].isDirty || 0 == J[h].lineThickness || (a.strokeStyle = J[h].lineColor, a.lineWidth =
              ...
              for (var b, c = 0; c < B.length; c++)if (W[c].y1 < a && W[c].y4 > a) { b = W[c]; break } return b ? (a = b.y6 ? a > b.y6 ? b.x3 + (b.x4 - b.x3) / (b.y4 - b.y3) * (a - b.y3) : b.x2 + (b.x3 - b.x2) / (b.y3 - b.y2) * (a - b.y2) : b.x2 + (b.x3 - b.x2) / (b.y3 - b.y2) * (a - b.y2),
                { x1: a, x2: a }) : -1
            } function r(a) { for (var b = 0; b < W.length; b++)J[b].isDirty || (a && (J[b].textBlock.ctx = a), J[b].textBlock.render(!0)) } function s(a) {
              y.plotArea.layoutManager.reset(); a.roundRect || Ga(a); y.title && (y.title.dockInsidePlotArea || "center" === y.title.horizontalAlign && "center" === y.title.verticalAlign) && (y.title.ctx = a, y.title.render()); if (y.subtitles) for (var b = 0; b < y.subtitles.length; b++) {
                var c = y.subtitles[b]; if (c.dockInsidePlotArea || "center" === c.horizontalAlign && "center" === c.verticalAlign) y.subtitles.ctx =
                  a, c.render()
              } y.legend && (y.legend.dockInsidePlotArea || "center" === y.legend.horizontalAlign && "center" === y.legend.verticalAlign) && (y.legend.ctx = a, y.legend.setLayout(), y.legend.render()); pa.fNg && pa.fNg(y)
                      ...
                      Z = w.reversed ? L : N; a = []; var F = [], W = [], E = [], aa = L, fa, ea = (ba - Y) / (U - R), ka = -ea, X = "area" === (w.valueRepresents ? w.valueRepresents : "height") ? c() : f(); if (-1 !== X) {
                        ...
                        for (G = 0; G < X.length - 1; G++)aa = w.reversed ? B[B.length - 1 - G].color ? B[B.length - 1 - G].color : w._colorSet[(B.length - 1 - G) % w._colorSet.length] : B[G].color ? B[G].color : w._colorSet[G % w._colorSet.length], G === fa ? W.push({ x1: a[G], y1: E[G], x2: F[G], y2: E[G], x3: ca, y3: ba, x4: F[G + 1], y4: E[G + 1], x5: a[G + 1], y5: E[G + 1], x6: U, y6: ba, id: G, height: E[G + 1] - E[G], color: aa }) : W.push({ x1: a[G], y1: E[G], x2: F[G], y2: E[G], x3: F[G + 1], y3: E[G + 1], x4: a[G + 1], y4: E[G + 1], id: G, height: E[G + 1] - E[G], color: aa }); var ja = 2, J = [], ma = !1, ga = [], oa = [], X = !1; a = a = 0; Da(ga); for (G =
                          0; G < B.length; G++)B[G].exploded && (X = !0, w.reversed ? ga.push(B.length - 1 - G) : ga.push(G)); O.clearRect(z.x1, z.y1, z.width, z.height); O.fillStyle = y.backgroundColor; O.fillRect(z.x1, z.y1, z.width, z.height); if (S && w.visible && (b(), h(), e(), "inside" !== w.indexLabelPlacement)) { d(); for (G = 0; G < B.length; G++)J[G].isDirty || (a = J[G].textBlock.x + J[G].width, a = (M - a) / 2, 0 == G && (D = a), D > a && (D = a)); for (G = 0; G < W.length; G++)W[G].x1 += D, W[G].x2 += D, W[G].x3 += D, W[G].x4 += D, W[G].x5 && (W[G].x5 += D, W[G].x6 += D), J[G].textBlock.x += D } for (G = 0; G < W.length; G++)D =
                            W[G], v(O, D, w.fillOpacity), oa.push(D.y1); s(O); S && w.visible && ("inside" === w.indexLabelPlacement || y.animationEnabled || n(O), y.animationEnabled || r()); if (!S) for (G = 0; G < B.length; G++)D = w.dataPointIds[G], a = { id: D, objectType: "dataPoint", dataPointIndex: G, dataSeriesIndex: 0, funnelSection: W[w.reversed ? B.length - 1 - G : G] }, y._eventManager.objectMap[D] = a; !y.animationEnabled && X ? t(y, -1, 0) : y.animationEnabled && !y.animatedRender && t(y, -1, 0); this.funnelPyramidClickHandler = function (a) {
                              var b = -1; if (!ma && !y.isAnimating && (g(a.dataSeries.explodeOnClick) ||
                                a.dataSeries.explodeOnClick) && (b = w.reversed ? B.length - 1 - a.dataPointIndex : a.dataPointIndex, 0 <= b)) { a = b; if ("funnel" === w.type || "pyramid" === w.type) w.reversed ? B[B.length - 1 - a].exploded = B[B.length - 1 - a].exploded ? !1 : !0 : B[a].exploded = B[a].exploded ? !1 : !0; t(y, b, 500) }
                            }; return { source: O, dest: this.plotArea.ctx, animationCallback: function (a, b) { x.fadeInAnimation(a, b); 1 <= a && (t(y, -1, 500), s(y.plotArea.ctx || y.ctx)) }, easingFunction: x.easing.easeInQuad, animationBase: 0 }
                      }
              }
            }
            ...
            function (a, f, c, b, e) {
              var h = this; e = "undefined" === typeof e ? 0 : e; if ((0 <= c.type.indexOf("stacked") || "pie" === c.type || "doughnut" === c.type || "funnel" === c.type || "pyramid" === c.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
                var g = "#percent", d = "#total", k = this.getPercentAndTotal(c, f), d = isNaN(k.total) ? d : k.total, g = isNaN(k.percent) ? g : k.percent; do {
                  k = ""; if (c.percentFormatString) k = c.percentFormatString; else {
                    var k = "#,##0.", m = Math.max(Math.ceil(Math.log(1 / Math.abs(g)) / Math.LN10), 2); if (isNaN(m) || !isFinite(m)) m =
                      2; for (var n = 0; n < m; n++)k += "#"; c.percentFormatString = k
                  } a = a.replace("#percent", aa(g, k, h._cultureInfo)); a = a.replace("#total", aa(d, c.yValueFormatString ? c.yValueFormatString : "#,##0.########", h._cultureInfo))
                } while (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))
              } return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function (a) {
                if ('"' === a[0] && '"' === a[a.length - 1] || "'" === a[0] && "'" === a[a.length - 1]) return a.slice(1, a.length - 1); a = Oa(a.slice(1, a.length - 1)); a = a.replace("#index", e); var g = null; try {
                  var l = a.match(/(.*?)\s*\[\s*(.*?)\s*\]/);
                  l && 0 < l.length && (g = Oa(l[2]), a = Oa(l[1]))
                } catch (d) { } l = null; if ("color" === a) return "waterfall" === c.type ? f.color ? f.color : 0 < f.y ? c.risingColor : c.fallingColor : "error" === c.type ? c.color ? c.color : c._colorSet[g % c._colorSet.length] : f.color ? f.color : c.color ? c.color : c._colorSet[b % c._colorSet.length]; if (f.hasOwnProperty(a)) l = f; else if (c.hasOwnProperty(a)) l = c; else return ""; l = l[a]; null !== g && (l = l[g]); if ("x" === a) if (c.axisX && "dateTime" === c.axisX.valueType || "dateTime" === c.xValueType || f.x && f.x.getTime) {
                  if (!c.axisX.logarithmic) return oa(l,
                ...
                } else return aa(l, f.xValueFormatString ? f.xValueFormatString : c.xValueFormatString ? c.xValueFormatString : c.xValueFormatString = "#,##0.########", h._cultureInfo); else return "y" === a ? aa(l, f.yValueFormatString ? f.yValueFormatString : c.yValueFormatString ? c.yValueFormatString : c.yValueFormatString = "#,##0.########",
                  h._cultureInfo) : "z" === a ? aa(l, f.zValueFormatString ? f.zValueFormatString : c.zValueFormatString ? c.zValueFormatString : c.zValueFormatString = "#,##0.########", h._cultureInfo) : l
              })
            }; ka(L, Y); L.prototype.setLayout = function () {
              var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, f = a.layoutManager.getFreeSpace(), c = null, b = 0, e = 0, h = 0, d = 0, k = this.markerMargin = this.chart.options.legend && !g(this.chart.options.legend.markerMargin) ? this.chart.options.legend.markerMargin : 0.3 * this.fontSize; this.height = 0; var v = [], m =
                []; if ("top" === this.verticalAlign || "bottom" === this.verticalAlign) this.orientation = "horizontal", c = this.verticalAlign, h = this.maxWidth = null !== this.maxWidth ? this.maxWidth : f.width, d = this.maxHeight = null !== this.maxHeight ? this.maxHeight : 0.5 * f.height; else if ("center" === this.verticalAlign) {
                  ...
                  var p = this.dataSeries[n]; if (p.dataPoints && p.dataPoints.length) if ("pie" !== p.type && "doughnut" !== p.type && "funnel" !== p.type && "pyramid" !== p.type) {
                    ...
                    0; u < p.dataPoints.length; u++) {
                      var s = p.dataPoints[u], q = s.legendMarkerType ? s.legendMarkerType : p.legendMarkerType ? p.legendMarkerType : M.getDefaultLegendMarker(p.type), l = s.legendText ? s.legendText : p.legendText ? p.legendText : this.itemTextFormatter ? this.itemTextFormatter({ chart: this.chart, legend: this.options, dataSeries: p, dataPoint: s }) : s.name ? s.name : "DataPoint: " + (u + 1), r = s.legendMarkerColor ? s.legendMarkerColor : p.legendMarkerColor ? p.legendMarkerColor : s.color ? s.color : p.color ? p.color : p._colorSet[u % p._colorSet.length],
                      x = 0.75 * this.lineHeight, t = s.legendMarkerBorderColor ? s.legendMarkerBorderColor : p.legendMarkerBorderColor ? p.legendMarkerBorderColor : s.markerBorderColor ? s.markerBorderColor : p.markerBorderColor, w = s.legendMarkerBorderThickness ? s.legendMarkerBorderThickness : p.legendMarkerBorderThickness ? p.legendMarkerBorderThickness : s.markerBorderThickness || p.markerBorderThickness ? Math.max(1, Math.round(0.2 * x)) : 0, l = this.chart.replaceKeywordsWithValue(l, s, p, u), q = {
                        markerType: q, markerColor: r, text: l, textBlock: null, chartType: p.type,
                        markerSize: x, dataSeriesIndex: n, dataPointIndex: u, markerBorderColor: t, markerBorderThickness: w
                      }; (s.showInLegend || p.showInLegend && !1 !== s.showInLegend) && v.push(q)
                  }
                } !0 === this.reversed && v.reverse(); if (0 < v.length) {
                  p = null; r = l = s = u = 0; s = null !== this.itemWidth ? null !== this.itemMaxWidth ? Math.min(this.itemWidth, this.itemMaxWidth, h) : this.itemMaxWidth = Math.min(this.itemWidth, h) : null !== this.itemMaxWidth ? Math.min(this.itemMaxWidth, h) : this.itemMaxWidth = h; x = 0 === x ? 0.75 * this.lineHeight : x; s -= x + k; for (n = 0; n < v.length; n++) {
                    q =
                    v[n]; t = s; if ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType) t -= 2 * 0.1 * this.lineHeight; if (!(0 >= d || "undefined" === typeof d || 0 >= t || "undefined" === typeof t)) {
                      if ("horizontal" === this.orientation) {
                        q.textBlock = new na(this.ctx, { x: 0, y: 0, maxWidth: t, maxHeight: this.itemWrap ? d : this.lineHeight, angle: 0, text: q.text, horizontalAlign: "left", fontSize: this.fontSize, fontFamily: this.fontFamily, fontWeight: this.fontWeight, fontColor: this.fontColor, fontStyle: this.fontStyle, textBaseline: "middle" }); q.textBlock.measureText();
                        null !== this.itemWidth && (q.textBlock.width = this.itemWidth - (x + k + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0))); if (!p || p.width + Math.round(q.textBlock.width + x + k + (0 === p.width ? 0 : this.horizontalSpacing) + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0)) > h) p = { items: [], width: 0 }, m.push(p), this.height += l, l = 0; l = Math.max(l, q.textBlock.height)
                      } else q.textBlock = new na(this.ctx, {
                        x: 0, y: 0, maxWidth: s, maxHeight: !0 === this.itemWrap ?
                          d : 1.5 * this.fontSize, angle: 0, text: q.text, horizontalAlign: "left", fontSize: this.fontSize, fontFamily: this.fontFamily, fontWeight: this.fontWeight, fontColor: this.fontColor, fontStyle: this.fontStyle, textBaseline: "middle"
                      }), q.textBlock.measureText(), null !== this.itemWidth && (q.textBlock.width = this.itemWidth - (x + k + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0))), this.height < d - this.lineHeight ? (p = { items: [], width: 0 }, m.push(p)) : (p = m[u], u = (u + 1) % m.length), this.height +=
                        q.textBlock.height; q.textBlock.x = p.width; q.textBlock.y = 0; p.width += Math.round(q.textBlock.width + x + k + (0 === p.width ? 0 : this.horizontalSpacing) + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0)); p.items.push(q); this.width = Math.max(p.width, this.width); r = q.textBlock.width + (x + k + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0))
                    }
                  } this.itemWidth = r; this.height = !1 === this.itemWrap ? m.length * this.lineHeight : this.height +
                    l; this.height = Math.min(d, this.height); this.width = Math.min(h, this.width)
              ...
              function () {
                  ...
                  for (var m = d[k], n = 0, p = 0; p < m.items.length; p++) {
                    var q = m.items[p], l = q.textBlock.x + a + (0 === p ? 0.2 * h : this.horizontalSpacing), r = f + g, v = l; this.chart.data[q.dataSeriesIndex].visible ||
                      (this.ctx.globalAlpha = 0.5); this.ctx.save(); this.ctx.beginPath(); this.ctx.rect(a, f, b, Math.max(e - e % this.lineHeight, 0)); this.ctx.clip(); if ("line" === q.chartType || "stepLine" === q.chartType || "spline" === q.chartType) this.ctx.strokeStyle = q.lineColor, this.ctx.lineWidth = Math.ceil(this.lineHeight / 8), this.ctx.beginPath(), this.ctx.moveTo(l - 0.1 * this.lineHeight, r + this.lineHeight / 2), this.ctx.lineTo(l + 0.85 * this.lineHeight, r + this.lineHeight / 2), this.ctx.stroke(), v -= 0.1 * this.lineHeight; if ("error" === q.chartType) {
                        ...
                        this.errorMarkerColor[0]; this.ctx.lineWidth = h / 8; this.ctx.beginPath(); var x = l - 0.08 * this.lineHeight + 0.1 * this.lineHeight, w = r + 0.15 * this.lineHeight, u = 0.7 * this.lineHeight, s = u + 0.02 * this.lineHeight; this.ctx.moveTo(x, w); this.ctx.lineTo(x + u, w); this.ctx.stroke(); this.ctx.beginPath(); this.ctx.moveTo(x + u / 2, w); this.ctx.lineTo(x + u / 2, w + s); this.ctx.stroke(); this.ctx.beginPath(); this.ctx.moveTo(x, w + s); this.ctx.lineTo(x + u, w + s); this.ctx.stroke(); this.errorMarkerColor.shift()
                      } t.drawMarker(l + h / 2, r + this.lineHeight / 2, this.ctx,
                ...
                Y); M.prototype.getDefaultAxisPlacement = function () {
                  ...
                  if (!this.dataPoints || 0 === this.dataPoints.length) return null; var c = {
                    ...
                    index: NaN
                  }, b = null, e = 0, h = 0, d = 1, g = Infinity, k = 0, m = 0, n = 0; "none" !== this.chart.plotInfo.axisPlacement && (this.axisX.logarithmic ? (n = Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x), n = 1 < n ? Math.min(Math.max((this.dataPoints.length - 1) / n * Math.log(a / this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0) : (n = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x, n = 0 < n ? Math.min(Math.max((this.dataPoints.length - 1) / n * (a - this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0)); for (; ;) {
                    h =
                    0 < d ? n + e : n - e; if (0 <= h && h < this.dataPoints.length) { var b = this.dataPoints[h], p = this.axisX.logarithmic ? b.x > a ? b.x / a : a / b.x : Math.abs(b.x - a); p < c.distance && (c.dataPoint = b, c.distance = p, c.index = h); b = p; b <= g ? g = b : 0 < d ? k++ : m++; if (1E3 < k && 1E3 < m) break } else if (0 > n - e && n + e >= this.dataPoints.length) break; -1 === d ? (e++, d = 1) : d = -1
                  ...
                  if (!this.dataPoints || 0 ===
                    this.dataPoints.length || a < this.chart.plotArea.x1 || a > this.chart.plotArea.x2 || f < this.chart.plotArea.y1 || f > this.chart.plotArea.y2) return null; c = c || !1; var b = [], e = 0, h = 0, d = 1, g = !1, k = Infinity, m = 0, n = 0, p = 0; if ("none" !== this.chart.plotInfo.axisPlacement) if (p = (this.chart.axisX[0] ? this.chart.axisX[0] : this.chart.axisX2[0]).getXValueAt({ x: a, y: f }), this.axisX.logarithmic) var q = Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x), p = 1 < q ? Math.min(Math.max((this.dataPoints.length - 1) / q * Math.log(p /
                      this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0; else q = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x, p = 0 < q ? Math.min(Math.max((this.dataPoints.length - 1) / q * (p - this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0; for (; ;) {
                        h = 0 < d ? p + e : p - e; if (0 <= h && h < this.dataPoints.length) {
                          var q = this.chart._eventManager.objectMap[this.dataPointIds[h]], l = this.dataPoints[h], r = null; if (q) {
                            ...
                            }if (g || 1E3 < m && 1E3 < n) break
                          }
                        } else if (0 > p - e && p + e >= this.dataPoints.length) break; -1 === d ? (e++, d = 1) : d = -1
                  ...
                  var a, f, c = 0, b = 0, e, h = 0, d = 0, b = 0, b = this.interval, k = 0, v, m = 0.6 * this.chart.height, n; a = !1; var p = this.scaleBreaks ? this.scaleBreaks._appliedBreaks : [], q = p.length ? g(this.scaleBreaks.firstBreakIndex) ?
                    0 : this.scaleBreaks.firstBreakIndex : 0; if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
                      e = this.viewportMaximum; if (this.labels) { a = Math.ceil(b); for (var b = Math.ceil(this.intervalStartPosition), l = !1, c = b; c < this.viewportMaximum; c += a)if (this.labels[c]) l = !0; else { l = !1; break } l && (this.interval = a, this.intervalStartPosition = b) } if (this.logarithmic && !this.equidistantInterval) for (this.logLabelValues || (this.logLabelValues = [], this.createExtraLabelsForLog()), b = 0, l = q; b < this.logLabelValues.length; b++)if (c =
                      ...
                      } l = q; for (c = this.intervalStartPosition; c <= e; c = parseFloat(1E-12 > this.interval ? this.logarithmic && this.equidistantInterval ? c * Math.pow(this.logarithmBase,
                      ...
                      this.getLabelStartPoint(new Date(this.viewportMinimum), this.intervalType, this.interval), e = bb(new Date(this.viewportMaximum), this.interval, this.intervalType), l = q, c = this.intervalStartPosition; c < e; bb(c, b, this.intervalType)) {
                        for (a = c.getTime(); l < p.length && a > p[l].endValue; l++); n = a; a = l < p.length && a >= p[l].startValue && a <= p[l].endValue; a || (a = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.options, value: new Date(n), label: this.labels[n] ? this.labels[n] : null }) : "axisX" === this.type && this.labels[n] ?
                    ...
                    Math.log(this.range) / Math.log(this.logarithmBase) : Math.abs(this.range)) * ba[this.intervalType + "Duration"] * this.interval, h = "undefined" === typeof this.options.labelMaxWidth ? 0.5 * this.chart.width >> 0 : this.options.labelMaxWidth, this.chart.panEnabled || (d = "undefined" === typeof this.options.labelWrap || this.labelWrap ? 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize); else if ("left" === this._position || "right" === this._position) k = this.logarithmic && !this.equidistantInterval && 2 <= this._labels.length ? this.lineCoordinates.height *
                      Math.log(Math.min(this._labels[this._labels.length - 1].position / this._labels[this._labels.length - 2].position, this._labels[1].position / this._labels[0].position)) / Math.log(this.range) : this.lineCoordinates.height / (this.logarithmic && this.equidistantInterval ? Math.log(this.range) / Math.log(this.logarithmBase) : Math.abs(this.range)) * ba[this.intervalType + "Duration"] * this.interval, this.chart.panEnabled || (h = "undefined" === typeof this.options.labelMaxWidth ? 0.3 * this.chart.width >> 0 : this.options.labelMaxWidth), d = "undefined" ===
                        typeof this.options.labelWrap || this.labelWrap ? 0.3 * this.chart.height >> 0 : 1.5 * this.labelFontSize; for (b = 0; b < this._labels.length; b++) { a = this._labels[b].textBlock; a.maxWidth = h; a.maxHeight = d; var r = a.measureText(); v = r.height } e = []; q = p = 0; if (this.labelAutoFit || this.options.labelAutoFit) if (g(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360, 90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)), "bottom" === this._position ||
                          "top" === this._position) if (h = 0.9 * k >> 0, q = 0, !this.chart.panEnabled && 1 <= this._labels.length) {
                            this.sessionVariables.labelFontSize = this.labelFontSize; this.sessionVariables.labelMaxWidth = h; this.sessionVariables.labelMaxHeight = d; this.sessionVariables.labelAngle = this.labelAngle; this.sessionVariables.labelWrap = this.labelWrap; for (c = 0; c < this._labels.length; c++)if (!this._labels[c].breaksLabelType) {
                              a = this._labels[c].textBlock; for (var x, l = a.text.split(" "), b = 0; b < l.length; b++)n = l[b], this.ctx.font = a.fontStyle + " " +
                                a.fontWeight + " " + a.fontSize + "px " + a.fontFamily, n = this.ctx.measureText(n), n.width > q && (x = c, q = n.width)
                            } c = 0; for (c = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; c < this._labels.length; c++)if (!this._labels[c].breaksLabelType) {
                              a = this._labels[c].textBlock; r = a.measureText(); for (l = c + 1; l < this._labels.length; l++)if (!this._labels[l].breaksLabelType) { f = this._labels[l].textBlock; f = f.measureText(); break } e.push(a.height); this.sessionVariables.labelMaxHeight = Math.max.apply(Math, e); Math.cos(Math.PI / 180 * Math.abs(this.labelAngle));
                                          ...
                                          l : this.options.labelFontSize, this.sessionVariables.labelAngle = this.labelAngle) : b >= 3.2 * h && b < 3.6 * h ? (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelMaxWidth = n, this.sessionVariables.labelFontSize = this.labelFontSize) : b > 3.6 * h && b < 5 * h ? (g(this.options.labelFontSize) && 12 < l && (l = Math.floor(12 / 13 * l), a.measureText()), this.sessionVariables.labelFontSize = g(this.options.labelFontSize) ? l : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelAngle =
                                            -25, this.sessionVariables.labelMaxWidth = n) : b > 5 * h && (this.sessionVariables.labelWrap = !0, this.sessionVariables.labelMaxWidth = h, this.sessionVariables.labelFontSize = l, this.sessionVariables.labelMaxHeight = d, this.sessionVariables.labelAngle = this.labelAngle)); else if (x === c && (0 === x && q + this._labels[x + 1].textBlock.measureText().width - 2 * h > p || x === this._labels.length - 1 && q + this._labels[x - 1].textBlock.measureText().width - 2 * h > p || 0 < x && x < this._labels.length - 1 && q + this._labels[x + 1].textBlock.measureText().width - 2 * h > p &&
                                              q + this._labels[x - 1].textBlock.measureText().width - 2 * h > p)) p = 0 === x ? q + this._labels[x + 1].textBlock.measureText().width - 2 * h : q + this._labels[x - 1].textBlock.measureText().width - 2 * h, this.sessionVariables.labelFontSize = g(this.options.labelFontSize) ? l : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = n; else if (0 === p) for (this.sessionVariables.labelFontSize = g(this.options.labelFontSize) ? l : this.options.labelFontSize, this.sessionVariables.labelWrap =
                                                !0, b = 0; b < this._labels.length; b++)a = this._labels[b].textBlock, a.maxWidth = this.sessionVariables.labelMaxWidth = Math.min(Math.max(h, q), n), r = a.measureText(), b < this._labels.length - 1 && (l = b + 1, f = this._labels[l].textBlock, f.maxWidth = this.sessionVariables.labelMaxWidth = Math.min(Math.max(h, q), n), f = f.measureText(), r.width + f.width >> 0 > 2 * h && (this.sessionVariables.labelAngle = -25))
                              ...
                              this.labelFontSize : this.sessionVariables.labelFontSize : this.options.labelFontSize, a.angle = this.labelAngle = g(this.options.labelAngle) ? g(this.sessionVariables.labelAngle) ? this.sessionVariables.labelAngle = this.labelAngle : this.sessionVariables.labelAngle : this.labelAngle, a.wrap = this.labelWrap = g(this.options.labelWrap) ? g(this.sessionVariables.labelWrap) ? this.sessionVariables.labelWrap = this.labelWrap : this.sessionVariables.labelWrap : this.options.labelWrap, a.maxHeight = g(this.sessionVariables.labelMaxHeight) ?
                                this.sessionVariables.labelMaxHeight = d : this.sessionVariables.labelMaxHeight, a.measureText(); for (c = 0; c < this.stripLines.length; c++) {
                                  var h = this.stripLines[c], t; if ("outside" === h.labelPlacement) {
                                    ...
                                    if ("left" === this._position || "right" === this._position) g(h.options.labelWrap) && !g(this.sessionVariables.stripLineLabelMaxHeight) ? t = this.sessionVariables.stripLineLabelMaxHeight : this.sessionVariables.stripLineLabelMaxHeight = t = h.labelWrap ? 0.8 * this.chart.width >> 0 : 1.5 * this.labelFontSize; g(h.labelBackgroundColor) && (h.labelBackgroundColor = "#EEEEEE")
                                  } else d = "bottom" === this._position || "top" === this._position ? 0.9 * this.chart.width >> 0 : 0.9 * this.chart.height >> 0, t = g(h.options.labelWrap) || h.labelWrap ? "bottom" === this._position ||
                                    "top" === this._position ? 0.8 * this.chart.width >> 0 : 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize, g(h.labelBackgroundColor) && (g(h.startValue) && 0 !== h.startValue ? h.labelBackgroundColor = u ? "transparent" : null : h.labelBackgroundColor = "#EEEEEE"); a = new na(this.ctx, {
                                      x: 0, y: 0, backgroundColor: h.labelBackgroundColor, borderColor: h.labelBorderColor, borderThickness: h.labelBorderThickness, cornerRadius: h.labelCornerRadius, maxWidth: h.options.labelMaxWidth ? h.options.labelMaxWidth : d, maxHeight: t, angle: this.labelAngle, text: h.labelFormatter ?
                  ...
                  var d, k, v, m, n = a[0] ? a[0].chart : f[0].chart, p = n.isNavigator ? 0 : 10, q = n._axes; if (a && 0 < a.length) for (var l = 0; l < a.length; l++)a[l] && a[l].calculateAxisParameters(); if (f && 0 < f.length) for (l = 0; l < f.length; l++)f[l].calculateAxisParameters(); if (c && 0 < c.length) for (l = 0; l < c.length; l++)c[l].calculateAxisParameters(); if (b && 0 < b.length) for (l = 0; l < b.length; l++)b[l].calculateAxisParameters(); for (l = 0; l < q.length; l++)if (q[l] && q[l].scaleBreaks &&
                    q[l].scaleBreaks._appliedBreaks.length) for (var r = q[l].scaleBreaks._appliedBreaks, x = 0; x < r.length && !(r[x].startValue > q[l].viewportMaximum); x++)r[x].endValue < q[l].viewportMinimum || (g(q[l].scaleBreaks.firstBreakIndex) && (q[l].scaleBreaks.firstBreakIndex = x), r[x].startValue >= q[l].viewPortMinimum && (q[l].scaleBreaks.lastBreakIndex = x)); for (var t = x = 0, w = 0, u = 0, s = 0, y = 0, z = 0, D, F, E = k = 0, H, L, M, r = H = L = M = !1, l = 0; l < q.length; l++)q[l] && q[l].title && (q[l]._titleTextBlock = new na(q[l].ctx, {
                      ...
                      case "left": q[l]._titleTextBlock.maxWidth = q[l].titleMaxWidth || h.height; q[l]._titleTextBlock.maxHeight = q[l].titleWrap ?
                        0.8 * h.width : 1.5 * q[l].titleFontSize; q[l]._titleTextBlock.angle = -90; break; case "right": q[l]._titleTextBlock.maxWidth = q[l].titleMaxWidth || h.height; q[l]._titleTextBlock.maxHeight = q[l].titleWrap ? 0.8 * h.width : 1.5 * q[l].titleFontSize; q[l]._titleTextBlock.angle = 90; break; default: q[l]._titleTextBlock.maxWidth = q[l].titleMaxWidth || h.width, q[l]._titleTextBlock.maxHeight = q[l].titleWrap ? 0.8 * h.height : 1.5 * q[l].titleFontSize, q[l]._titleTextBlock.angle = 0
                    }if ("normal" === e) {
                      for (var u = [], s = [], y = [], z = [], P = [], O = [], N = [], V = []; 4 >
                        x;) {
                                            ...
                                            b[l].lineCoordinates.height ? b[l].titleMaxWidth : b[l].lineCoordinates.height), Y += z[l] + b[l].margin); if (a && 0 < a.length) for (l = 0; l < a.length; l++)a[l] && (a[l].calculateValueToPixelConversionParameters(), a[l].calculateBreaksSizeInValues(), a[l]._labels && 1 < a[l]._labels.length && (D = (a[l].logarithmic ? Math.log(a[l]._labels[1].position / a[l].viewportMinimum) / a[l].conversionParameters.lnLogarithmBase : a[l]._labels[1].position - a[l].viewportMinimum) * Math.abs(a[l].conversionParameters.pixelPerUnit) + a[l].lineCoordinates.x1,
                                              d = a[l]._labels[a[l]._labels.length - ("dateTime" === a[l].valueType ? 2 : 1)].position, d = a[l].getApparentDifference(a[l].viewportMinimum, d), F = a[l].logarithmic ? (1 < d ? Math.log(d) / a[l].conversionParameters.lnLogarithmBase * Math.abs(a[l].conversionParameters.pixelPerUnit) : 0) + a[l].lineCoordinates.x1 : (0 < d ? d * Math.abs(a[l].conversionParameters.pixelPerUnit) : 0) + a[l].lineCoordinates.x1)); if (f && 0 < f.length) for (l = 0; l < f.length; l++)f[l].calculateValueToPixelConversionParameters(), f[l].calculateBreaksSizeInValues(), f[l]._labels &&
                                                1 < f[l]._labels.length && (D = (f[l].logarithmic ? Math.log(f[l]._labels[1].position / f[l].viewportMinimum) / f[l].conversionParameters.lnLogarithmBase : f[l]._labels[1].position - f[l].viewportMinimum) * Math.abs(f[l].conversionParameters.pixelPerUnit) + f[l].lineCoordinates.x1, d = f[l]._labels[f[l]._labels.length - ("dateTime" === f[l].valueType ? 2 : 1)].position, d = f[l].getApparentDifference(f[l].viewportMinimum, d), F = f[l].logarithmic ? (1 < d ? Math.log(d) / f[l].conversionParameters.lnLogarithmBase * Math.abs(f[l].conversionParameters.pixelPerUnit) :
                                                  0) + f[l].lineCoordinates.x1 : (0 < d ? d * Math.abs(f[l].conversionParameters.pixelPerUnit) : 0) + f[l].lineCoordinates.x1); for (l = 0; l < q.length; l++)"axisY" === q[l].type && (q[l].calculateValueToPixelConversionParameters(), q[l].calculateBreaksSizeInValues()); if (0 < x) {
                                                    if (a && 0 < a.length) for (l = 0; l < a.length; l++)r = P[x - 1][l] === P[x][l] ? !0 : !1; else r = !0; if (f && 0 < f.length) for (l = 0; l < f.length; l++)H = O[x - 1][l] === O[x][l] ? !0 : !1; else H = !0; if (c && 0 < c.length) for (l = 0; l < c.length; l++)L = N[x - 1][l] === N[x][l] ? !0 : !1; else L = !0; if (b && 0 < b.length) for (l =
                                                      0; l < b.length; l++)M = V[x - 1][l] === V[x][l] ? !0 : !1; else M = !0
                                                  } if (r && H && L && M) break; x++
                      } if (a && 0 < a.length) for (l = 0; l < a.length; l++)a[l].calculateStripLinesThicknessInValues(), a[l].calculateBreaksInPixels(); if (f && 0 < f.length) for (l = 0; l < f.length; l++)f[l].calculateStripLinesThicknessInValues(), f[l].calculateBreaksInPixels(); if (c && 0 < c.length) for (l = 0; l < c.length; l++)c[l].calculateStripLinesThicknessInValues(), c[l].calculateBreaksInPixels(); if (b && 0 < b.length) for (l = 0; l < b.length; l++)b[l].calculateStripLinesThicknessInValues(),
                        b[l].calculateBreaksInPixels()
                    } else {
                      p = []; D = []; E = []; t = []; F = []; w = []; P = []; for (O = []; 4 > x;) {
                        Z = Y = R = T = ba = U = $ = e = V = N = G = aa = 0; if (a && 0 < a.length) for (E = [], l = Y = 0; l < a.length; l++)E.push(Math.ceil(a[l] ? a[l].createLabelsAndCalculateWidth() : 0)), Y += E[l], e += a[l] && !n.isNavigator ? a[l].margin : 0; else E.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateWidth() : 0)); P.push(E); if (f && 0 < f.length) for (t = [], l = Z = 0; l < f.length; l++)t.push(Math.ceil(f[l] ? f[l].createLabelsAndCalculateWidth() : 0)), Z += t[l], $ += f[l] ? f[l].margin : 0; else t.push(Math.ceil(f[0] ?
                                    ...
                                    0; l < c.length; l++)p[l] = g(n.sessionVariables.axisY.height) ? n.sessionVariables.axisY.height = p[l] : n.sessionVariables.axisY.height; else for (l = 0; l < c.length; l++)n.sessionVariables.axisY.height = p[l]; if (c && 0 < c.length) for (l = c.length - 1; 0 <= l; l--)k = Math.round(h.y2), m = Math.round(h.y2 > c[l].chart.height ? c[l].chart.height : h.y2), c[l].lineCoordinates.y1 = k - (p[l] + c[l].margin + aa), c[l].lineCoordinates.y2 = k - (p[l] + c[l].margin + aa), "inside" === c[l].labelPlacement && 0 < l && (c[l].lineCoordinates.y1 = c[l].lineCoordinates.y1 + p[l] - (c[l]._titleTextBlock ?
                                      c[l]._titleTextBlock.height : 0) - ("inside" === c[l].tickPlacement ? c[l].tickLength : 0), c[l].lineCoordinates.y2 = c[l].lineCoordinates.y1 + c[l].lineThickness / 2), c[l].bounds = { x1: d, y1: k - (p[l] + aa + c[l].margin), x2: v, y2: m - (aa + c[l].margin), width: v - d, height: p[l] }, c[l].title && (c[l]._titleTextBlock.maxWidth = 0 < c[l].titleMaxWidth && c[l].titleMaxWidth < c[l].lineCoordinates.width ? c[l].titleMaxWidth : c[l].lineCoordinates.width), aa += p[l] + c[l].margin; if (b && 0 < b.length) for (l = b.length - 1; 0 <= l; l--)b[l] && (k = Math.round(h.y1), m = Math.round(h.y1 +
                                        (D[l] + b[l].margin + G)), b[l].lineCoordinates.y1 = m, b[l].lineCoordinates.y2 = m, "inside" === b[l].labelPlacement && 0 < l && (b[l].lineCoordinates.y1 = m - D[l] + (b[l]._titleTextBlock ? b[l]._titleTextBlock.height : 0)), b[l].bounds = { x1: d, y1: k + (b[l].margin + G), x2: v, y2: m, width: v - d, height: R }, b[l].title && (b[l]._titleTextBlock.maxWidth = 0 < b[l].titleMaxWidth && b[l].titleMaxWidth < b[l].lineCoordinates.width ? b[l].titleMaxWidth : b[l].lineCoordinates.width), G += D[l] + b[l].margin); if (a && 0 < a.length) for (l = 0; l < a.length; l++) {
                                          ...
                                          U = f[l]._labels && 0 < f[l]._labels.length ? f[l]._labels[0].textBlock.fontSize / 2 : 0; d = Math.round(h.x1 - e); k = b && 0 < b.length ?
                                            Math.round(b[0] ? b[0].lineCoordinates.y2 : h.y1 < Math.max(U, 10) ? Math.max(U, 10) : h.y1) : h.y1 < Math.max(U, 10) ? Math.max(U, 10) : h.y1; v = Math.round(h.x2 - Z - $); m = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : h.y2 - T > n.height - Math.max(U, 10) ? n.height - Math.max(U, 10) : h.y2 - T) : h.y2 > n.height - Math.max(U, 10) ? n.height - Math.max(U, 10) : h.y2; if (c && 0 < c.length) for (U = 0; U < c.length; U++)c[U] && c[U].labelAutoFit && (v = 0 > c[U].labelAngle ? Math.max(v, u) : 0 === c[U].labelAngle ? Math.max(v, u / 2) : v, d = 0 > c[U].labelAngle || 0 === c[U].labelAngle ? v -
                                              Z : d); if (b && 0 < b.length) for (U = 0; U < b.length; U++)b[U] && b[U].labelAutoFit && (v = b[U].lineCoordinates.x2, d = v - Z); f[l].lineCoordinates = { x1: v + V, y1: k, x2: v + V, y2: m, height: Math.abs(m - k) }; "inside" === f[l].labelPlacement && 0 < l && (f[l].lineCoordinates.x1 = f[l].lineCoordinates.x1 + (t[l] - (f[l]._titleTextBlock ? f[l]._titleTextBlock.height : 0) - 2) - ("outside" === f[l].tickPlacement ? f[l].tickLength : 0), f[l].lineCoordinates.x2 = f[l].lineCoordinates.x1 + f[l].lineThickness / 2); f[l].bounds = {
                                                x1: f[l].lineCoordinates.x1, y1: k, x2: v + t[l] + V, y2: m,
                                                width: v - d, height: m - k
                                              }; f[l].title && (f[l]._titleTextBlock.maxWidth = 0 < f[l].titleMaxWidth && f[l].titleMaxWidth < f[l].lineCoordinates.height ? f[l].titleMaxWidth : f[l].lineCoordinates.height); f[l].calculateValueToPixelConversionParameters(); f[l].calculateBreaksSizeInValues(); V += t[l] + f[l].margin
                                        } for (l = 0; l < q.length; l++)"axisY" === q[l].type && (q[l].calculateValueToPixelConversionParameters(), q[l].calculateBreaksSizeInValues()); if (0 < x) {
                                          if (a && 0 < a.length) for (l = 0; l < a.length; l++)r = P[x - 1][l] === P[x][l] ? !0 : !1; else r = !0;
                                          if (f && 0 < f.length) for (l = 0; l < f.length; l++)H = O[x - 1][l] === O[x][l] ? !0 : !1; else H = !0; if (c && 0 < c.length) for (l = 0; l < c.length; l++)L = F[x - 1][l] === F[x][l] ? !0 : !1; else L = !0; if (b && 0 < b.length) for (l = 0; l < b.length; l++)M = w[x - 1][l] === w[x][l] ? !0 : !1; else M = !0
                                        } if (r && H && L && M) break; x++
                      } if (c && 0 < c.length) for (l = 0; l < c.length; l++)c[l].calculateStripLinesThicknessInValues(), c[l].calculateBreaksInPixels(); if (b && 0 < b.length) for (l = 0; l < b.length; l++)b[l].calculateStripLinesThicknessInValues(), b[l].calculateBreaksInPixels(); if (a && 0 < a.length) for (l =
                        0; l < a.length; l++)a[l].calculateStripLinesThicknessInValues(), a[l].calculateBreaksInPixels(); if (f && 0 < f.length) for (l = 0; l < f.length; l++)f[l].calculateStripLinesThicknessInValues(), f[l].calculateBreaksInPixels()
                  }
          ...
          function () {
            ...
            var a = this, f = !1, c = 0, b = 0, e = 1, d = 0; 0 !== this.labelAngle && 360 !== this.labelAngle && (e = 1.2); if ("undefined" === typeof this.options.interval) {
              if ("bottom" === this._position || "top" === this._position) if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                ...
                for (var c = [], n, k = this.viewportMaximum, v = this.lineCoordinates.height / Math.log(this.range), m = this._labels.length - 1; 0 <= m; m--) {
                  p = this._labels[m]; if (p.position < this.viewportMinimum) break;
                  p.position > this.viewportMaximum || !(m === this._labels.length - 1 || n < Math.log(k / p.position) * v) || (c.push(p), k = p.position, n = p.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + p.textBlock.width * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)))
                } this._labels = c
              } else {
            ...
            } this.logarithmic && (!this.equidistantInterval && this.labelAutoFit) && this._labels.sort(function (a, b) { return a.position - b.position }); var m = 0, p, q; if ("bottom" === this._position) {
              for (m = 0; m < this._labels.length; m++)p = this._labels[m], p.position < this.viewportMinimum || p.position > this.viewportMaximum || (q = this.getPixelCoordinatesOnAxis(p.position), this.tickThickness && "inside" != this.tickPlacement && (this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle = this.tickColor, b = 1 === this.ctx.lineWidth %
              ...
              for (m = 0; m < this._labels.length; m++)p = this._labels[m], p.position < this.viewportMinimum || p.position > this.viewportMaximum || (q = this.getPixelCoordinatesOnAxis(p.position),
            ...
            if (this.stripLines && 0 < this.stripLines.length && a) {
              for (var f = this, c, b = 0, e = 0, d = !1, k = !1, v = [], x = [], k = !1, b = 0; b < this.stripLines.length; b++) {
                var m = this.stripLines[b]; m._thicknessType === a && ("pixel" === a && (m.value < this.viewportMinimum || m.value > this.viewportMaximum || g(m.value) || isNaN(this.range)) || "value" === a && (m.startValue <= this.viewportMinimum && m.endValue <= this.viewportMinimum ||
                  m.startValue >= this.viewportMaximum && m.endValue >= this.viewportMaximum || g(m.startValue) || g(m.endValue) || isNaN(this.range)) || v.push(m))
                ...
                k = !1; this.ctx.save(); this.ctx.beginPath(); this.ctx.rect(this.chart.plotArea.x1, this.chart.plotArea.y1, this.chart.plotArea.width, this.chart.plotArea.height); this.ctx.clip(); for (b = 0; b < v.length; b++)m = v[b], m.showOnTop ? d || (d = !0, this.chart.addEventListener("dataAnimationIterationEnd", function () {
                  this.ctx.save(); this.ctx.beginPath(); this.ctx.rect(this.chart.plotArea.x1, this.chart.plotArea.y1, this.chart.plotArea.width, this.chart.plotArea.height); this.ctx.clip(); for (e =
                    0; e < v.length; e++)m = v[e], m.showOnTop && m.render(); this.ctx.restore()
                }, m)) : m.render(); for (b = 0; b < x.length; b++)c = x[b], c.stripLine.showOnTop ? k || (k = !0, this.chart.addEventListener("dataAnimationIterationEnd", function () { for (e = 0; e < x.length; e++)c = x[e], "inside" === c.stripLine.labelPlacement && c.stripLine.showOnTop && (f.ctx.save(), f.ctx.beginPath(), f.ctx.rect(f.chart.plotArea.x1, f.chart.plotArea.y1, f.chart.plotArea.width, f.chart.plotArea.height), f.ctx.clip(), c.textBlock.render(!0), f.ctx.restore()) }, c.textBlock)) :
                  "inside" === c.stripLine.labelPlacement && c.textBlock.render(!0); this.ctx.restore(); k = !0
              } if (k) for (k = !1, b = 0; b < x.length; b++)c = x[b], "outside" === c.stripLine.labelPlacement && c.textBlock.render(!0)
            }
            ...
            if (this.scaleBreaks && 0 < this.scaleBreaks._appliedBreaks.length) {
              var a = this.scaleBreaks._appliedBreaks; u ? (this.maskCanvas = sa(this.chart.width, this.chart.height), this.maskCtx = this.maskCanvas.getContext("2d")) : (this.maskCanvas = this.chart.plotArea.canvas, this.maskCtx = this.chart.plotArea.ctx);
            ...
            var a = this.chart.ctx, f = u ? this.chart._preRenderCtx : a, c = Math.ceil(this.tickThickness / (this.reversed ?
              -2 : 2)), b = Math.ceil(this.tickThickness / (this.reversed ? 2 : -2)), e, d; f.save(); if ("bottom" === this._position || "top" === this._position) {
                if (this.lineThickness) {
                  this.reversed ? (e = this.lineCoordinates.x2, d = this.lineCoordinates.x1) : (e = this.lineCoordinates.x1, d = this.lineCoordinates.x2); f.lineWidth = this.lineThickness; f.strokeStyle = this.lineColor ? this.lineColor : "black"; f.setLineDash && f.setLineDash(T(this.lineDashType, this.lineThickness)); var k = 1 === this.lineThickness % 2 ? (this.lineCoordinates.y1 << 0) + 0.5 : this.lineCoordinates.y1 <<
                    0; f.beginPath(); if (this.scaleBreaks && !g(this.scaleBreaks.firstBreakIndex)) if (g(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + b; else for (var v = this.scaleBreaks.firstBreakIndex; v <= this.scaleBreaks.lastBreakIndex; v++)f.moveTo(e, k), f.lineTo(this.scaleBreaks._appliedBreaks[v].startPixel + c, k), e = this.scaleBreaks._appliedBreaks[v].endPixel + b; e && (f.moveTo(e, k), f.lineTo(d, k)); f.stroke()
                }
                ...
                this.lineThickness) {
                  this.reversed ? (e = this.lineCoordinates.y1, d = this.lineCoordinates.y2) : (e = this.lineCoordinates.y2, d = this.lineCoordinates.y1); f.lineWidth = this.lineThickness; f.strokeStyle = this.lineColor; f.setLineDash && f.setLineDash(T(this.lineDashType, this.lineThickness)); k = 1 === this.lineThickness % 2 ? (this.lineCoordinates.x1 << 0) + 0.5 : this.lineCoordinates.x1 << 0; f.beginPath(); if (this.scaleBreaks && !g(this.scaleBreaks.firstBreakIndex)) if (g(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel +
                    c; else for (v = this.scaleBreaks.firstBreakIndex; v <= this.scaleBreaks.lastBreakIndex; v++)f.moveTo(k, e), f.lineTo(k, this.scaleBreaks._appliedBreaks[v].startPixel + b), e = this.scaleBreaks._appliedBreaks[v].endPixel + c; e && (f.moveTo(k, e), f.lineTo(k, d)); f.stroke()
            } u && (a.drawImage(this.chart._preRenderCanvas, 0, 0, this.chart.width, this.chart.height), this.chart._breaksCanvasCtx && this.chart._breaksCanvasCtx.drawImage(this.chart._preRenderCanvas, 0, 0, this.chart.width, this.chart.height), f.clearRect(0, 0, this.chart.width,
            ...
            if (this.logarithmic) this.calculateLogarithmicAxisParameters(); else {
              var a = this.chart.layoutManager.getFreeSpace(), f = !1, c = !1; "bottom" === this._position || "top" === this._position ? (this.maxWidth = a.width, this.maxHeight = a.height) : (this.maxWidth = a.height, this.maxHeight = a.width); var a = "axisX" === this.type ? "xySwapped" === this.chart.plotInfo.axisPlacement ? 62 : 70 : "xySwapped" === this.chart.plotInfo.axisPlacement ? 50 : 40, b = 4; "axisX" === this.type &&
                ...
                this.minimum : this.dataInfo.min, d = null !== this.maximum ? this.maximum : this.dataInfo.max, isFinite(e) || isFinite(d) ? 0 === e && 0 === d ? (d += 9, e = 0) : 0 === d - e ? (b = Math.min(Math.abs(0.01 * Math.abs(d)), 5), d += b, e -= b) : e > d ? (b = Math.min(0.01 * Math.abs(this.getApparentDifference(d, e, null, !0)), 5), 0 <= d ? e = d - b : d = isFinite(e) ? e + b : 0) : (b = Math.min(0.01 * Math.abs(this.getApparentDifference(e, d, null, !0)), 0.05), 0 !== d && (d += b), 0 !== e && (e -= b)) : (d = "undefined" === typeof this.options.interval ? -Infinity : this.options.interval, e = "undefined" !== typeof this.options.interval ||
                  isFinite(this.dataInfo.minDiff) ? 0 : Infinity), k = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < d - e ? 0.5 * Math.abs(d - e) : 1, this.includeZero && (null === this.minimum || isNaN(this.minimum)) && 0 < e && (e = 0), this.includeZero && (null === this.maximum || isNaN(this.maximum)) && 0 > d && (d = 0)), Math.abs(this.getApparentDifference(e, d, null, !0)), "axisX" === this.type && c) {
                    this.valueType = "dateTime"; if (null === this.minimum || isNaN(this.minimum)) this.minimum = e - k / 2, this.minimum = Math.min(this.minimum, null === this.sessionVariables.viewportMinimum ||
                      isNaN(this.sessionVariables.viewportMinimum) ? Infinity : this.sessionVariables.viewportMinimum); if (null === this.maximum || isNaN(this.maximum)) this.maximum = d + k / 2, this.maximum = Math.max(this.maximum, null === this.sessionVariables.viewportMaximum || isNaN(this.sessionVariables.viewportMaximum) ? -Infinity : this.sessionVariables.viewportMaximum)
            ...
            if (0 !== this.spacing || 0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
              var f = this.ctx, c = this.ctx.globalAlpha; this.ctx = a || this.ctx; this.ctx.save(); this.ctx.beginPath(); this.ctx.rect(this.chart.plotArea.x1, this.chart.plotArea.y1, this.chart.plotArea.width, this.chart.plotArea.height); this.ctx.clip(); var b = this.scaleBreaks.parent.getPixelCoordinatesOnAxis(this.startValue),
                d = this.scaleBreaks.parent.getPixelCoordinatesOnAxis(this.endValue); this.ctx.strokeStyle = this.lineColor; this.ctx.fillStyle = this.color; this.ctx.beginPath(); this.ctx.globalAlpha = 1; R(this.id); var h, g, k, v, m, n; a = Math.max(this.spacing, 3); var p = Math.max(0, this.lineThickness); this.ctx.lineWidth = p; this.ctx.setLineDash && this.ctx.setLineDash(T(this.lineDashType, p)); if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position) if (b = 1 === p % 2 ? (b.x << 0) + 0.5 : b.x << 0, g = 1 === p % 2 ? (d.x << 0) + 0.5 :
                  d.x << 0, "top" === this.scaleBreaks.parent._position ? (d = this.chart.plotArea.y1, k = this.chart.plotArea.y2 + p / 2 + 0.5 << 0) : (d = this.chart.plotArea.y2, k = this.chart.plotArea.y1 - p / 2 + 0.5 << 0, a *= -1), this.bounds = { x1: b - p / 2, y1: d, x2: g + p / 2, y2: k }, this.ctx.moveTo(b, d), "straight" === this.type || "top" === this.scaleBreaks.parent._position && 0 >= a || "bottom" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(b, k), this.ctx.lineTo(g, k), this.ctx.lineTo(g, d); else if ("wavy" === this.type) {
                    v = b; m = d; h = 0.5; n = (k - m) / a / 3; for (var q = 0; q < n; q++)this.ctx.bezierCurveTo(v +
                      h * a, m + a, v + h * a, m + 2 * a, v, m + 3 * a), m += 3 * a, h *= -1; this.ctx.bezierCurveTo(v + h * a, m + a, v + h * a, m + 2 * a, v, m + 3 * a); v = g; h *= -1; this.ctx.lineTo(v, m); for (q = 0; q < n; q++)this.ctx.bezierCurveTo(v + h * a, m - a, v + h * a, m - 2 * a, v, m - 3 * a), m -= 3 * a, h *= -1
                  } else { if ("zigzag" === this.type) { h = -1; m = d + a; v = b + a; n = (k - m) / a / 2; for (q = 0; q < n; q++)this.ctx.lineTo(v, m), v += 2 * h * a, m += 2 * a, h *= -1; this.ctx.lineTo(v, m); v += g - b; for (q = 0; q < n + 1; q++)this.ctx.lineTo(v, m), v += 2 * h * a, m -= 2 * a, h *= -1; this.ctx.lineTo(v + h * a, m + a) } } else if ("left" === this.scaleBreaks.parent._position || "right" ===
                    this.scaleBreaks.parent._position) if (d = 1 === p % 2 ? (d.y << 0) + 0.5 : d.y << 0, k = 1 === p % 2 ? (b.y << 0) + 0.5 : b.y << 0, "left" === this.scaleBreaks.parent._position ? (b = this.chart.plotArea.x1, g = this.chart.plotArea.x2 + p / 2 + 0.5 << 0) : (b = this.chart.plotArea.x2, g = this.chart.plotArea.x1 - p / 2 + 0.5 << 0, a *= -1), this.bounds = { x1: b, y1: d - p / 2, x2: g, y2: k + p / 2 }, this.ctx.moveTo(b, d), "straight" === this.type || "left" === this.scaleBreaks.parent._position && 0 >= a || "right" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(g, d), this.ctx.lineTo(g, k),
                      this.ctx.lineTo(b, k); else if ("wavy" === this.type) { v = b; m = d; h = 0.5; n = (g - v) / a / 3; for (q = 0; q < n; q++)this.ctx.bezierCurveTo(v + a, m + h * a, v + 2 * a, m + h * a, v + 3 * a, m), v += 3 * a, h *= -1; this.ctx.bezierCurveTo(v + a, m + h * a, v + 2 * a, m + h * a, v + 3 * a, m); m = k; h *= -1; this.ctx.lineTo(v, m); for (q = 0; q < n; q++)this.ctx.bezierCurveTo(v - a, m + h * a, v - 2 * a, m + h * a, v - 3 * a, m), v -= 3 * a, h *= -1 } else if ("zigzag" === this.type) {
                        h = 1; m = d - a; v = b + a; n = (g - v) / a / 2; for (q = 0; q < n; q++)this.ctx.lineTo(v, m), m += 2 * h * a, v += 2 * a, h *= -1; this.ctx.lineTo(v, m); m += k - d; for (q = 0; q < n + 1; q++)this.ctx.lineTo(v,
                          m), m += 2 * h * a, v -= 2 * a, h *= -1; this.ctx.lineTo(v + a, m + h * a)
            ...
            if ("undefined" !== typeof a || this.options._isPlaceholder) {
              var d = 0; this.parent.options._isPlaceholder && this.parent.createUserOptions(); this.options._isPlaceholder || (Da(this.parent.stripLines), d = this.parent.options.stripLines.indexOf(this.options));
            ...
            this.ctx.save(); var a = this.parent.getPixelCoordinatesOnAxis(this.value), d = Math.abs("pixel" === this._thicknessType ? this.thickness : Math.abs(this.parent.convertValueToPixel(this.endValue) - this.parent.convertValueToPixel(this.startValue))); if (0 < d) {
              var c = null === this.opacity ? 1 : this.opacity; this.ctx.strokeStyle = this.color; this.ctx.beginPath(); var b = this.ctx.globalAlpha; this.ctx.globalAlpha =
                c; R(this.id); var e, h, g, k; this.ctx.lineWidth = d; this.ctx.setLineDash && this.ctx.setLineDash(T(this.lineDashType, d)); if ("bottom" === this.parent._position || "top" === this.parent._position) e = h = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, g = this.chart.plotArea.y1, k = this.chart.plotArea.y2, this.bounds = { x1: e - d / 2, y1: g, x2: h + d / 2, y2: k }; else if ("left" === this.parent._position || "right" === this.parent._position) g = k = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0, e = this.chart.plotArea.x1, h = this.chart.plotArea.x2, this.bounds =
                  { x1: e, y1: g - d / 2, x2: h, y2: k + d / 2 }; this.ctx.moveTo(e, g); this.ctx.lineTo(h, k); this.ctx.stroke(); this.ctx.globalAlpha = b
            } this.ctx.restore()
            ...
            var b, e, h, k, v = null, x = null, m = null, n = ""; if (!this.valueFormatString) if ("dateTime" === this.parent.valueType) this.valueFormatString = this.parent.valueFormatString; else {
                ...
                { x: 0, y: 0, padding: { top: 2, right: 3, bottom: 2, left: 4 }, backgroundColor: this.labelBackgroundColor, borderColor: this.labelBorderColor, borderThickness: this.labelBorderThickness, cornerRadius: this.labelCornerRadius, maxWidth: this.labelMaxWidth, maxHeight: this.labelMaxHeight, angle: this.labelAngle, text: n, horizontalAlign: "left", fontSize: this.labelFontSize, fontFamily: this.labelFontFamily, fontWeight: this.labelFontWeight, fontColor: this.labelFontColor, fontStyle: this.labelFontStyle, textBaseline: "middle" }); if (this.snapToDataPoint) {
                  var r =
                    0, n = []; if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                      var t = null; if ("bottom" === this.parent._position || "top" === this.parent._position) r = this.parent.dataSeries[0].axisX.convertPixelToValue({ y: d }); else if ("left" === this.parent._position || "right" === this.parent._position) r = this.parent.convertPixelToValue({ y: d }); for (var u = 0; u < this.parent.dataSeries.length; u++)(t = this.parent.dataSeries[u].getDataPointAtX(r, !0)) && 0 <= t.index && (t.dataSeries = this.parent.dataSeries[u], null !== t.dataPoint.y && t.dataSeries.visible &&
                            ...
                            Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), C = y = w = 0, r = 0; r < n.length; r++)if (n[r].dataPoint.y && n[r].dataPoint.y.length) for (s = 0; s < n[r].dataPoint.y.length; s++)w = Math.abs(a - this.parent.convertValueToPixel(n[r].dataPoint.y[s])), w < t && (t = w, u = r); else y += n[r].dataPoint.y, C = n[r].dataPoint.x.getTime ? n[r].dataPoint.x.getTime() : n[r].dataPoint.x, C = 100 * (y / n[r].dataSeries.plotUnit.dataPointYSums[C]), w = Math.abs(a - this.parent.convertValueToPixel(C)), w < t && (t = w, u = r); else for (t = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)),
                              r = u = w = 0; r < n.length; r++)if (n[r].dataPoint.y && n[r].dataPoint.y.length) for (s = 0; s < n[r].dataPoint.y.length; s++)w = Math.abs(a - this.parent.convertValueToPixel(n[r].dataPoint.y[s])), w < t && (t = w, u = r); else w = Math.abs(a - this.parent.convertValueToPixel(n[r].dataPoint.y)), w < t && (t = w, u = r); s = n[u]; if ("bottom" === this.parent._position || "top" === this.parent._position) {
                                b = 0; if ("rangeBar" === this.parent.dataSeries[u].type || "error" === this.parent.dataSeries[u].type) {
                                  ...
                                  t = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)); y = w = 0; for (r = u; 0 <= r; r--)y += n[r].dataPoint.y, w = Math.abs(a - this.parent.convertValueToPixel(y)), w < t && (t = w, b = r); v = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(y) << 0) + 0.5 : this.parent.convertValueToPixel(y) << 0; this.value = y; m.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: s.dataPoint.y }) : g(this.options.label) ?
                                  ...
                                  t = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)); C = y = w = 0; for (r = u; 0 <= r; r--)y += n[r].dataPoint.y, C = n[r].dataPoint.x.getTime ? n[r].dataPoint.x.getTime() : n[r].dataPoint.x, C = 100 * (y / n[r].dataSeries.plotUnit.dataPointYSums[C]), w = Math.abs(a - this.parent.convertValueToPixel(C)), w < t && (t = w, b = r); v = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(C) << 0) + 0.5 :
                      ...
                      r = this.parent.convertPixelToValue({ x: a }); for (u = 0; u < this.parent.dataSeries.length; u++)(t =
                      ...
                      !g(this.parent.dataSeries) && 0 < this.parent.dataSeries.length && (r = this.parent.dataSeries[0].axisX.convertPixelToValue({ x: a }));
                        ...
                        "boxAndWhisker" === n[0].dataSeries.type) for (t = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y[0])), r = w = 0; r < n.length; r++)if (n[r].dataPoint.y && n[r].dataPoint.y.length) for (s = 0; s < n[r].dataPoint.y.length; s++)w = Math.abs(d - this.parent.convertValueToPixel(n[r].dataPoint.y[s])), w < t && (t = w, u = r); else w = Math.abs(d - this.parent.convertValueToPixel(n[r].dataPoint.y)), w < t && (t = w, u = r); else if ("stackedColumn" === n[0].dataSeries.type || "stackedArea" === n[0].dataSeries.type) for (t = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)),
                          r = y = w = 0; r < n.length; r++)if (n[r].dataPoint.y && n[r].dataPoint.y.length) for (s = 0; s < n[r].dataPoint.y.length; s++)w = Math.abs(d - this.parent.convertValueToPixel(n[r].dataPoint.y[s])), w < t && (t = w, u = r); else y += n[r].dataPoint.y, w = Math.abs(d - this.parent.convertValueToPixel(y)), w < t && (t = w, u = r); else if ("stackedColumn100" === n[0].dataSeries.type || "stackedArea100" === n[0].dataSeries.type) for (t = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)), r = C = y = w = 0; r < n.length; r++)if (n[r].dataPoint.y && n[r].dataPoint.y.length) for (s =
                            0; s < n[r].dataPoint.y.length; s++)w = Math.abs(d - this.parent.convertValueToPixel(n[r].dataPoint.y[s])), w < t && (t = w, u = r); else y += n[r].dataPoint.y, C = n[r].dataPoint.x.getTime ? n[r].dataPoint.x.getTime() : n[r].dataPoint.x, C = 100 * (y / n[r].dataSeries.plotUnit.dataPointYSums[C]), w = Math.abs(d - this.parent.convertValueToPixel(C)), w < t && (t = w, u = r); else for (t = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)), r = w = 0; r < n.length; r++)if (n[r].dataPoint.y && n[r].dataPoint.y.length) for (s = 0; s < n[r].dataPoint.y.length; s++)w =
                              Math.abs(d - this.parent.convertValueToPixel(n[r].dataPoint.y[s])), w < t && (t = w, u = r); else w = Math.abs(d - this.parent.convertValueToPixel(n[r].dataPoint.y)), w < t && (t = w, u = r); s = n[u]; b = 0; if ("rangeColumn" === this.parent.dataSeries[u].type || "rangeArea" === this.parent.dataSeries[u].type || "error" === this.parent.dataSeries[u].type || "rangeSplineArea" === this.parent.dataSeries[u].type || "candlestick" === this.parent.dataSeries[u].type || "ohlc" === this.parent.dataSeries[u].type || "boxAndWhisker" === this.parent.dataSeries[u].type) {
                                t =
                                ...
                                t = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)); y = w = 0; for (r = u; 0 <= r; r--)y += n[r].dataPoint.y, w = Math.abs(d - this.parent.convertValueToPixel(y)), w < t && (t = w, b = r); x = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(y) << 0) + 0.5 : this.parent.convertValueToPixel(y) << 0; m.text = this.labelFormatter ? this.labelFormatter({
                                  chart: this.chart,
                                ...
                                t = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)); y = w = 0; for (r = u; 0 <= r; r--)y += n[r].dataPoint.y, C = n[r].dataPoint.x.getTime ? n[r].dataPoint.x.getTime() : n[r].dataPoint.x, C = 100 * (y / n[r].dataSeries.plotUnit.dataPointYSums[C]),
                              ...
                              } else "waterfall" === this.parent.dataSeries[u].type ? (x = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(s.dataSeries.dataPointEOs[s.index].cumulativeSum) <<
                  ...
                  if ("bottom" === this.parent._position || "top" === this.parent._position) b = e = v = 1 === q.lineWidth % 2 ? (a << 0) + 0.5 : a << 0, h = this.chart.plotArea.y1, k = this.chart.plotArea.y2, this.bounds = { x1: b - p / 2, y1: h, x2: e + p / 2, y2: k }; else if ("left" === this.parent._position || "right" === this.parent._position) h = k = x = 1 === q.lineWidth % 2 ? (d << 0) + 0.5 : d << 0, b = this.chart.plotArea.x1, e = this.chart.plotArea.x2, this.bounds = { x1: b, y1: h - p / 2, x2: e, y2: k + p / 2 }; if ("xySwapped" === this.chart.plotInfo.axisPlacement) if ("left" ===
                    this.parent._position || "right" === this.parent._position) {
                      C = !1; if (this.parent.labels) for (n = Math.ceil(this.parent.interval), r = 0; r < this.parent.viewportMaximum; r += n)if (this.parent.labels[r]) C = !0; else { C = !1; break } if (C) {
                        if ("axisX" === this.parent.type) for (r = this.parent.convertPixelToValue({ y: d }), t = null, u = 0; u < this.parent.dataSeries.length; u++)(t = this.parent.dataSeries[u].getDataPointAtX(r, !0)) && 0 <= t.index && (m.text = this.labelFormatter ? this.labelFormatter({
                          chart: this.chart, axis: this.parent.options, crosshair: this.options,
                          value: g(c) ? this.parent.convertPixelToValue(a) : c
                        }) : g(this.options.label) ? t.dataPoint.label : this.label)
                    ...
                    C = !1; n = ""; if (this.parent.labels) for (n = Math.ceil(this.parent.interval), r = 0; r < this.parent.viewportMaximum; r += n)if (this.parent.labels[r]) C =
            ...
            } if ("bottom" === this.parent._position || "top" === this.parent._position) this._updatedValue = this.parent.convertPixelToValue(v); if ("left" === this.parent._position ||
              "right" === this.parent._position) this._updatedValue = this.parent.convertPixelToValue(x); this._textBlock = m; g(c) || this.renderLabel(); q.globalAlpha = l
            ...
            c = "undefined" === typeof c ? !0 : c; this.container || this._initialize(); this.enabled || this.hide(); if (!this.chart.disableToolTip) {
              if ("undefined" === typeof a || "undefined" === typeof d) { if (isNaN(this._prevX) || isNaN(this._prevY)) return; a = this._prevX; d = this._prevY } else this._prevX = a, this._prevY = d; var b = null, e = null, h = [], k = 0; if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                var v =
                  []; if (this.chart.axisX) for (var x = 0; x < this.chart.axisX.length; x++) { for (var k = "xySwapped" === this.chart.plotInfo.axisPlacement ? this.chart.axisX[x].convertPixelToValue({ y: d }) : this.chart.axisX[x].convertPixelToValue({ x: a }), m = null, b = 0; b < this.chart.axisX[x].dataSeries.length; b++)(m = this.chart.axisX[x].dataSeries[b].getDataPointAtX(k, c)) && 0 <= m.index && (m.dataSeries = this.chart.axisX[x].dataSeries[b], null !== m.dataPoint.y && m.dataSeries.visible && v.push(m)); m = null } if (this.chart.axisX2) for (x = 0; x < this.chart.axisX2.length; x++) {
                    k =
                    "xySwapped" === this.chart.plotInfo.axisPlacement ? this.chart.axisX2[x].convertPixelToValue({ y: d }) : this.chart.axisX2[x].convertPixelToValue({ x: a }); m = null; for (b = 0; b < this.chart.axisX2[x].dataSeries.length; b++)(m = this.chart.axisX2[x].dataSeries[b].getDataPointAtX(k, c)) && 0 <= m.index && (m.dataSeries = this.chart.axisX2[x].dataSeries[b], null !== m.dataPoint.y && m.dataSeries.visible && v.push(m)); m = null
                  } if (0 === v.length) return; v.sort(function (a, b) { return a.distance - b.distance }); c = v[0]; for (b = 0; b < v.length; b++)v[b].dataPoint.x.valueOf() ===
                    c.dataPoint.x.valueOf() && h.push(v[b]); v = null
              } else {
                if (b = this.chart.getDataPointAtXY(a, d, c)) this.currentDataPointIndex = b.dataPointIndex, this.currentSeriesIndex = b.dataSeries.index; else if (u) if (b = ib(a, d, this.chart._eventManager.ghostCtx), 0 < b && "undefined" !== typeof this.chart._eventManager.objectMap[b]) { b = this.chart._eventManager.objectMap[b]; if ("legendItem" === b.objectType) return; this.currentSeriesIndex = b.dataSeriesIndex; this.currentDataPointIndex = 0 <= b.dataPointIndex ? b.dataPointIndex : -1 } else this.currentDataPointIndex =
                  -1; else this.currentDataPointIndex = -1; if (0 <= this.currentSeriesIndex) {
                    e = this.chart.data[this.currentSeriesIndex]; m = {}; if (0 <= this.currentDataPointIndex) b = e.dataPoints[this.currentDataPointIndex], m.dataSeries = e, m.dataPoint = b, m.index = this.currentDataPointIndex, m.distance = Math.abs(b.x - k), "waterfall" === e.type && (m.cumulativeSumYStartValue = e.dataPointEOs[this.currentDataPointIndex].cumulativeSumYStartValue, m.cumulativeSum = e.dataPointEOs[this.currentDataPointIndex].cumulativeSum); else {
                      if (!this.enabled || "line" !==
                        e.type && "stepLine" !== e.type && "spline" !== e.type && "area" !== e.type && "stepArea" !== e.type && "splineArea" !== e.type && "stackedArea" !== e.type && "stackedArea100" !== e.type && "rangeArea" !== e.type && "rangeSplineArea" !== e.type && "candlestick" !== e.type && "ohlc" !== e.type && "boxAndWhisker" !== e.type) return; k = e.axisX.convertPixelToValue({ x: a }); m = e.getDataPointAtX(k, c); g(m) || (m.dataSeries = e, this.currentDataPointIndex = m.index, b = m.dataPoint)
                ...
                if (this.highlightObjects(h), this.enabled) {
                  c = ""; c = this.getToolTipInnerHTML({ entries: h }); if (null !== c) {
                    this.contentDiv.innerHTML = c; if (this.isToolTipDefinedInData && g(this.options.content) && g(this.options.contentFormatter)) for (k = this.contentDiv.getElementsByTagName("span"), b = 0; b < k.length; b++)k[b] && (k[b].style.color = k[b].getAttribute("data-color")); k = !1; "none" === this.container.style.display &&
            ...
            var f = this.chart.overlaidCanvasCtx; if (g(this.chart.clearedOverlayedCanvas) || "toolTip" === this.chart.clearedOverlayedCanvas) this.chart.resetOverlayedCanvas(), f.clearRect(0, 0, this.chart.width, this.chart.height),
              this.chart.clearedOverlayedCanvas = "toolTip"; f.save(); var c = this.chart.plotArea, b = 0; f.beginPath(); f.rect(c.x1, c.y1, c.x2 - c.x1, c.y2 - c.y1); f.clip(); for (c = 0; c < a.length; c++) {
                var e = a[c]; if ((e = this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]]) && e.objectType && "dataPoint" === e.objectType) {
                  var b = this.chart.data[e.dataSeriesIndex], h = b.dataPoints[e.dataPointIndex], k = e.dataPointIndex; !1 === h.highlightEnabled || !0 !== b.highlightEnabled && !0 !== h.highlightEnabled || ("line" === b.type || "stepLine" === b.type ||
            ...
            a = a.entries; var d = null, c = null, b = null, e = 0, h = ""; this.isToolTipDefinedInData = !0; for (var g = 0; g < a.length; g++)if (a[g].dataSeries.toolTipContent || a[g].dataPoint.toolTipContent) {
              ...
              for (var k = null, v = "", g = 0; g < a.length; g++) {
                c = a[g].dataSeries; b = a[g].dataPoint; e = a[g].index; h = ""; if (0 === g && this.isToolTipDefinedInData && !this.content) {
                  this.chart.axisX && 0 < this.chart.axisX.length ? v += "undefined" !==
                    typeof this.chart.axisX[0].labels[b.x] ? this.chart.axisX[0].labels[b.x] : "{x}" : this.chart.axisX2 && 0 < this.chart.axisX2.length && (v += "undefined" !== typeof this.chart.axisX2[0].labels[b.x] ? this.chart.axisX2[0].labels[b.x] : "{x}"); v += "</br>"; if (!c.visible) continue; v = this.chart.replaceKeywordsWithValue(v, b, c, e)
            ...
            this.chart.clearedOverlayedCanvas = null; var c, b, e, h = []; e = !1; d = !g(d) && 0 <= d && d < this.chart.data.length ? d : 0; if (this.shared) for (var k = 0; k < this.chart.data.length; k++)c = this.chart.data[k], (b = c.getDataPointAtX(a, !1)) && (b.dataPoint && !g(b.dataPoint.y) && c.visible) && (b.dataSeries = c, h.push(b)); else c = this.chart.data[d], (b = c.getDataPointAtX(a, !1)) && (b.dataPoint && !g(b.dataPoint.y) && c.visible) && (b.dataSeries = c, h.push(b)); if (0 < h.length) {
              for (k = 0; k < h.length; k++)if (b = h[k], (this.shared || 0 <= b.dataSeries.type.indexOf("100")) &&
                b.dataPoint.x >= b.dataSeries.axisX.viewportMinimum && b.dataPoint.x <= b.dataSeries.axisX.viewportMaximum) { e = !1; break } else if (b.dataPoint.x < b.dataSeries.axisX.viewportMinimum || b.dataPoint.x > b.dataSeries.axisX.viewportMaximum || b.dataPoint.y < b.dataSeries.axisY.viewportMinimum || b.dataPoint.y > b.dataSeries.axisY.viewportMaximum) e = !0; else { e = !1; break } if (e) return this.hide(), !1; this.highlightObjects(h); this._entries = h; k = ""; k = this.getToolTipInnerHTML({ entries: h }); if (null !== k) {
                  this.contentDiv.innerHTML = k; if (this.isToolTipDefinedInData &&
                    g(this.options.content) && g(this.options.contentFormatter)) for (b = this.contentDiv.getElementsByTagName("span"), k = 0; k < b.length; k++)b[k] && (b[k].style.color = b[k].getAttribute("data-color")); k = !1; "none" === this.container.style.display && (k = !0, this.container.style.display = "block"); try {
            ...
            function () { return ++this.lastObjectId }; ea.prototype.mouseEventHandler = function (a) {
              if ("mousemove" === a.type || "click" === a.type) {
                var d = [], c = Aa(a), b = null; if ((b = this.chart.getObjectAtXY(c.x, c.y, !1)) && "undefined" !== typeof this.objectMap[b]) if (b = this.objectMap[b], "dataPoint" === b.objectType) {
              ...
              drawMarker: function (a, d, c, b, e, h, g, k) {
                if (c) {
                  var v = 1; c.fillStyle = h ? h : "#000000";
                  c.strokeStyle = g ? g : "#000000"; c.lineWidth = k ? k : 0; c.setLineDash && c.setLineDash(T("solid", k)); "circle" === b ? (c.moveTo(a, d), c.beginPath(), c.arc(a, d, e / 2, 0, 2 * Math.PI, !1), h && c.fill(), k && (g ? c.stroke() : (v = c.globalAlpha, c.globalAlpha = 0.15, c.strokeStyle = "black", c.stroke(), c.globalAlpha = v))) : "square" === b ? (c.beginPath(), c.rect(a - e / 2, d - e / 2, e, e), h && c.fill(), k && (g ? c.stroke() : (v = c.globalAlpha, c.globalAlpha = 0.15, c.strokeStyle = "black", c.stroke(), c.globalAlpha = v))) : "triangle" === b ? (c.beginPath(), c.moveTo(a - e / 2, d + e / 2), c.lineTo(a +
                    e / 2, d + e / 2), c.lineTo(a, d - e / 2), c.closePath(), h && c.fill(), k && (g ? c.stroke() : (v = c.globalAlpha, c.globalAlpha = 0.15, c.strokeStyle = "black", c.stroke(), c.globalAlpha = v)), c.beginPath()) : "cross" === b && (c.strokeStyle = h, c.lineWidth = e / 4, c.beginPath(), c.moveTo(a - e / 2, d - e / 2), c.lineTo(a + e / 2, d + e / 2), c.stroke(), c.moveTo(a + e / 2, d - e / 2), c.lineTo(a - e / 2, d + e / 2), c.stroke())
                }
  ...
  Ja.version = "v3.7.2 GA"; window.CanvasJS && (Ja && !window.CanvasJS.Chart) && (window.CanvasJS.Chart = Ja); ea.StockChart = {
  ...
  }; ea.RangeSelector = { enabled: !0, width: 500, height: 35, label: "Range", verticalAlign: "top", horizontalAlign: "center", selectedRangeButtonIndex: null, publicProperties: { options: "readWrite", buttons: "readWrite", inputFields: "readWrite", buttonStyle: "readWrite", bounds: "readOnly" } }; ea.RangeButton = {
    ...
    }; L = "#FFFFFF"; ca = "#3A3A3A"; V = "#666666"; Ia = {
      colorSet: "colorSet2", backgroundColor: L, title: Ia.title, subtitles: Ia.subtitles, charts: [Ia], rangeSelector: {
        buttonStyle: {
  ...
  za = {
    colorSet: "colorSet1", backgroundColor: L, title: za.title, subtitles: za.subtitles, charts: [za], rangeSelector: {
    ...
    }, navigator: { backgroundColor: L, slider: { maskColor: "#d9e8f9", maskOpacity: 0.6, handleColor: "#efefef", handleBorderColor: "#666666", handleBorderThickness: 1, outlineColor: "#FFFFFF", outlineThickness: 1 } }, toolbar: za.toolbar
  }; L = "#32373A"; V = ca = "#FAFAFA"; var ab = {
    light1: Fa, light2: Ia, dark1: za, dark2: {
    ...
    function k(d) { var g; g = document.createElement("div"); g.setAttribute("class", d); N(g, { position: "absolute", textAlign: "left", cursor: "auto", webkitTapHighlightColor: "transparent" }); return g } function F(d, k, x) {
      d = document.createElement(d); d.setAttribute("class", k); N(d, { webkitTapHighlightColor: "transparent" }); g(x) || d.setAttribute("type",
        x); return d
    } function E(d, k) {
      k = k || {}; this.theme = g(k.theme) || g($a[k.theme]) ? "light1" : k.theme; this.predefinedThemes = ab; E.base.constructor.call(this, "StockChart", null, k, null, null); this.optionsName = "stockChart"; var x = this; this.sessionVariables = {}; this._axisXMax = this._axisXMin = null; this._containerId = d; this._objectsInitialized = !1; this.ctx = null; this.plotArea = { canvas: null, ctx: null, x1: 0, y1: 0, x2: 0, y2: 0, width: 0, height: 0 }; this._dataInRenderedOrder = []; this.allDOMEventHandlers = []; if (this.container = "string" === typeof this._containerId ?
        document.getElementById(this._containerId) : this._containerId) {
          this.container.innerHTML = ""; var t = 0, a = 0; this._defaultCursor = "default"; t = this.options.width ? this.width : 0 < this.container.clientWidth ? this.container.clientWidth : this.width; a = this.options.height ? this.height : 0 < this.container.clientHeight ? this.container.clientHeight : this.height; this.width = t; this.height = a; this.x1 = this.y1 = 0; this.x2 = this.width; this.y2 = this.height; this.selectedColorSet = "undefined" !== typeof xa[this.colorSet] ? xa[this.colorSet] : xa.colorSet1;
        this._canvasJSContainer = document.createElement("div"); this._canvasJSContainer.setAttribute("class", "canvasjs-stock-container"); this._canvasJSContainer.style.position = "relative"; this._canvasJSContainer.style.userSelect = this._canvasJSContainer.style.WebkitUserSelect = this._canvasJSContainer.style.MozUserSelect = this._canvasJSContainer.style.msUserSelect = "none"; this._canvasJSContainer.style.textAlign = "left"; this._canvasJSContainer.style.cursor = "auto"; this._canvasJSContainer.style.direction = "ltr"; this._canvasJSContainer.style.fontFamily =
          s; u || (this._canvasJSContainer.style.height = "0px"); this.container.appendChild(this._canvasJSContainer); this.canvas = sa(t, a); this.canvas.style.position = "absolute"; this.canvas.getContext && (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", Ga(this.ctx), this.overlaidCanvas = sa(t, a), this.overlaidCanvas.style.position = "absolute", this.overlaidCanvas.style.webkitTapHighlightColor = "transparent", this.overlaidCanvas.getContext && (this._canvasJSContainer.appendChild(this.overlaidCanvas),
            ...
            y(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerUp" : "touchend", function (a) { x._touchEventHandler(a) }, this.allDOMEventHandlers), y(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerCancel" : "touchcancel", function (a) { x._touchEventHandler(a) }, this.allDOMEventHandlers), this.windowResizeHandler = y(window, "resize", function () { x._updateSize() && x.render() }, this.allDOMEventHandlers))
      } else window.console && window.console.log('CanvasJS Error: StockChart Container with id "' + this._containerId +
        '" was not found')
    } function L(d, g) { L.base.constructor.call(this, d, g); this.options = g; this.dockInsidePlotArea = !1 } function V(d, g, k) { V.base.constructor.call(this, d, g, k); this.options = g; this.dockInsidePlotArea = !1 } function M(d) { this.stockChart = d; this.lastObjectId = 0; this.objectMap = []; this.rectangularRegionEventSubscriptions = []; this.ghostCanvas = sa(this.stockChart.width, this.stockChart.height); this.ghostCtx = this.ghostCanvas.getContext("2d"); this.mouseoveredObjectMaps = [] } function z(d, g) {
      g = g || {}; this.optionsName =
        "navigator"; z.base.constructor.call(this, "Navigator", "navigator", g, null, d); this.parent = this.stockChart = d
    } function T(d, v) { this.panel = k("canvasjs-slider-panel"); this.parent = this.navigator = d; this.stockChart = d.stockChart; this.navigator.panel.appendChild(this.panel); T.base.constructor.call(this, "Slider", "slider", v, null, d); this.options = g(v.navigator) || g(v.navigator.slider) ? {} : v.navigator.slider; this.optionsName = "slider"; this.panMode = !1; this.sessionVariables = {} } function R(d, k) {
      R.base.constructor.call(this,
        "RangeSelector", "rangeSelector", k, null, d); this.parent = this.stockChart = d; this.options = g(k) || g(k.rangeSelector) ? {} : k.rangeSelector; this.optionsName = "rangeSelector"; this.ctx = d.ctx
    } function O(d, k, x) { O.base.constructor.call(this, "RangeButton", "rangeButton", x, k, d.rangeSelector); this.stockChart = d; this.parent = this.rangeSelector = d.rangeSelector; this.options = g(x) ? {} : x; this.optionsName = "rangeButton"; this.enabled = !1; this.state = "off" } function ba(d, k) {
      ba.base.constructor.call(this, "InputFields", "inputFields", k,
        null, d.rangeSelector); this.stockChart = d; this.options = g(k) || g(k.inputFields) ? {} : k.inputFields; this.parent = this.rangeSelector = d.rangeSelector; this.elements = []; this._textBlocks = []; this.optionsName = "inputFields"; this.elements.push(F("input", "canvasjs-input-field", "text")); this.elements.push(F("input", "canvasjs-input-field", "text")); for (var x = 0; x < this.elements.length; x++)this.stockChart._canvasJSContainer.appendChild(this.elements[x]); var t = this, a = null, f = null; y(this.elements[0], "focus", function () {
          t.enabled &&
          (t.elements[0].focused = !0, t._textBlocks[0].borderColor = t.style.borderColorOnFocus, t._textBlocks[0].render(!0))
        }, this.rangeSelector.stockChart.allDOMEventHandlers); y(this.elements[0], "focusout", function () {
          if (t.enabled) {
            t.elements[0].focused = !1; var a; t.stockChart.charts && t.stockChart.charts.length && (a = t.stockChart.charts[0].axisX && t.stockChart.charts[0].axisX.length ? t.stockChart.charts[0].axisX[0] : t.stockChart.charts[0].axisX2[0]); this.value = "dateTime" === t.valueType ? oa(a ? a.viewportMinimum : null, "YYYY-MM-DD",
              t.stockChart._cultureInfo) : aa(a ? a.viewportMinimum : null, t.valueFormatString, t.stockChart._cultureInfo); this.style.display = "none"; t._textBlocks[0].borderColor = t.style.borderColor; t._textBlocks[0].render(!0)
          }
        }, this.rangeSelector.stockChart.allDOMEventHandlers); y(this.elements[1], "focus", function () { t.enabled && (t.elements[1].focused = !0, t._textBlocks[1].borderColor = t.style.borderColorOnFocus, t._textBlocks[1].render(!0)) }, this.rangeSelector.stockChart.allDOMEventHandlers); y(this.elements[1], "focusout", function () {
          if (t.enabled) {
            t.elements[1].focused =
      ...
      y(this.elements[0], "change", function (c) {
        if (t.enabled) {
          var b, d; t.stockChart.charts && t.stockChart.charts.length && (t.stockChart.navigator && t.stockChart.navigator.enabled && (d = t.stockChart.navigator && t.stockChart.navigator.chart && t.stockChart.navigator.chart.axisX ? t.stockChart.navigator.chart.axisX[0] : t.stockChart.navigator.chart.axisX2[0]), b = t.stockChart.charts[0].axisX && t.stockChart.charts[0].axisX.length ? t.stockChart.charts[0].axisX[0] : t.stockChart.charts[0].axisX2[0]); c = "dateTime" === t.valueType ? isNaN((new Date(this.value.replace(/-/g,
          ...
          var b, d; t.stockChart.charts && t.stockChart.charts.length &&
            (t.stockChart.navigator && t.stockChart.navigator.enabled && (d = t.stockChart.navigator && t.stockChart.navigator.chart && t.stockChart.navigator.chart.axisX ? t.stockChart.navigator.chart.axisX[0] : t.stockChart.navigator.chart.axisX2[0]), b = t.stockChart.charts[0].axisX && t.stockChart.charts[0].axisX.length ? t.stockChart.charts[0].axisX[0] : t.stockChart.charts[0].axisX2[0]); c = "dateTime" === t.valueType ? isNaN((new Date(this.value.replace(/-/g, "/"))).getTime()) ? null : (new Date(this.value.replace(/-/g, "/"))).getTime() :
              this.value; a = b ? b.viewportMinimum : null; f = g(d) ? !g(c) && c > (b ? b.minimum : null) ? Math.min(b ? b.maximum : null, c) : b ? b.maximum : null : !g(c) && c > (d ? d.minimum : null) ? Math.min(d ? d.maximum : null, c) : d ? d.maximum : null; t.stockChart._rangeEventParameter = { stockChart: t.stockChart, source: "inputFields", index: null, minimum: a, maximum: f }; t.stockChart._rangeEventParameter.type = "rangeChanging"; t.stockChart.dispatchEvent("rangeChanging", t.stockChart._rangeEventParameter, t.stockChart); t.stockChart.sessionVariables._axisXMin = a; t.stockChart.sessionVariables._axisXMax =
                f; t.stockChart._syncCharts(a, f); t.stockChart._rangeEventParameter.type = "rangeChanged"; t.stockChart.dispatchEvent("rangeChanged", t.stockChart._rangeEventParameter, t.stockChart); t.stockChart.rangeSelector && t.stockChart.rangeSelector.resetRangeButtons()
        }
      }, this.rangeSelector.stockChart.allDOMEventHandlers); y(this.elements[0], "keydown", function (a) {
        if (t.enabled && 13 === a.keyCode) {
          var b = "dateTime" === t.valueType ? oa(t.startValue, "YYYY-MM-DD") : aa(t.startValue, t.valueFormatString); this.value != b && gb(this, "change");
          this.blur(); a.preventDefault && a.preventDefault()
        }
      }, this.rangeSelector.stockChart.allDOMEventHandlers); y(this.elements[1], "keydown", function (a) { if (t.enabled && 13 === a.keyCode) { var b = "dateTime" === t.valueType ? oa(t.endValue, "YYYY-MM-DD") : aa(t.endValue, t.valueFormatString); this.value != b && gb(this, "change"); this.blur(); a.preventDefault && a.preventDefault() } }, this.rangeSelector.stockChart.allDOMEventHandlers)
    } function ca(d, k) {
      ca.base.constructor.call(this, "ButtonStyle", "buttonStyle", k, null, d.rangeSelector);
      this.stockChart = d; this.parent = this.rangeSelector = d.rangeSelector; this.options = g(k) || g(k.buttonStyle) ? {} : k.buttonStyle; this.optionsName = "buttonStyle"
    } function fa(d, k) { fa.base.constructor.call(this, "Style", "style", k, null, d.rangeSelector.inputFields); this.stockChart = d; this.parent = this.inputFields = d.rangeSelector.inputFields; this.options = g(k) || g(k.style) ? {} : k.style; this.optionsName = "style" } var ea = !0; ka(E, Y); E.prototype._updateOptions = function () {
    ...
    }; E._supportedChartTypes = Da("line stepLine spline column area stepArea splineArea bubble scatter stackedColumn stackedColumn100 stackedArea stackedArea100 candlestick ohlc boxAndWhisker rangeColumn error rangeArea rangeSplineArea waterfall".split(" ")); E.prototype._initialize = function () {
      this._updateOptions(); this.animationEnabled = this.animationEnabled && u; this._updateSize(); this.clearCanvas();
      ...
      this.rangeSelector.inputFields._initialize(); if (this.rangeSelector.inputFields && this.rangeSelector.inputFields.enabled) for (this.rangeSelector.inputFields._textBlocks = [], this.rangeSelector.inputFields._labels = [], this.rangeSelector.inputFieldsWidth = 0, t = this.rangeSelector.inputFields.style.maxWidth = this.rangeSelector.inputFields.style.options.maxWidth ? this.rangeSelector.inputFields.style.options.maxWidth : this.rangeSelector.stockChart.width / 2, x = 0; x < this.rangeSelector.inputFields.elements.length; x++) {
        d =
        new na(this.rangeSelector.ctx, {
        ...
        }); var v = d.measureText(), a = new na(this.rangeSelector.ctx, {
          x: 0, y: 0, backgroundColor: u ? "transparent" : null, borderColor: this.rangeSelector.inputFields.style.borderColor,
          ...
          v.height ? v.height : this.rangeSelector.inputFieldsHeight; d = this.rangeSelector.inputFields._textBlocks[x]; d.id = ++this.rangeSelector.stockChart._eventManager.lastObjectId; this.rangeSelector.stockChart._eventManager.objectMap[d.id] = { id: d.id, objectType: "inputFields", inputFieldIndex: x }
      ...
      var v = this; d && (this.options = d); this._initialize(); this.title && this.title.render();
      if (this.subtitles) for (d = 0; d < this.subtitles.length; d++)this.subtitles[d].render(); var x; if (this.options.charts) {
        x = Array(this.options.charts.length); var t = this.layoutManager.getFreeSpace(), a = t.height, t = t.height, f = this.options.charts.length; for (d = 0; d < this.options.charts.length; d++)!g(this.options.charts[d].height) && parseFloat(this.options.charts[d].height) && (x[d] = 0 <= this.options.charts[d].height.toString().indexOf("%") ? Ua(this.options.charts[d].height, a, Math.floor(t / f), this.height, 0) : this.options.charts[d].height,
          t -= x[d], f--); t = Math.floor(t / f); for (d = 0; d < this.options.charts.length; d++)g(x[d]) && (x[d] = t); var c, f = this.options.charts, b = this.charts; this.charts = []; for (d = 0; d < f.length; d++) {
            t = this.layoutManager.getFreeSpace(); a = f[d]; a.theme = f[d].theme ? f[d].theme : this.options.theme ? this.options.theme : this.theme; a.animationEnabled = g(f[d].animationEnabled) ? this.animationEnabled : f[d].animationEnabled; a.animationDuration = f[d].animationDuration ? f[d].animationDuration : this.animationDuration; a.culture = f[d].culture ? f[d].culture :
            ...
            this.charts[d].panel.style.width = t.width + "px"; this.charts[d].panel.style.top = t.y1 + "px"; this.charts[d].panel.style.left = t.x1 + "px"; this.charts[d].panel.style.height = x[d] + "px"; this.charts[d].height = a.height ? a.height : x[d]; this.layoutManager.registerSpace("top", { width: t.width, height: x[d] })
      ...
      } t = x = null; c = 0; f = a = null; for (d = 0; d < this.charts.length; d++)for (b = this.charts[d].axisX && this.charts[d].axisX.length ? this.charts[d].axisX : this.charts[d].axisX2, x = x || (b && 0 < b.length ?
        b[0].minimum : null), t = t || (b && 0 < b.length ? b[0].maximum : null), c = 0; c < b.length; c++)e = b[c], e.minimum < x && (x = e.minimum), e.maximum > t && (t = e.maximum); var h; this.navigator && (this.navigator.chart && ea) && (h = this.navigator.chart.axisX && 0 < this.navigator.chart.axisX.length ? this.navigator.chart.axisX[0] : this.navigator.chart.axisX2[0], this._axisXMin = this.navigator.slider.minimum = g(this.navigator.options.slider) || g(this.navigator.options.slider.minimum) ? null : Math.max(h.minimum, this.navigator.slider.minimum), this._axisXMax =
          this.navigator.slider.maximum = g(this.navigator.options.slider) || g(this.navigator.options.slider.maximum) ? null : Math.min(h.maximum, this.navigator.slider.maximum)); if (this.rangeSelector && this.rangeSelector.enabled) {
            c = h ? h.maximum - h.minimum : t - x; this.charts && this.charts.length && (e = this.charts[0].axisX && this.charts[0].axisX.length ? this.charts[0].axisX[0] : this.charts[0].axisX2[0]); for (d = 0; d < this.rangeSelector.buttons.length; d++) {
              ...
              this.rangeSelector.inputFields.valueType = this.options.rangeSelector && this.options.rangeSelector.inputFields && this.options.rangeSelector.inputFields.valueType ? this.options.rangeSelector.inputFields.valueType : this.isDateTime ?
                "dateTime" : "number"; for (d = 0; d < this.rangeSelector.inputFields._textBlocks.length; d++)e = this.rangeSelector.inputFields._textBlocks[d], e.mousemove = function (a) { v.rangeSelector && v.rangeSelector.inputFields && !v.rangeSelector.inputFields.enabled || (a.inputField.cursor = a.stockChart.rangeSelector.inputFields.style.cursor) }, e.mouseover = function (a) { v.rangeSelector && v.rangeSelector.inputFields && !v.rangeSelector.inputFields.enabled || (a.inputField.cursor = a.stockChart.rangeSelector.inputFields.style.cursor) }, e.mouseout =
                  function (a) { v.rangeSelector && v.rangeSelector.inputFields && !v.rangeSelector.inputFields.enabled || (a.inputField.cursor = "auto") }, e.click = function (a) { v.rangeSelector && v.rangeSelector.inputFields && !v.rangeSelector.inputFields.enabled || (a.stockChart.rangeSelector.inputFields.elements[a.inputFieldIndex].style.display = "inline", a.stockChart.rangeSelector.inputFields.elements[a.inputFieldIndex].focus()) }; if (isFinite(x) && isFinite(t)) {
          ...
          } g(this._axisXMin) && (this._axisXMin = x); g(this._axisXMax) && (this._axisXMax = t); this._axisXMin = !g(this.sessionVariables._axisXMin) && this.navigator && this.navigator.slider && !this.navigator.slider.hasOptionChanged("minimum") ? this.sessionVariables._axisXMin :
      ...
      var d, g, k = 0, t = this.width; this.isPlotAreaSet = this.isDateTime = !1; for (var a =
        0; a < this.charts.length; a++) {
          d = this.charts[a]; d._initialize(); d.setLayout(); g = {}; if ((d.axisX[0] || d.axisX2[0]) && (d.axisY[0] || d.axisY2[0])) { var f = d.axisX[0] ? d.axisX[0].lineCoordinates : d.axisX2[0].lineCoordinates; if (d.axisY && 0 < d.axisY.length && d.axisY[0]) { var c = d.axisY[0]; g.x1 = f.x1 < f.x2 ? f.x1 : c.lineCoordinates.x1; g.x2 = f.x2 > c.lineCoordinates.x2 ? f.x2 : c.lineCoordinates.x2 } d.axisY2 && 0 < d.axisY2.length && d.axisY2[0] && (c = d.axisY2[0], g.x1 = f.x1 < f.x2 ? f.x1 : c.lineCoordinates.x1, g.x2 = f.x2 > c.lineCoordinates.x2 ? f.x2 : c.lineCoordinates.x2) } for (f =
            0; f < d.data.length; f++)"dateTime" === d.data[f].xValueType && (this.isDateTime = !0); k = Math.max(k, g.x1); t = Math.min(t, g.x2); d.sessionVariables.plotAreaBounds = g
      } this._chartsPlotAreaX1 = k; this._chartsPlotAreaX2 = t
    }; E.prototype._updateSize = function () { return lb.call(this, [this.canvas, this.overlaidCanvas]) }; E.prototype._syncCharts = function (d, k) {
      for (var x = this, t = null, a = Math.min(d, k), f = Math.max(d, k), c = 0; c < this.charts.length; c++) {
        ...
        t.options.toolbar ? t.options.toolbar = t.options.toolbar : x.options.toolbar && (t.options.toolbar = x.options.toolbar); t._initialize(); t.setLayout(); t.panEnabled = t.options.zoomEnabled && t.zoomEnabled ? !1 : !0; t.renderElements(); (g(this.charts[c].options.toolTip) || !g(this.charts[c].options.toolTip) && g(this.charts[c].options.toolTip.updated)) && this.charts[c].toolTip && (this.charts[c].toolTip.updated = function (a) {
          for (var b = 0; b < x.charts.length; b++)x.charts[b] != a.chart && x.charts[b].toolTip.showAtX(a.entries[0].xValue,
            a.entries[0].dataSeriesIndex)
        }); (g(this.charts[c].options.toolTip) || !g(this.charts[c].options.toolTip) && g(this.charts[c].options.toolTip.hidden)) && this.charts[c].toolTip && (this.charts[c].toolTip.hidden = function (a) { for (var b = 0; b < x.charts.length; b++)x.charts[b] != a.chart && x.charts[b].toolTip.hide() })
      ...
      d = "undefined" === typeof d ? {} : d; var g = d.format ? d.format : "png", k = d.fileName ? d.fileName : this.exportFileName, t = this.canvas.cloneNode(); t.setAttribute("class",
        ...
        })); for (c = 0; c < f.length; c++)a.drawImage(f[c].canvas, f[c].position.x * ma, f[c].position.y * ma); if (d.toDataURL) return t.toDataURL("image/" + g); cb(t, g, k)
    }; E.prototype.print = function () {
      var d = this.exportChart({ toDataURL: !0 }), g = document.createElement("iframe"); g.setAttribute("class", "canvasjs-chart-print-frame"); N(g, { position: "absolute", width: "100%", border: 0, margin: 0, padding: 0 }); g.style.height = this.height + "px"; this._canvasJSContainer.appendChild(g); var k = this,
        t = g.contentWindow || g.contentDocument.document || g.contentDocument; t.document.open(); t.document.write('<!DOCTYPE HTML>\n<html><body><img src="' + d + '"/><body/></html>'); t.document.body && t.document.body.style && (t.document.body.style.margin = "0px 0px 0px 0px", t.document.body.style.padding = "0px 0px 0px 0px"); t.document.close(); setTimeout(function () { t.focus(); t.print(); setTimeout(function () { k._canvasJSContainer.removeChild(g) }, 1E3) }, 500)
    }; E.prototype.getObjectAtXY = function (d, k, x) {
      x = null; if (!g(this.rangeSelector)) {
        for (var t =
          0; t < this.rangeSelector.buttons.length; t++) { var a = this.rangeSelector.buttons[t]; d >= a.bounds.x1 && (d <= a.bounds.x2 && k >= a.bounds.y1 && k <= a.bounds.y2) && (x = a.id) } for (t = 0; t < this.rangeSelector.inputFields._textBlocks.length; t++)a = this.rangeSelector.inputFields._textBlocks[t], d >= a.bounds.x1 && (d <= a.bounds.x2 && k >= a.bounds.y1 && k <= a.bounds.y2) && (x = a.id)
      } return x
    }; E.prototype._touchEventHandler = function (d) {
      if (d.changedTouches) {
        var k = [], x = d.changedTouches, t = x ? x[0] : d, a = null; switch (d.type) {
      ...
      "undefined" === typeof d.target && d.srcElement && (d.target = d.srcElement); var g = Aa(d), k = d.type, t, a; d.which ? a = 3 == d.which : d.button && (a = 2 == d.button); E.capturedEventParam && (t = E.capturedEventParam, "mouseup" === k && (E.capturedEventParam = null, t.stockChart.overlaidCanvas.releaseCapture ?
        t.stockChart.overlaidCanvas.releaseCapture() : document.documentElement.removeEventListener("mouseup", t.stockChart._mouseEventHandler, !1)), t.hasOwnProperty(k) && ("mouseup" !== k || t.stockChart.overlaidCanvas.releaseCapture ? d.target !== t.stockChart.overlaidCanvas && u || t[k].call(t.context, g.x, g.y) : d.target !== t.stockChart.overlaidCanvas && (t.stockChart.isDrag = !1))); if (this._ignoreNextEvent) this._ignoreNextEvent = !1; else if (d.preventManipulation && d.preventManipulation(), d.preventDefault && d.preventDefault(), La &&
          window.console && (window.console.log(k + " --\x3e x: " + g.x + "; y:" + g.y), a && window.console.log(d.which), "mouseup" === k && window.console.log("mouseup")), !a) {
            if (!E.capturedEventParam && this._events) {
              for (var f = 0; f < this._events.length; f++)if (this._events[f].hasOwnProperty(k)) if (t = this._events[f], a = t.bounds, g.x >= a.x1 && g.x <= a.x2 && g.y >= a.y1 && g.y <= a.y2) {
                t[k].call(t.context, g.x, g.y); "mousedown" === k && !0 === t.capture ? (Chart.capturedEventParam = t, this.overlaidCanvas.setCapture ? this.overlaidCanvas.setCapture() : document.documentElement.addEventListener("mouseup",
            ...
            } k = this.bounds; (g.x < k.x1 || g.x > k.x2 || g.y < k.y1 || g.y > k.y2) && this.resetOverlayedCanvas(); !this.isDrag && this._eventManager && this._eventManager.mouseEventHandler(d)
        }
    }; E.prototype.resetOverlayedCanvas = function () {
      this.overlaidCanvasCtx.clearRect(0,
        0, this.width, this.height)
    }; E.prototype.clearCanvas = mb; E.prototype.getAutoFontSize = nb; ka(L, Ha); ka(V, Ma); Ja.prototype.alignVerticalAxes = function () {
      if (!this.isNavigator && this.stockChart) {
        for (var d = this.sessionVariables.plotAreaBounds, g = this.stockChart._chartsPlotAreaX1 - d.x1, d = d.x2 - this.stockChart._chartsPlotAreaX2, k = 0; k < this.axisX.length; k++)this.axisX[k].lineCoordinates.x1 += g, this.axisX[k].lineCoordinates.x2 -= d, this.axisX[k].lineCoordinates.width = this.axisX[k].lineCoordinates.x2 - this.axisX[k].lineCoordinates.x1,
          this.axisX[k].bounds.x1 += g, this.axisX[k].bounds.x2 -= d, this.axisX[k].calculateValueToPixelConversionParameters(); for (k = 0; k < this.axisX2.length; k++)this.axisX2[k].lineCoordinates.x1 += g, this.axisX2[k].lineCoordinates.x2 -= d, this.axisX2[k].lineCoordinates.width = this.axisX2[k].lineCoordinates.x2 - this.axisX2[k].lineCoordinates.x1, this.axisX2[k].bounds.x1 += g, this.axisX2[k].bounds.x2 -= d, this.axisX2[k].calculateValueToPixelConversionParameters(); for (k = 0; k < this.axisY.length; k++)this.axisY[k].lineCoordinates.x1 +=
            g, this.axisY[k].lineCoordinates.x2 += g, this.axisY[k].bounds.x1 += g, this.axisY[k].bounds.x2 += g; for (k = 0; k < this.axisY2.length; k++)this.axisY2[k].lineCoordinates.x1 -= d, this.axisY2[k].lineCoordinates.x2 -= d, this.axisY2[k].bounds.x1 -= d, this.axisY2[k].bounds.x2 -= d
      }
    }; Ja.prototype.syncCharts = function (d, k) {
      this.stockChart && (d = g(d) ? this.stockChart._axisXMin : d, k = g(k) ? this.stockChart._axisXMax : k, this.stockChart._syncCharts(d, k), this.stockChart.sessionVariables._axisXMin = d, this.stockChart.sessionVariables._axisXMax =
      ...
      if ("mousemove" ===
        d.type || "click" === d.type) {
          var g = [], k = Aa(d), t = null; if ((t = this.stockChart.getObjectAtXY(k.x, k.y, !1)) && "undefined" !== typeof this.objectMap[t]) if (t = this.objectMap[t], "rangeButton" === t.objectType) {
            ...
            g.push(t)
          } else "inputFields" === t.objectType && (a = this.stockChart.rangeSelector.inputFields._textBlocks[t.inputFieldIndex], t.eventParameter = { x: k.x, y: k.y, inputField: a, inputFieldIndex: t.inputFieldIndex, stockChart: this.stockChart }, t.eventContext = { context: this.stockChart.rangeSelector, userContext: a, mouseover: "mouseover", mousemove: "mousemove", mouseout: "mouseout", click: "click" }, g.push(t)); a = []; for (k = 0; k < this.mouseoveredObjectMaps.length; k++) {
            for (var f = !0, t = 0; t < g.length; t++)if (g[t].id === this.mouseoveredObjectMaps[k].id) {
              f =
              !1; break
            } f ? this.fireEvent(this.mouseoveredObjectMaps[k], "mouseout", d) : a.push(this.mouseoveredObjectMaps[k])
          } this.mouseoveredObjectMaps = a; for (k = 0; k < g.length; k++) { a = !1; for (t = 0; t < this.mouseoveredObjectMaps.length; t++)if (g[k].id === this.mouseoveredObjectMaps[t].id) { a = !0; break } a || (this.fireEvent(g[k], "mouseover", d), this.mouseoveredObjectMaps.push(g[k])); "click" === d.type ? this.fireEvent(g[k], "click", d) : "mousemove" === d.type && this.fireEvent(g[k], "mousemove", d) }
      }
    }; M.prototype.fireEvent = function (d, g, k) {
      if (d &&
        g) { var t = d.eventParameter, a = d.eventContext, f = d.eventContext.userContext; f && (a && f[a[g]]) && f[a[g]].call(f, t); "mouseout" !== g ? f.cursor && f.cursor !== k.target.style.cursor && (k.target.style.cursor = f.cursor) : (k.target.style.cursor = this.stockChart._defaultCursor, delete d.eventParameter, delete d.eventContext) }
      ...
      this.animationEnabled = this.animationEnabled && u; this.updateOption("animationDuration"); this.updateOption("theme"); this.updateOption("verticalAlign"); this.updateOption("horizontalAlign"); this.updateOption("width"); this.updateOption("height"); this.updateOption("dynamicUpdate")
    }; z.prototype._initialize = function () {
      this._updateOptions(); var d; this.enabled && !this.panel && (this.panel = k("canvasjs-navigator-panel"), (d = !g(this.panel) && this.stockChart._canvasJSContainer.contains(this.panel)) || this.stockChart._canvasJSContainer.appendChild(this.panel));
      d = !g(this.panel) && this.stockChart._canvasJSContainer.contains(this.panel); if (this.enabled) {
        this.height = this.options.height ? parseInt(this.options.height) : 0.14 * this.stockChart.height; d || this.stockChart._canvasJSContainer.appendChild(this.panel); var v = this.stockChart.layoutManager.getFreeSpace(), x = v.x1, t = v.y1; this.width = this.options.width ? this.width : v.width; "top" === this.verticalAlign ? (t = v.y1 + 2, d = "top") : (t = v.y2 - this.height - 2, d = "bottom"); "left" === this.horizontalAlign ? x = v.x1 + 2 : "center" === this.horizontalAlign ?
          x = v.x1 + v.width / 2 - this.width / 2 : "right" === this.horizontalAlign && (x = v.x2 - 2 - this.width); this.panel.style.top = t + "px"; this.panel.style.left = x + "px"; this.panel.style.height = this.height + "px"; this.panel.style.width = this.width + "px"; this.stockChart.layoutManager.registerSpace(d, { width: this.width, height: this.height + 2 }); this.bounds = { x1: x, y1: t, x2: x + this.width, y2: t + this.height }
      } else d && this.stockChart._canvasJSContainer.removeChild(this.panel)
    }; z.prototype._updateSlider = function (d, k) {
      var x = this.chart.axisX && this.chart.axisX.length ?
        this.chart.axisX[0] : this.chart.axisX2[0]; if (!g(x)) {
          var t = Math.max(x.bounds.x1, x.convertValueToPixel(x.reversed ? Math.max(d, Math.min(x.maximum, k)) : Math.min(d, Math.min(x.maximum, k)))), a = x.convertValueToPixel(x.reversed ? Math.min(d, Math.min(x.maximum, k)) : Math.max(d, Math.min(x.maximum, k))); this.slider.panel.style.left = t + "px"; this.slider.left = t; this.slider.panel.style.width = a - t + "px"; this.slider.width = a - t; this.slider.minimum = d; this.slider.maximum = k; this.chart.resetOverlayedCanvas(); this.slider.maskInverted ?
      ...
      var d = this; y(this.panel, "mousedown", function (g) {
        d.stockChart.isDrag = !0; g.target !==
          d.leftHandle && g.target !== d.rightHandle && (d.stockChart.navigatorClicked = !0, d.currentHandle = d.leftHandle, d.panMode = !0, d.startPosition = Aa(g), g.target === d.currentHandle ? d.startPosition.x += d.currentHandle.offsetLeft + d.currentHandle.clientWidth / 2 + d.panel.offsetLeft : g.target === d.panel && (d.startPosition.x += d.panel.offsetLeft), d.startWidth = d.panel.clientWidth, d.startLeft = d.panel.offsetLeft)
        ...
        this.stockChart.allDOMEventHandlers); y(this.navigator.panel, "mousedown", function (k) {
          if (k.target !== d.navigator.slider.panel && k.target !== d.leftHandle && k.target !== d.rightHandle) {
            d.stockChart.navigatorClicked = !0; var x = Aa(k), t, a; t = 0; var f = d.navigator.chart.axisX && d.navigator.chart.axisX.length ? d.navigator.chart.axisX[0] : d.navigator.chart.axisX2[0]; k = d.navigator.slider.left; g(d.startLeft) && (d.startLeft = k); t = k + d.navigator.slider.width; a = x.x - (k + t) / 2; if (x.x < k || x.x > t) {
              var x = Math.max(0, k + a), c = Math.min(t + a, d.navigator.width);
          ...
          this.navigator.stockChart.allDOMEventHandlers); y(this.navigator.stockChart.container, "mousemove", function (k) {
            var x = d.navigator.chart.axisX && d.navigator.chart.axisX.length ? d.navigator.chart.axisX[0] : d.navigator.chart.axisX2[0]; if (!g(d.currentHandle) && d.startPosition) {
              d.navigator.chart.overlaidCanvas.style.cursor = d.navigator.chart.container.style.cursor = d.navigator.panel.style.cursor = "ew-resize"; var t; t = d.currentHandle === d.leftHandle ? 1 : -1; var a = Aa(k); k = k.target || k.srcElement; a.x = k === d.currentHandle ?
      ...
      var d = this, k; this._updateOptions(); ea && (this.eventsAttached || (this._attachEvents(), this.eventsAttached = !0), this.handleWidth = this.options.handleWidth ? this.handleWidth : 8, this.handleHeight = this.options.handleHeight ? Math.min(this.navigator.height,
        this.options.handleHeight) : 0.25 * this.navigator.height, this.leftHandle ? N(this.leftHandle, {
          ...
          if (d.stockChart.rangeSelector && d.stockChart.rangeSelector.inputFields &&
            d.stockChart.rangeSelector.inputFields.enabled) for (var k = 0; k < d.stockChart.rangeSelector.inputFields.elements.length; k++)g.target != d.stockChart.rangeSelector.inputFields.elements[k] && d.stockChart.rangeSelector.inputFields.elements[k].focused && d.stockChart.rangeSelector.inputFields.elements[k].blur()
          ...
          d.panMode = !1; d.navigator.stockChart.isDrag = !1; if (d.stockChart.navigatorClicked) {
            ...
            var t = Math.max(d.stockChart.sessionVariables._axisXMin, d.stockChart.sessionVariables._axisXMax); g(d.stockChart._rangeEventParameter) && (d.stockChart._rangeEventParameter = { stockChart: d.stockChart, source: "navigator", index: null, minimum: s, maximum: t }); d.navigator.dynamicUpdate || (d.stockChart._rangeEventParameter.type = "rangeChanging", d.stockChart.dispatchEvent("rangeChanging", d.stockChart._rangeEventParameter, d.stockChart)); for (var a = 0; a < d.stockChart.charts.length; a++) {
              k = d.stockChart.charts[a]; k.toolTip &&
                k.toolTip.enabled && k.toolTip.hide(); for (var f = 0; f < k.axisX.length; f++)k.axisX[f].setViewPortRange(s, t); for (f = 0; f < k.axisX2.length; f++)k.axisX2[f].setViewPortRange(s, t); k.render()
      ...
      var k = this; d && (y(d, "mousedown", function (d) {
        k.stockChart.navigatorClicked = !0; k.currentHandle = this; k.startPosition = Aa(d); d.target === k.currentHandle ? k.startPosition.x += k.currentHandle.offsetLeft + k.currentHandle.clientWidth / 2 + k.panel.offsetLeft : d.target === k.panel && (k.startPosition.x +=
          k.panel.offsetLeft); k.startWidth = k.panel.clientWidth; k.startLeft = k.panel.offsetLeft; d.preventDefault && d.preventDefault(); d.stopPropagation && d.stopPropagation()
      }, this.navigator.stockChart.allDOMEventHandlers), y(d, window.navigator.msPointerEnabled ? "MSPointerDown" : "touchstart", function (d) { k.stockChart._touchEventHandler(d) }, this.navigator.stockChart.allDOMEventHandlers))
      ...
      var d = 0; this._updateOptions(); this._label = {}; this.buttons = []; if (ea && this.enabled) {
        if (this.options.buttons) for (var k = 0; k < this.options.buttons.length; k++)this.buttons.push(new O(this.stockChart, k, this.options.buttons[k])); else { for (k = 0; 6 > k; k++)this.buttons.push(new O(this.stockChart, k)); this.buttonLabels = "1m 3m 6m YTD 1y All".split(" ") } this._wrapElements =
          !1; var s = this.stockChart.layoutManager.getFreeSpace(), t = s.x1, k = s.y1; this.width = this.options.width ? this.width : s.width; g(this.buttonStyle.options.labelFontSize) && (this.buttonStyle.labelFontSize = this.stockChart.getAutoFontSize(this.buttonStyle.labelFontSize)); this.rangeButtonsWidth = 0; this.buttonStyle.maxWidth = this.buttonStyle.options.maxWidth ? this.buttonStyle.options.maxWidth : this.stockChart.width / this.buttons.length; if (this.buttons && 0 < this.buttons.length) {
            ...
            var f = this.buttons[k]; f._index = k; a = new na(this.ctx, {
              ...
              text: this.options.buttons && this.options.buttons.length ? g(f.label) ? "" : f.label : this.buttonLabels[k], horizontalAlign: "center", textAlign: "center", fontSize: this.buttonStyle.labelFontSize, fontFamily: this.buttonStyle.labelFontFamily, fontWeight: this.buttonStyle.labelFontWeight, fontColor: this.buttonStyle.labelFontColor, fontStyle: this.buttonStyle.labelFontStyle, textBaseline: "middle"
            }); f.state = g(this.selectedRangeButtonIndex) || this.selectedRangeButtonIndex !== k ? "off" : "on"; f.textBlock = a; f.bounds = {
              x1: null, x2: null,
              y1: null, y2: null, width: null, height: null
            }; a.measureText(); this.rangeButtonsWidth += a.width + this.buttonStyle.spacing; this.rangeButtonsHeight = a.height; d = d < a.height ? a.height : d; f = this.buttons[k]; f.id = ++this.stockChart._eventManager.lastObjectId; this.stockChart._eventManager.objectMap[f.id] = { id: f.id, objectType: "rangeButton", rangeButtonIndex: k }
      ...
      var d, g, k = this.bounds.x1 + 5, t, a; this._label && (this._label.textBlock &&
        0 < this.buttons.length) && (this._label.textBlock.x = k, this._label.textBlock.y = a = this.bounds.y1 + this._label.textBlock.measureText().height / 2 + 2 * this.buttons[0].textBlock.borderThickness, this._label.bounds = { x1: k, y1: a - this._label.textBlock.fontSize / 2, x2: k + this._label.textBlock.measureText().width, y2: a + this._label.textBlock.measureText().height, width: this._label.textBlock.measureText().width, height: this._label.textBlock.measureText().height }, k += this._label.bounds.width); for (d = 0; d < this.buttons.length; d++)g =
          ...
          g.textBlock.height, g.bounds.width = t - k, g.bounds.height = g.bounds.y2 - g.bounds.y1, k = t + this.buttonStyle.spacing, g.textBlock.maxWidth = this.buttonStyle.maxWidth
              ...
              var t = this.inputFields._textBlocks[s], a = t.measureText(); t._width = this.inputFields.style.options.width ? this.inputFields.style.width : Math.abs(a.width - t._width) <= ("dateTime" === this.inputFields.valueType ? 10 : 5) ? t._width : a.width + 10; d += t._width + this.inputFields.style.spacing; this.inputFields.elements[s].style.width = t._width - this.inputFields.style.spacing - 2 * this.inputFields.style.borderThickness -
                5 + "px"; t.x = t.bounds.x1 = 1 === t.borderThickness % 2 ? (this.bounds.x2 - d - (this.stockChart.exportEnabled && k ? 40 : 0) << 0) + 0.5 : this.bounds.x2 - d - (this.stockChart.exportEnabled && k ? 40 : 0); t.bounds.x2 = t.bounds.x1 + t._width; this.inputFields.elements[s].style.left = this.bounds.x2 - d - (this.stockChart.exportEnabled && k ? 40 : 0) + this.inputFields.style.borderThickness + "px"; d += this.inputFields._labels[s].measureText().width; this.inputFields._labels[s].x = this.inputFields._labels[s].bounds.x1 = this.bounds.x2 - d - (this.stockChart.exportEnabled &&
                  k ? 40 : 0); this.inputFields._labels[s].bounds.x2 = this.inputFields._labels[s].bounds.x1 + this.inputFields._labels[s].measureText().width; t.width = t._width; t.y = 1 === t.borderThickness % 2 ? (this._wrapElements ? this.bounds.y1 + this.rangeButtonsHeight + 10 : this.bounds.y1) + a.height / 2 + 2 * t.borderThickness << 0.5 : (this._wrapElements ? this.bounds.y1 + this.rangeButtonsHeight + 10 : this.bounds.y1) + a.height / 2 + 2 * t.borderThickness; this.inputFields._labels[s].y = (this._wrapElements ? this.bounds.y1 + this.rangeButtonsHeight + 10 : this.bounds.y1) +
                    a.height / 2 + 2 * t.borderThickness; t.bounds.y1 = this.inputFields._labels[s].bounds.y1 = t.y - a.height / 2 + 2 * t.borderThickness; t.bounds.y2 = this.inputFields._labels[s].bounds.y2 = t.bounds.y1 + a.height; this.inputFields.elements[s].style.top = this.inputFields._labels[s].bounds.y1 + "px"; t.render(!0); this.inputFields._labels[s].render(!0)
            }
      ...
      !this.inputFields.elements[0].focused && isFinite(d) && (this.inputFields.elements[0].value = "dateTime" === this.inputFields.valueType ? oa(d,
        "YYYY-MM-DD") : aa(d, this.inputFields.valueFormatString)); !this.inputFields.elements[1].focused && isFinite(g) && (this.inputFields.elements[1].value = "dateTime" === this.inputFields.valueType ? oa(g, "YYYY-MM-DD") : aa(g, this.inputFields.valueFormatString)); for (var k = 0; k < this.inputFields.elements.length; k++)this.inputFields.elements[k].focused && this.inputFields.elements[k].focus(); this.inputFields.startValue = d; this.inputFields.endValue = g; this.render()
